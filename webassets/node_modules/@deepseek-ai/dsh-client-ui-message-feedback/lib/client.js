window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".Am4xBq_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.Am4xBq_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}.Am4xBq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Am4xBq_action:disabled{cursor:default;opacity:.4}.Am4xBq_action[data-active]{color:var(--dsw-alias-label-primary)}.Am4xBq_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(28px + var(--dsh-content-font-delta,0px));white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;overflow:hidden}.Am4xBq_noteOpen:hover,.Am4xBq_noteOpen[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Am4xBq_notePanel{z-index:1100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:320px;max-width:min(360px,100vw - 24px);max-height:calc(100vh - 24px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:12px;flex-direction:column;gap:8px;padding:8px;display:flex;position:fixed;overflow-y:auto}.Am4xBq_noteInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.Am4xBq_noteActions{justify-content:flex-end;gap:6px;display:flex}.Am4xBq_noteSave,.Am4xBq_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.Am4xBq_noteSave{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}.Am4xBq_noteSave:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.Am4xBq_noteSave:disabled{cursor:default;opacity:.4}.Am4xBq_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.Am4xBq_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Am4xBq_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:20px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"action": "Am4xBq_action",
			"failure": "Am4xBq_failure",
			"noteActions": "Am4xBq_noteActions",
			"noteCancel": "Am4xBq_noteCancel",
			"noteInput": "Am4xBq_noteInput",
			"noteOpen": "Am4xBq_noteOpen",
			"notePanel": "Am4xBq_notePanel",
			"noteSave": "Am4xBq_noteSave"
		};
		//#endregion
