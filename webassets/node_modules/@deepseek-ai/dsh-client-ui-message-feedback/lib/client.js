window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-message-feedback\src\client\MessageFeedbackActions.module.css.mjs
		const css = ".XuClLa_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.XuClLa_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}.XuClLa_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.XuClLa_action:disabled{cursor:default;opacity:.4}.XuClLa_action[data-active]{color:var(--dsw-alias-label-primary)}.XuClLa_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(28px + var(--dsh-content-font-delta,0px));white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;overflow:hidden}.XuClLa_noteOpen:hover,.XuClLa_noteOpen[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.XuClLa_notePanel{z-index:1100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:320px;max-width:min(360px,100vw - 24px);max-height:calc(100vh - 24px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:12px;flex-direction:column;gap:8px;padding:8px;display:flex;position:fixed;overflow-y:auto}.XuClLa_noteInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.XuClLa_noteActions{justify-content:flex-end;gap:6px;display:flex}.XuClLa_noteSave,.XuClLa_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.XuClLa_noteSave{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}.XuClLa_noteSave:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.XuClLa_noteSave:disabled{cursor:default;opacity:.4}.XuClLa_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.XuClLa_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.XuClLa_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:20px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"action": "XuClLa_action",
			"failure": "XuClLa_failure",
			"noteActions": "XuClLa_noteActions",
			"noteCancel": "XuClLa_noteCancel",
			"noteInput": "XuClLa_noteInput",
			"noteOpen": "XuClLa_noteOpen",
			"notePanel": "XuClLa_notePanel",
			"noteSave": "XuClLa_noteSave"
		};
		//#endregion
		...
		*/
		function MessageFeedbackActions({ messageId, ensure, rate, toggle, clearNote, useFeedback, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				rating !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					ref: triggerRef,
					type: "button",
				...
				rowFailure === null && loadFailed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: MessageFeedbackActions_module_css_default.failure,
					role: "status",
					children: t("error.load")
				}),
				rowFailure !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: MessageFeedbackActions_module_css_default.failure,
					role: "status",
					children: rowFailure
				}),
				!(rating !== void 0 && noteOpen) && noteFailure !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: MessageFeedbackActions_module_css_default.failure,
					role: "status",
					children: noteFailure
				}),
				rating !== void 0 && noteOpen && (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					ref: panelRef,
					...
					children: [
						...
						noteFailure !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: MessageFeedbackActions_module_css_default.failure,
							role: "status",
							children: noteFailure
						})
