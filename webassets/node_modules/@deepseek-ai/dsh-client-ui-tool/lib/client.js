window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/tool/models/raw-tool-call.ts
		...
		*/
		...
		//#endregion
		//#region src/client/tool/models/primitive-labels.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-tool\src\client\tool\components\AskQuestionCard.module.css.mjs
		const css$4 = ".SNKFpa_card{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:16px;max-height:360px;margin:4px 0 4px 4px;padding:16px 20px;display:flex;overflow-y:auto}.SNKFpa_item{flex-direction:column;gap:2px;min-width:0;display:flex}.SNKFpa_question,.SNKFpa_answer{white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.SNKFpa_question{color:var(--dsw-alias-label-tertiary)}.SNKFpa_answer{color:var(--dsw-alias-label-primary)}.SNKFpa_answerLine{display:block}.SNKFpa_skipped{color:var(--dsw-alias-label-tertiary)}.SNKFpa_verdict{color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.SNKFpa_questionList{flex-direction:column;gap:8px;margin:0;padding-left:20px;display:flex}.SNKFpa_unansweredQuestion{color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}";
		...
		var AskQuestionCard_module_css_default = {
			"answer": "SNKFpa_answer",
			"answerLine": "SNKFpa_answerLine",
			"card": "SNKFpa_card",
			"item": "SNKFpa_item",
			"question": "SNKFpa_question",
			"questionList": "SNKFpa_questionList",
			"skipped": "SNKFpa_skipped",
			"unansweredQuestion": "SNKFpa_unansweredQuestion",
			"verdict": "SNKFpa_verdict"
		};
		//#endregion
		//#region src/client/tool/components/AskQuestionCard.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-tool\src\client\tool\components\ToolRow.module.css.mjs
		const css$3 = "._0c_MW_root{flex-direction:column;display:flex}._0c_MW_row{position:relative;overflow:hidden}._0c_MW_root[data-state=running] ._0c_MW_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _0c_MW_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes _0c_MW_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}._0c_MW_leading{flex-shrink:0}._0c_MW_root[data-tool^=cordis_] ._0c_MW_leading,._0c_MW_root[data-tool^=cordis_] ._0c_MW_title{color:var(--dsw-alias-state-business-primary)}._0c_MW_root[data-tool^=cordis_] ._0c_MW_title{font-weight:500}._0c_MW_root[data-tool^=cordis_] ._0c_MW_sep{background:var(--dsw-alias-state-business-primary)}._0c_MW_chevron{color:var(--dsw-alias-label-secondary)}._0c_MW_title{font-weight:400}._0c_MW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._0c_MW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}._0c_MW_summarySuffix{white-space:nowrap;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px}._0c_MW_diffStat{font-family:var(--ds-font-family-code);font-size:calc(var(--dsh-content-font-size-secondary,13px) - 2px);color:var(--dsw-alias-label-caption);margin-left:10px;transform:translateY(.5px)}._0c_MW_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);text-decoration:underline dotted;text-decoration-color:var(--dsw-alias-label-tertiary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:0 auto;margin:0;padding:0;text-decoration-thickness:1px;overflow:hidden}._0c_MW_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}._0c_MW_errorSummary{color:var(--dsw-alias-state-error-primary)}._0c_MW_bodyWrap{flex-direction:column;display:flex}._0c_MW_inspectButton{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._0c_MW_root:hover ._0c_MW_inspectButton,._0c_MW_inspectButton:focus-visible{opacity:1}._0c_MW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._0c_MW_bodyScroll{max-height:260px;overflow-y:auto}._0c_MW_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}._0c_MW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}._0c_MW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._0c_MW_ioSection::-webkit-scrollbar-track{margin:6px 0}._0c_MW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}._0c_MW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}._0c_MW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}._0c_MW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}._0c_MW_codeBody,._0c_MW_terminalBody,._0c_MW_diffBody,._0c_MW_readBody,._0c_MW_imageBody,._0c_MW_searchBody,._0c_MW_webBody{margin:4px 0 4px 4px}._0c_MW_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}._0c_MW_imageLabel{overflow-wrap:anywhere;font:var(--dsw-font-sm-13);color:var(--dsw-alias-label-secondary);margin-bottom:4px}._0c_MW_imageMeta{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary)}._0c_MW_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}._0c_MW_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1)}._0c_MW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "_0c_MW_bodyScroll",
			"bodyWrap": "_0c_MW_bodyWrap",
			"chevron": "_0c_MW_chevron",
			"codeBody": "_0c_MW_codeBody",
			"diffBody": "_0c_MW_diffBody",
			"diffStat": "_0c_MW_diffStat",
			"dsh-tool-row-sweep": "_0c_MW_dsh-tool-row-sweep",
			"errorSummary": "_0c_MW_errorSummary",
			"fileLink": "_0c_MW_fileLink",
			"imageBody": "_0c_MW_imageBody",
			"imageLabel": "_0c_MW_imageLabel",
			"imageMeta": "_0c_MW_imageMeta",
			"inspectButton": "_0c_MW_inspectButton",
			"ioCard": "_0c_MW_ioCard",
			"ioDivider": "_0c_MW_ioDivider",
			"ioLabel": "_0c_MW_ioLabel",
			"ioSection": "_0c_MW_ioSection",
			"ioText": "_0c_MW_ioText",
			"leading": "_0c_MW_leading",
			"readBody": "_0c_MW_readBody",
			"root": "_0c_MW_root",
			"row": "_0c_MW_row",
			"searchBody": "_0c_MW_searchBody",
			"searchRecovery": "_0c_MW_searchRecovery",
			"sep": "_0c_MW_sep",
			"summary": "_0c_MW_summary",
			"summarySuffix": "_0c_MW_summarySuffix",
			"terminalBody": "_0c_MW_terminalBody",
			"title": "_0c_MW_title",
			"visuallyHidden": "_0c_MW_visuallyHidden",
			"webBody": "_0c_MW_webBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [status !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}) : imageBody !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".TJPAwW_callRow{border-radius:6px}.TJPAwW_subCalls{border-left:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "TJPAwW_callRow",
			"subCalls": "TJPAwW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".gye0Wa_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.gye0Wa_cardBody{margin:0}.gye0Wa_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.gye0Wa_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.gye0Wa_code[data-error]{color:var(--dsw-alias-state-error-primary)}.gye0Wa_read,.gye0Wa_web{margin:0}.gye0Wa_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "gye0Wa_cardBody",
			"code": "gye0Wa_code",
			"description": "gye0Wa_description",
			"empty": "gye0Wa_empty",
			"read": "gye0Wa_read",
			"recovery": "gye0Wa_recovery",
			"web": "gye0Wa_web"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = ".tgso6G_card{flex-direction:column;display:flex}.tgso6G_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.tgso6G_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.tgso6G_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.tgso6G_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.tgso6G_ioSection::-webkit-scrollbar-track{margin:6px 0}.tgso6G_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.tgso6G_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.tgso6G_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.tgso6G_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.tgso6G_root[data-expandable]{cursor:pointer}.tgso6G_root{height:calc(24px + var(--dsh-content-font-delta,0px));align-items:center;min-width:0;display:flex;position:relative;overflow:hidden}.tgso6G_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite tgso6G_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes tgso6G_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.tgso6G_leading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.tgso6G_leading svg:not([data-state]){width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.tgso6G_chevron{color:var(--dsw-alias-label-secondary)}.tgso6G_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.tgso6G_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.tgso6G_root:hover .tgso6G_iconIdle{opacity:0}.tgso6G_root:hover .tgso6G_chevronHover{opacity:1}.tgso6G_title{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none}.tgso6G_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.tgso6G_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.tgso6G_errorSummary{color:var(--dsw-alias-state-error-primary)}.tgso6G_bodyWrap{flex-direction:column;display:flex}.tgso6G_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.tgso6G_card:hover .tgso6G_inspectButton,.tgso6G_inspectButton:focus-visible{opacity:1}.tgso6G_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.tgso6G_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "tgso6G_bodyWrap",
			"card": "tgso6G_card",
			"chevron": "tgso6G_chevron",
			"chevronHover": "tgso6G_chevronHover",
			"dsh-bash-row-sweep": "tgso6G_dsh-bash-row-sweep",
			"errorSummary": "tgso6G_errorSummary",
			"iconIdle": "tgso6G_iconIdle",
			"inspectButton": "tgso6G_inspectButton",
			"ioCard": "tgso6G_ioCard",
			"ioDivider": "tgso6G_ioDivider",
			"ioLabel": "tgso6G_ioLabel",
			"ioSection": "tgso6G_ioSection",
			"ioText": "tgso6G_ioText",
			"leading": "tgso6G_leading",
			"root": "tgso6G_root",
			"sep": "tgso6G_sep",
			"summary": "tgso6G_summary",
			"terminal": "tgso6G_terminal",
			"title": "tgso6G_title",
			"visuallyHidden": "tgso6G_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region src/client/tool/toolviews/read-family-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region src/client/tool/models/image-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region src/client/tool/toolviews/read-image-row.tsx
		/**
