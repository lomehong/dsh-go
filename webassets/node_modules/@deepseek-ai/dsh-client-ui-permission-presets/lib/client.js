window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-permission-presets\src\client\PermissionRow.module.css.mjs
		const css = ".Xa4VfG_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.Xa4VfG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.Xa4VfG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Xa4VfG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.Xa4VfG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Xa4VfG_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Xa4VfG_selector:disabled{cursor:default}.Xa4VfG_chevron{flex:none}";
		...
		var PermissionRow_module_css_default = {
			"chevron": "Xa4VfG_chevron",
			"desc": "Xa4VfG_desc",
			"row": "Xa4VfG_row",
			"rowText": "Xa4VfG_rowText",
			"selector": "Xa4VfG_selector",
			"title": "Xa4VfG_title"
		};
		//#endregion
