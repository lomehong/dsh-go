window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".v4MSZa_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.v4MSZa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.v4MSZa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.v4MSZa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.v4MSZa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.v4MSZa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.v4MSZa_selector:disabled{cursor:default}.v4MSZa_chevron{flex:none}";
		...
		var PermissionRow_module_css_default = {
			"chevron": "v4MSZa_chevron",
			"desc": "v4MSZa_desc",
			"row": "v4MSZa_row",
			"rowText": "v4MSZa_rowText",
			"selector": "v4MSZa_selector",
			"title": "v4MSZa_title"
		};
		//#endregion
