window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-settings-plugin-inventory\src\client\PluginInventorySettingsTab.module.css.mjs
		const css = ".q1PiPW_section{width:100%;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}.q1PiPW_catalogHeading h3,.q1PiPW_status,.q1PiPW_failure p{margin:0}.q1PiPW_status,.q1PiPW_failure{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.q1PiPW_failure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;display:flex}.q1PiPW_failure button{border:.5px solid var(--dsw-alias-border-l3);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:4px 10px}.q1PiPW_catalog{flex-direction:column;gap:12px;display:flex}.q1PiPW_search{width:100%;color:var(--dsw-alias-label-tertiary);align-items:center;display:flex;position:relative}.q1PiPW_search>svg{pointer-events:none;position:absolute;left:12px}.q1PiPW_search input{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;height:36px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:10px;outline:none;padding:0 34px 0 36px;font-size:13px}.q1PiPW_search input::placeholder{color:var(--dsw-alias-label-tertiary)}.q1PiPW_search input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.q1PiPW_catalogHeading{align-items:baseline;gap:7px;padding:0 2px;display:flex}.q1PiPW_catalogHeading h3{font-size:13px;font-weight:600;line-height:20px}.q1PiPW_catalogHeading span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.q1PiPW_cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;margin:0;padding:0;list-style:none;display:grid}.q1PiPW_card{min-width:0;box-shadow:var(--dsw-elevation-stroke);background:var(--dsw-alias-bg-layer-3);border:0;border-radius:14px;overflow:hidden}.q1PiPW_card[data-open=true]{--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);box-shadow:var(--dsw-elevation-panel)}.q1PiPW_cardContent{box-sizing:border-box;width:100%;min-height:52px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;justify-content:space-between;align-items:center;gap:12px;padding:12px 14px;display:flex}.q1PiPW_cardContent:hover,.q1PiPW_card[data-open=true]>.q1PiPW_cardContent{background:var(--dsw-alias-interactive-bg-hover)}.q1PiPW_cardContent:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.q1PiPW_cardTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;font-weight:600;line-height:20px;overflow:hidden}.q1PiPW_cardTrailing{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:7px;display:inline-flex}.q1PiPW_statusDot{corner-shape:round;background:var(--dsw-alias-label-tertiary);border-radius:999px;flex:none;width:7px;height:7px;display:inline-block}.q1PiPW_statusDot[data-phase=active]{background:var(--dsw-alias-state-success-primary)}.q1PiPW_statusDot[data-phase=failed]{background:var(--dsw-alias-state-error-primary)}.q1PiPW_statusDot[data-phase=loading]{background:var(--dsw-alias-state-business-primary)}.q1PiPW_configTag{background:var(--dsw-alias-bg-layer-1);min-height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:5px;align-items:center;padding:1px 6px;font-size:11px;line-height:16px;display:inline-flex}.q1PiPW_configTag[data-kind=enabled]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary)}.q1PiPW_configTag[data-kind=preset]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent);color:var(--dsw-alias-state-business-primary)}.q1PiPW_configTag[data-kind=conditional]{background:color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b45309) 12%, transparent);color:var(--dsw-alias-state-warning-primary,#b45309)}.q1PiPW_configTag[data-kind=failed]{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent);color:var(--dsw-alias-state-error-primary)}.q1PiPW_group{flex-direction:column;gap:10px;display:flex}.q1PiPW_groupTitleRow{align-items:center;gap:8px;min-height:32px;display:flex}.q1PiPW_group+.q1PiPW_group{border-top:.5px solid var(--dsw-alias-border-l2);padding-top:14px}.q1PiPW_headerEnd{margin-left:auto}.q1PiPW_groupToggle{color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex:none;align-items:center;gap:8px;padding:0;display:flex}.q1PiPW_groupToggle:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.q1PiPW_groupToggle>.q1PiPW_chevron{transform:rotate(-90deg)}.q1PiPW_groupToggle[aria-expanded=true]>.q1PiPW_chevron{transform:none}.q1PiPW_groupTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.q1PiPW_groupSub{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;gap:4px 8px;margin:-6px 0 0 20px;font-size:12px;line-height:18px;display:flex}.q1PiPW_failedCount{color:var(--dsw-alias-state-error-primary)}.q1PiPW_switcher{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);height:36px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border:none;border-radius:18px;flex:none;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.q1PiPW_switcher:hover{background:var(--dsw-alias-interactive-bg-hover)}.q1PiPW_switcher:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.q1PiPW_switcher>.q1PiPW_chevron{flex:none}.q1PiPW_switcherLabel{text-overflow:ellipsis;max-width:240px;overflow:hidden}.q1PiPW_groupBody{flex-direction:column;gap:10px;display:flex}.q1PiPW_brokenNote{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;white-space:pre-line;border-radius:8px;margin:0;padding:8px 10px;font-size:12.5px;line-height:18px}.q1PiPW_hint{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:baseline;gap:4px 8px;margin:0;font-size:12.5px;line-height:18px;display:flex}.q1PiPW_jumpLink{color:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;background:0 0;border:0;padding:0;font-size:12.5px}.q1PiPW_enabledIn{flex-wrap:wrap;align-items:baseline;gap:4px 10px;display:flex}.q1PiPW_card[data-failed=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}.q1PiPW_chevron{color:var(--dsw-alias-label-tertiary);flex:none}.q1PiPW_card[data-open=true] .q1PiPW_chevron{transform:rotate(180deg)}.q1PiPW_cardDetails{border-top:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);padding:10px 14px 12px}.q1PiPW_entryValue{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);font-size:12px;line-height:18px;display:block}.q1PiPW_details{grid-template-columns:76px minmax(0,1fr);gap:6px 10px;margin:8px 0 0;display:grid}.q1PiPW_details div{display:contents}.q1PiPW_details dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.q1PiPW_details dd{overflow-wrap:anywhere;min-width:0;color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:17px}.q1PiPW_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:no-preference){.q1PiPW_chevron{transition:transform .14s var(--ds-ease-in-out)}}@media (width<=680px){.q1PiPW_cards{grid-template-columns:minmax(0,1fr)}}";
		...
		var PluginInventorySettingsTab_module_css_default = {
			"brokenNote": "q1PiPW_brokenNote",
			"card": "q1PiPW_card",
			"cardContent": "q1PiPW_cardContent",
			"cardDetails": "q1PiPW_cardDetails",
			"cardTitle": "q1PiPW_cardTitle",
			"cardTrailing": "q1PiPW_cardTrailing",
			"cards": "q1PiPW_cards",
			"catalog": "q1PiPW_catalog",
			"catalogHeading": "q1PiPW_catalogHeading",
			"chevron": "q1PiPW_chevron",
			"configTag": "q1PiPW_configTag",
			"details": "q1PiPW_details",
			"enabledIn": "q1PiPW_enabledIn",
			"entryValue": "q1PiPW_entryValue",
			"failedCount": "q1PiPW_failedCount",
			"failure": "q1PiPW_failure",
			"group": "q1PiPW_group",
			"groupBody": "q1PiPW_groupBody",
			"groupSub": "q1PiPW_groupSub",
			"groupTitle": "q1PiPW_groupTitle",
			"groupTitleRow": "q1PiPW_groupTitleRow",
			"groupToggle": "q1PiPW_groupToggle",
			"headerEnd": "q1PiPW_headerEnd",
			"hint": "q1PiPW_hint",
			"jumpLink": "q1PiPW_jumpLink",
			"search": "q1PiPW_search",
			"section": "q1PiPW_section",
			"status": "q1PiPW_status",
			"statusDot": "q1PiPW_statusDot",
			"switcher": "q1PiPW_switcher",
			"switcherLabel": "q1PiPW_switcherLabel",
			"visuallyHidden": "q1PiPW_visuallyHidden"
		};
		//#endregion
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
						...
						children: [trailing, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, {
		...
		function CardFacts({ moduleName, moduleLabel, entryId, facts }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [entryId === null ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: moduleLabel }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: moduleName })] }), facts.map(([label, value]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: label }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: value })] }, label))]
			})] });
		}
		...
		function PluginInventorySettingsTab({ list, presetName, t }) {
			...
			const presetRowCard = (preset, row, index) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PluginCard, {
					...
					trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [row.enabled === true && !failed && row.fiberPhase !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PhaseDot, {
						phase: row.fiberPhase,
						t
					}) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StateTag, {
						kind,
						label: stateText
					})] }),
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CardFacts, {
						moduleName: row.moduleName,
						...
						facts: [
							...
							...row.condition === void 0 ? [] : [[t("condition"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: row.condition }, "condition")]]
						]
					})
				}, key);
			};
			...
			const globalRowCard = (entry, providers) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PluginCard, {
					...
					onToggle: toggleRow,
					ariaLabel: `${title}, ${stateText}`,
					trailing: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [entry.enabled && !failed && entry.fiberPhase !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PhaseDot, {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CardFacts, {
						...
						moduleLabel: t("moduleLabel"),
						entryId: entry.entryId,
						facts: providers !== void 0 ? [[t("configuration"), t("presetProvidedDetail")], [t("enabledIn"), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: PluginInventorySettingsTab_module_css_default.enabledIn,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: providers.map((preset) => presetName(preset)).join(" · ") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					snapshot !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							entries.length === 0 && presets.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: PluginInventorySettingsTab_module_css_default.status,
								children: t("empty")
							}) : null,
							nothingMatches ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: PluginInventorySettingsTab_module_css_default.status,
								...
								children: [
									...
									presetEffectiveOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											otherMatchCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
												className: PluginInventorySettingsTab_module_css_default.hint,
												children: [t("matchesInOtherPresets", { count: String(otherMatchCount) }), otherPresetMatches.map((preset) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
													type: "button",
													className: PluginInventorySettingsTab_module_css_default.jumpLink,
													onClick: () => {
							...
							entries.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								className: PluginInventorySettingsTab_module_css_default.group,
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
										...
										children: [
											...
											filteredFailed.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									globalEffectiveOpen && globalCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ul", {
										className: PluginInventorySettingsTab_module_css_default.cards,
										id: `${sectionId}-global`,
