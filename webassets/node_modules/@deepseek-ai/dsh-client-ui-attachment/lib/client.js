window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-attachment\src\AttachmentRail.module.css.mjs
		const css$5 = "._07WLNq_root{min-width:0;position:relative}._07WLNq_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);align-items:stretch;gap:10px;display:flex;overflow:auto hidden}._07WLNq_rail::-webkit-scrollbar{display:none}._07WLNq_item{flex:none;height:64px}._07WLNq_thumbnail{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}._07WLNq_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}._07WLNq_remove{z-index:1;corner-shape:round;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}._07WLNq_item:hover ._07WLNq_remove,._07WLNq_remove:focus-visible{opacity:1}@media (pointer:coarse){._07WLNq_remove{opacity:1}}@media (prefers-reduced-motion:reduce){._07WLNq_remove{transition:none}}._07WLNq_arrow{z-index:2;--dsw-elevation-stroke-color:var(--dsw-alias-border-l2-darkmode-thin);corner-shape:round;background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-elevation-panel);cursor:pointer;border:0;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}._07WLNq_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}._07WLNq_arrowLeft{left:4px}._07WLNq_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "_07WLNq_arrow",
			"arrowLeft": "_07WLNq_arrowLeft",
			"arrowRight": "_07WLNq_arrowRight",
			"item": "_07WLNq_item",
			"rail": "_07WLNq_rail",
			"remove": "_07WLNq_remove",
			"root": "_07WLNq_root",
			"thumbnail": "_07WLNq_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-attachment\src\DropOverlay.module.css.mjs
		const css$4 = ".dVD7UG_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out dVD7UG_fade-in;display:flex;position:fixed;inset:0}@keyframes dVD7UG_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){.dVD7UG_mask{animation:none}}.dVD7UG_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}.dVD7UG_illustration{width:115px;height:84px}.dVD7UG_title{font:var(--dsw-font-l-20);margin-top:16px}.dVD7UG_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "dVD7UG_desc",
			"fade-in": "dVD7UG_fade-in",
			"illustration": "dVD7UG_illustration",
			"mask": "dVD7UG_mask",
			"title": "dVD7UG_title",
			"wrap": "dVD7UG_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-attachment\src\FileCard.module.css.mjs
		const css$3 = ".dtbe9W_card{border:.5px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-specific-input-major,transparent);box-sizing:border-box;text-align:left;border-radius:16px;align-items:center;gap:10px;width:240px;height:64px;padding:0 12px;display:inline-flex;position:relative}.dtbe9W_failed{border-color:var(--dsw-alias-state-error-primary,#d54941)}.dtbe9W_icon{flex:none;justify-content:center;align-items:center;width:28px;height:28px;display:inline-flex}.dtbe9W_spinner{corner-shape:round;border:2px solid;border-top-color:#0000;border-radius:50%;width:20px;height:20px;animation:.8s linear infinite dtbe9W_file-card-spin}@keyframes dtbe9W_file-card-spin{to{transform:rotate(360deg)}}.dtbe9W_body{flex-direction:column;flex:1;min-width:0;padding:8px 0;display:flex}.dtbe9W_retry{color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;padding:0}.dtbe9W_name{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.dtbe9W_meta{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-tertiary,#00000073);font-size:12px;line-height:15px;overflow:hidden}.dtbe9W_metaFailed{color:var(--dsw-alias-state-error-primary,#d54941)}.dtbe9W_remove{corner-shape:round;background:var(--dsw-alias-button-contrast-fill,#000000b8);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted,#fff);opacity:0;cursor:pointer;border:none;border-radius:50%;justify-content:center;align-items:center;padding:0;transition:opacity .2s ease-in-out;display:inline-flex;position:absolute;top:6px;right:6px}.dtbe9W_card:hover .dtbe9W_remove,.dtbe9W_remove:focus-visible{opacity:1}.dtbe9W_card:hover .dtbe9W_name,.dtbe9W_card:focus-within .dtbe9W_name{padding-right:18px}.dtbe9W_removeFailed{background:var(--dsw-alias-state-error-primary,#d54941);color:#fff;opacity:1}.dtbe9W_progressTrack{background:var(--dsw-alias-fill-tertiary,#00000014);border-radius:1px;height:2px;position:absolute;bottom:5px;left:12px;right:12px;overflow:hidden}.dtbe9W_progressBar{border-radius:inherit;background:var(--dsw-alias-brand-primary,#4d6bfe);width:35%;height:100%;animation:1.2s ease-in-out infinite alternate dtbe9W_file-card-progress;display:block}.dtbe9W_progressBar[style]{animation:none}@keyframes dtbe9W_file-card-progress{0%{transform:translate(-70%)}to{transform:translate(220%)}}@media (pointer:coarse){.dtbe9W_remove{opacity:1}}";
		...
		var FileCard_module_css_default = {
			"body": "dtbe9W_body",
			"card": "dtbe9W_card",
			"failed": "dtbe9W_failed",
			"file-card-progress": "dtbe9W_file-card-progress",
			"file-card-spin": "dtbe9W_file-card-spin",
			"icon": "dtbe9W_icon",
			"meta": "dtbe9W_meta",
			"metaFailed": "dtbe9W_metaFailed",
			"name": "dtbe9W_name",
			"progressBar": "dtbe9W_progressBar",
			"progressTrack": "dtbe9W_progressTrack",
			"remove": "dtbe9W_remove",
			"removeFailed": "dtbe9W_removeFailed",
			"retry": "dtbe9W_retry",
			"spinner": "dtbe9W_spinner"
		};
		//#endregion
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						"aria-hidden": true,
						children: state === "uploading" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: FileCard_module_css_default.spinner }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DocumentFileIcon, {})
					}),
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-attachment\src\ImageLightbox.module.css.mjs
		const css$2 = ".ebvf1W_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.ebvf1W_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.ebvf1W_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.ebvf1W_close{z-index:1;border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);corner-shape:round;background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-attachment\src\client\ComposerAttachments.module.css.mjs
		const css$1 = ".Hx7aCW_rail{min-width:0;padding:4px 12px 0}.Hx7aCW_imageItem{width:64px;height:64px;position:relative}.Hx7aCW_thumbnail{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.Hx7aCW_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.Hx7aCW_remove{z-index:1;corner-shape:round;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.Hx7aCW_imageItem:hover .Hx7aCW_remove,.Hx7aCW_remove:focus-visible{opacity:1}@media (pointer:coarse){.Hx7aCW_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.Hx7aCW_remove{transition:none}}";
		...
		var ComposerAttachments_module_css_default = {
			"imageItem": "Hx7aCW_imageItem",
			"rail": "Hx7aCW_rail",
			"remove": "Hx7aCW_remove",
			"thumbnail": "Hx7aCW_thumbnail"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-attachment\src\MessageImage.module.css.mjs
		const css = "._9r3KBG_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}._9r3KBG_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}._9r3KBG_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}._9r3KBG_frame{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}._9r3KBG_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}._9r3KBG_frame img{object-fit:cover;width:100%;height:100%;display:block}._9r3KBG_loading,._9r3KBG_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}._9r3KBG_error{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}._9r3KBG_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "_9r3KBG_error",
			"frame": "_9r3KBG_frame",
			"gallery": "_9r3KBG_gallery",
			"loading": "_9r3KBG_loading"
		};
		//#endregion
