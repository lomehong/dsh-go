window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$4 = ".ZEnYiq_root{min-width:0;position:relative}.ZEnYiq_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:10px;display:flex;overflow:auto hidden}.ZEnYiq_rail::-webkit-scrollbar{display:none}.ZEnYiq_item{flex:0 0 64px;width:64px;height:64px;position:relative}.ZEnYiq_thumbnail{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.ZEnYiq_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.ZEnYiq_remove{z-index:1;corner-shape:round;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.ZEnYiq_item:hover .ZEnYiq_remove,.ZEnYiq_remove:focus-visible{opacity:1}@media (pointer:coarse){.ZEnYiq_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.ZEnYiq_remove{transition:none}}.ZEnYiq_arrow{z-index:2;--dsw-elevation-stroke-color:var(--dsw-alias-border-l2-darkmode-thin);corner-shape:round;background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-elevation-panel);cursor:pointer;border:0;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.ZEnYiq_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.ZEnYiq_arrowLeft{left:4px}.ZEnYiq_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "ZEnYiq_arrow",
			"arrowLeft": "ZEnYiq_arrowLeft",
			"arrowRight": "ZEnYiq_arrowRight",
			"item": "ZEnYiq_item",
			"rail": "ZEnYiq_rail",
			"remove": "ZEnYiq_remove",
			"root": "ZEnYiq_root",
			"thumbnail": "ZEnYiq_thumbnail"
		};
		//#endregion
		...
		*/
		...
		const css$3 = ".QZJuZa_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out QZJuZa_fade-in;display:flex;position:fixed;inset:0}@keyframes QZJuZa_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){.QZJuZa_mask{animation:none}}.QZJuZa_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}.QZJuZa_illustration{width:115px;height:84px}.QZJuZa_title{font:var(--dsw-font-l-20);margin-top:16px}.QZJuZa_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "QZJuZa_desc",
			"fade-in": "QZJuZa_fade-in",
			"illustration": "QZJuZa_illustration",
			"mask": "QZJuZa_mask",
			"title": "QZJuZa_title",
			"wrap": "QZJuZa_wrap"
		};
		...
		*/
		...
		const css$2 = ".xdKOOG_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.xdKOOG_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.xdKOOG_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.xdKOOG_close{z-index:1;border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);corner-shape:round;background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		const css$1 = ".Tub9Vq_rail{min-width:0;padding:4px 12px 0}";
		...
		var ComposerAttachments_module_css_default = { "rail": "Tub9Vq_rail" };
		//#endregion
		...
		const css = ".RaF_9W_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}.RaF_9W_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}.RaF_9W_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}.RaF_9W_frame{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}.RaF_9W_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}.RaF_9W_frame img{object-fit:cover;width:100%;height:100%;display:block}.RaF_9W_loading,.RaF_9W_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.RaF_9W_error{border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}.RaF_9W_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "RaF_9W_error",
			"frame": "RaF_9W_frame",
			"gallery": "RaF_9W_gallery",
			"loading": "RaF_9W_loading"
		};
		//#endregion
