window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetLabel.module.css.mjs
		const css$2 = ".YOb90W_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.YOb90W_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = "._8pvOKa_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}._8pvOKa_seat:not(:disabled):hover,._8pvOKa_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}._8pvOKa_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}._8pvOKa_seatIcon{color:var(--dsw-alias-label-primary);flex:none}._8pvOKa_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both _8pvOKa_seat-icon-in}@keyframes _8pvOKa_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}._8pvOKa_introText{white-space:pre;display:inline-block}._8pvOKa_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards _8pvOKa_seat-char-in;display:inline-block}@keyframes _8pvOKa_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){._8pvOKa_introIcon,._8pvOKa_introChar{opacity:1;animation:none}}._8pvOKa_chevron{color:var(--dsw-alias-label-caption);flex:none}._8pvOKa_item{flex-direction:column;gap:2px;max-width:280px;display:flex}._8pvOKa_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}._8pvOKa_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "_8pvOKa_chevron",
			"introChar": "_8pvOKa_introChar",
			"introIcon": "_8pvOKa_introIcon",
			"introText": "_8pvOKa_introText",
			"item": "_8pvOKa_item",
			"itemDesc": "_8pvOKa_itemDesc",
			"itemName": "_8pvOKa_itemName",
			"seat": "_8pvOKa_seat",
			"seat-char-in": "_8pvOKa_seat-char-in",
			"seat-icon-in": "_8pvOKa_seat-icon-in",
			"seatIcon": "_8pvOKa_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".aFSiSq_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.aFSiSq_title{margin:0;font-size:18px;font-weight:600}.aFSiSq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.aFSiSq_group{flex-direction:column;gap:10px;display:flex}.aFSiSq_group+.aFSiSq_group{margin-top:20px}.aFSiSq_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.aFSiSq_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.aFSiSq_card{border:.5px solid var(--dsw-alias-border-l4);background:0 0;border-radius:20px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.aFSiSq_card:hover:not(.aFSiSq_cardActive){background:var(--dsw-alias-interactive-bg-hover)}.aFSiSq_cardActive{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}.aFSiSq_cardBroken,.aFSiSq_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.aFSiSq_brokenBadge{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.aFSiSq_brokenTip{z-index:1;background:var(--dsw-alias-label-primary);width:max-content;max-width:100%;color:var(--dsw-alias-bg-layer-3);text-align:left;white-space:pre-line;overflow-wrap:anywhere;opacity:0;pointer-events:none;border-radius:6px;padding:6px 8px;font-size:11px;font-weight:400;line-height:1.5;transition:opacity .12s;position:absolute;top:calc(100% + 6px);left:0}.aFSiSq_brokenBadge:hover .aFSiSq_brokenTip,.aFSiSq_cardMain:focus-visible .aFSiSq_brokenTip{opacity:1}.aFSiSq_cardMain[aria-disabled=true]{cursor:default}.aFSiSq_cardBrokenReason{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.aFSiSq_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.aFSiSq_cardMain:disabled{cursor:default}.aFSiSq_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.aFSiSq_cardHead{align-items:center;gap:8px;display:flex;position:relative}.aFSiSq_cardName{font-size:15px;font-weight:600;line-height:1.4}.aFSiSq_badge,.aFSiSq_inUse{corner-shape:round;white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.aFSiSq_badge{border:.5px solid var(--dsw-alias-border-l4);color:var(--dsw-alias-label-tertiary)}.aFSiSq_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.aFSiSq_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.aFSiSq_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-tertiary);margin-top:auto;font-size:11px}.aFSiSq_cardFoot{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.aFSiSq_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.aFSiSq_iconButton:disabled{opacity:.4;cursor:default}.aFSiSq_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.aFSiSq_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.aFSiSq_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.aFSiSq_iconButton:hover:after,.aFSiSq_iconButton:focus-visible:after{opacity:1}.aFSiSq_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.aFSiSq_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.aFSiSq_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.aFSiSq_revealedPathLabel{white-space:nowrap}.aFSiSq_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.aFSiSq_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.aFSiSq_secondaryButton:disabled{opacity:.5;cursor:default}.aFSiSq_field{flex-direction:column;gap:6px;display:flex}.aFSiSq_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.aFSiSq_input{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.aFSiSq_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.aFSiSq_input::placeholder{color:var(--dsw-alias-label-dimmed)}.aFSiSq_dialog{width:min(560px,100%)}.aFSiSq_dialogFields{flex-direction:column;gap:12px;display:flex}.aFSiSq_viewerCode{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.aFSiSq_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.aFSiSq_deleteDialog{width:min(480px,100%)}.aFSiSq_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.aFSiSq_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.aFSiSq_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.aFSiSq_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.aFSiSq_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "aFSiSq_badge",
			"brokenBadge": "aFSiSq_brokenBadge",
			"brokenTip": "aFSiSq_brokenTip",
			"card": "aFSiSq_card",
			"cardActive": "aFSiSq_cardActive",
			"cardBroken": "aFSiSq_cardBroken",
			"cardBrokenReason": "aFSiSq_cardBrokenReason",
			"cardDesc": "aFSiSq_cardDesc",
			"cardFoot": "aFSiSq_cardFoot",
			"cardHead": "aFSiSq_cardHead",
			"cardId": "aFSiSq_cardId",
			"cardMain": "aFSiSq_cardMain",
			"cardName": "aFSiSq_cardName",
			"cards": "aFSiSq_cards",
			"creatorButton": "aFSiSq_creatorButton",
			"deleteConfirm": "aFSiSq_deleteConfirm",
			"deleteDialog": "aFSiSq_deleteDialog",
			"dialog": "aFSiSq_dialog",
			"dialogFields": "aFSiSq_dialogFields",
			"error": "aFSiSq_error",
			"field": "aFSiSq_field",
			"fieldLabel": "aFSiSq_fieldLabel",
			"group": "aFSiSq_group",
			"groupHead": "aFSiSq_groupHead",
			"iconButton": "aFSiSq_iconButton",
			"iconDanger": "aFSiSq_iconDanger",
			"inUse": "aFSiSq_inUse",
			"input": "aFSiSq_input",
			"intro": "aFSiSq_intro",
			"revealedPath": "aFSiSq_revealedPath",
			"revealedPathLabel": "aFSiSq_revealedPathLabel",
			"secondaryButton": "aFSiSq_secondaryButton",
			"section": "aFSiSq_section",
			"title": "aFSiSq_title",
			"viewerCode": "aFSiSq_viewerCode"
		};
		//#endregion
												...
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														...
														children: [
															...
															row.broken !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
																className: AgentPresetSection_module_css_default.brokenBadge,
																children: [t("brokenBadge"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
