window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$2 = ".KLGnSq_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.KLGnSq_icon{opacity:.7;flex:none}";
		...
		*/
		...
		const css$1 = "._8DlJta_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}._8DlJta_seat:not(:disabled):hover,._8DlJta_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}._8DlJta_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}._8DlJta_seatIcon{color:var(--dsw-alias-label-primary);flex:none}._8DlJta_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both _8DlJta_seat-icon-in}@keyframes _8DlJta_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}._8DlJta_introText{white-space:pre;display:inline-block}._8DlJta_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards _8DlJta_seat-char-in;display:inline-block}@keyframes _8DlJta_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){._8DlJta_introIcon,._8DlJta_introChar{opacity:1;animation:none}}._8DlJta_chevron{color:var(--dsw-alias-label-caption);flex:none}._8DlJta_item{flex-direction:column;gap:2px;max-width:280px;display:flex}._8DlJta_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}._8DlJta_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "_8DlJta_chevron",
			"introChar": "_8DlJta_introChar",
			"introIcon": "_8DlJta_introIcon",
			"introText": "_8DlJta_introText",
			"item": "_8DlJta_item",
			"itemDesc": "_8DlJta_itemDesc",
			"itemName": "_8DlJta_itemName",
			"seat": "_8DlJta_seat",
			"seat-char-in": "_8DlJta_seat-char-in",
			"seat-icon-in": "_8DlJta_seat-icon-in",
			"seatIcon": "_8DlJta_seatIcon"
		};
		//#endregion
		...
		*/
		...
		const css = ".Yy6FWG_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.Yy6FWG_title{margin:0;font-size:18px;font-weight:600}.Yy6FWG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.Yy6FWG_group{flex-direction:column;gap:10px;display:flex}.Yy6FWG_group+.Yy6FWG_group{margin-top:20px}.Yy6FWG_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.Yy6FWG_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.Yy6FWG_card{border:.5px solid var(--dsw-alias-border-l4);background:0 0;border-radius:20px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.Yy6FWG_card:hover:not(.Yy6FWG_cardActive){background:var(--dsw-alias-interactive-bg-hover)}.Yy6FWG_cardActive{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}.Yy6FWG_cardBroken,.Yy6FWG_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.Yy6FWG_brokenBadge{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Yy6FWG_brokenTip{z-index:1;background:var(--dsw-alias-label-primary);width:max-content;max-width:100%;color:var(--dsw-alias-bg-layer-3);text-align:left;white-space:pre-line;overflow-wrap:anywhere;opacity:0;pointer-events:none;border-radius:6px;padding:6px 8px;font-size:11px;font-weight:400;line-height:1.5;transition:opacity .12s;position:absolute;top:calc(100% + 6px);left:0}.Yy6FWG_brokenBadge:hover .Yy6FWG_brokenTip,.Yy6FWG_cardMain:focus-visible .Yy6FWG_brokenTip{opacity:1}.Yy6FWG_cardMain[aria-disabled=true]{cursor:default}.Yy6FWG_cardBrokenReason{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.Yy6FWG_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.Yy6FWG_cardMain:disabled{cursor:default}.Yy6FWG_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Yy6FWG_cardHead{align-items:center;gap:8px;display:flex;position:relative}.Yy6FWG_cardName{font-size:15px;font-weight:600;line-height:1.4}.Yy6FWG_badge,.Yy6FWG_inUse{corner-shape:round;white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Yy6FWG_badge{border:.5px solid var(--dsw-alias-border-l4);color:var(--dsw-alias-label-tertiary)}.Yy6FWG_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.Yy6FWG_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.Yy6FWG_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-tertiary);margin-top:auto;font-size:11px}.Yy6FWG_cardFoot{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.Yy6FWG_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.Yy6FWG_iconButton:disabled{opacity:.4;cursor:default}.Yy6FWG_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.Yy6FWG_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.Yy6FWG_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.Yy6FWG_iconButton:hover:after,.Yy6FWG_iconButton:focus-visible:after{opacity:1}.Yy6FWG_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.Yy6FWG_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.Yy6FWG_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.Yy6FWG_revealedPathLabel{white-space:nowrap}.Yy6FWG_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.Yy6FWG_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.Yy6FWG_secondaryButton:disabled{opacity:.5;cursor:default}.Yy6FWG_field{flex-direction:column;gap:6px;display:flex}.Yy6FWG_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.Yy6FWG_input{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.Yy6FWG_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.Yy6FWG_input::placeholder{color:var(--dsw-alias-label-dimmed)}.Yy6FWG_dialog{width:min(560px,100%)}.Yy6FWG_dialogFields{flex-direction:column;gap:12px;display:flex}.Yy6FWG_viewerCode{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.Yy6FWG_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.Yy6FWG_deleteDialog{width:min(480px,100%)}.Yy6FWG_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.Yy6FWG_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.Yy6FWG_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.Yy6FWG_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Yy6FWG_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "Yy6FWG_badge",
			"brokenBadge": "Yy6FWG_brokenBadge",
			"brokenTip": "Yy6FWG_brokenTip",
			"card": "Yy6FWG_card",
			"cardActive": "Yy6FWG_cardActive",
			"cardBroken": "Yy6FWG_cardBroken",
			"cardBrokenReason": "Yy6FWG_cardBrokenReason",
			"cardDesc": "Yy6FWG_cardDesc",
			"cardFoot": "Yy6FWG_cardFoot",
			"cardHead": "Yy6FWG_cardHead",
			"cardId": "Yy6FWG_cardId",
			"cardMain": "Yy6FWG_cardMain",
			"cardName": "Yy6FWG_cardName",
			"cards": "Yy6FWG_cards",
			"creatorButton": "Yy6FWG_creatorButton",
			"deleteConfirm": "Yy6FWG_deleteConfirm",
			"deleteDialog": "Yy6FWG_deleteDialog",
			"dialog": "Yy6FWG_dialog",
			"dialogFields": "Yy6FWG_dialogFields",
			"error": "Yy6FWG_error",
			"field": "Yy6FWG_field",
			"fieldLabel": "Yy6FWG_fieldLabel",
			"group": "Yy6FWG_group",
			"groupHead": "Yy6FWG_groupHead",
			"iconButton": "Yy6FWG_iconButton",
			"iconDanger": "Yy6FWG_iconDanger",
			"inUse": "Yy6FWG_inUse",
			"input": "Yy6FWG_input",
			"intro": "Yy6FWG_intro",
			"revealedPath": "Yy6FWG_revealedPath",
			"revealedPathLabel": "Yy6FWG_revealedPathLabel",
			"secondaryButton": "Yy6FWG_secondaryButton",
			"section": "Yy6FWG_section",
			"title": "Yy6FWG_title",
			"viewerCode": "Yy6FWG_viewerCode"
		};
		//#endregion
