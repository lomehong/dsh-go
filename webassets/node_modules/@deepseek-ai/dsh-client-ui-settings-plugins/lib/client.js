window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$3 = ".Flg3PG_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.Flg3PG_field+.Flg3PG_field{border-top:.5px solid var(--dsw-alias-border-l2)}.Flg3PG_head{align-items:center;gap:8px;display:flex}.Flg3PG_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.Flg3PG_badges{align-items:center;gap:8px;display:inline-flex}.Flg3PG_badge{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Flg3PG_badgeMuted{corner-shape:round;white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.Flg3PG_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.Flg3PG_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.Flg3PG_reset:disabled{cursor:default}.Flg3PG_input{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Flg3PG_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Flg3PG_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Flg3PG_inputInvalid{border-color:var(--dsw-alias-label-error);}.Flg3PG_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.Flg3PG_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badge": "Flg3PG_badge",
			"badgeMuted": "Flg3PG_badgeMuted",
			"badges": "Flg3PG_badges",
			"field": "Flg3PG_field",
			"head": "Flg3PG_head",
			"hint": "Flg3PG_hint",
			"input": "Flg3PG_input",
			"inputInvalid": "Flg3PG_inputInvalid",
			"invalid": "Flg3PG_invalid",
			"label": "Flg3PG_label",
			"reset": "Flg3PG_reset"
		};
		//#endregion
		...
		*/
		...
		const css$2 = ".QtXd2W_card{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);border-radius:16px;list-style:none;transition:border-color .16s,background .16s}.QtXd2W_card:hover{border-color:var(--dsw-alias-label-dimmed)}.QtXd2W_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.QtXd2W_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.QtXd2W_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.QtXd2W_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.QtXd2W_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.QtXd2W_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.QtXd2W_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.QtXd2W_chevronOpen{transform:rotate(180deg)}.QtXd2W_body{border-top:.5px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.QtXd2W_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.QtXd2W_pending{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.QtXd2W_footer{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.QtXd2W_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.QtXd2W_discard,.QtXd2W_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.QtXd2W_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.QtXd2W_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.QtXd2W_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.QtXd2W_discard:disabled,.QtXd2W_save:disabled{opacity:.4;cursor:default}.QtXd2W_discard:focus-visible,.QtXd2W_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "QtXd2W_body",
			"card": "QtXd2W_card",
			"cardOpen": "QtXd2W_cardOpen",
			"chevron": "QtXd2W_chevron",
			"chevronOpen": "QtXd2W_chevronOpen",
			"description": "QtXd2W_description",
			"discard": "QtXd2W_discard",
			"failed": "QtXd2W_failed",
			"footer": "QtXd2W_footer",
			"headText": "QtXd2W_headText",
			"header": "QtXd2W_header",
			"name": "QtXd2W_name",
			"pending": "QtXd2W_pending",
			"readOnly": "QtXd2W_readOnly",
			"save": "QtXd2W_save"
		};
		//#endregion
		...
		*/
		...
		const css$1 = ".JAlC3W_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.JAlC3W_heading{margin:0;font-size:18px;font-weight:600}.JAlC3W_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.JAlC3W_tabs{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.JAlC3W_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.JAlC3W_tab:hover,.JAlC3W_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.JAlC3W_tab[data-active=true]:after,.JAlC3W_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.JAlC3W_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.JAlC3W_panel{min-width:0;padding-top:2px}.JAlC3W_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.JAlC3W_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "JAlC3W_cards",
			"empty": "JAlC3W_empty",
			"heading": "JAlC3W_heading",
			"intro": "JAlC3W_intro",
			"panel": "JAlC3W_panel",
			"section": "JAlC3W_section",
			"tab": "JAlC3W_tab",
			"tabs": "JAlC3W_tabs"
		};
		//#endregion
		...
		*/
		...
		const css = ".jWZYzW_permission{gap:6px;padding:12px 0;display:grid}.jWZYzW_toggleRow{color:var(--dsw-alias-label-primary);justify-content:space-between;align-items:flex-start;gap:16px;font-size:13px;line-height:1.5;display:flex}.jWZYzW_toggleLabel{flex:1;min-width:0}.jWZYzW_switch{box-sizing:border-box;background:var(--dsw-alias-border-l3);cursor:pointer;border:0;border-radius:10px;flex:none;width:36px;height:20px;padding:2px;position:relative}.jWZYzW_switchOn{background:var(--dsw-alias-brand-primary)}.jWZYzW_switch:disabled{cursor:default;opacity:.5}.jWZYzW_switch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.jWZYzW_thumb{corner-shape:round;background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block}.jWZYzW_switchOn .jWZYzW_thumb{transform:translate(16px)}.jWZYzW_selection{gap:10px;display:grid}.jWZYzW_hint,.jWZYzW_notice,.jWZYzW_invalid,.jWZYzW_conflict{margin:0;font-size:12px;line-height:1.5}.jWZYzW_hint,.jWZYzW_notice{color:var(--dsw-alias-label-tertiary)}.jWZYzW_invalid,.jWZYzW_conflict{color:var(--dsw-alias-label-error)}.jWZYzW_catalogError{color:var(--dsw-alias-label-error);justify-content:space-between;align-items:center;gap:12px;font-size:12px;display:flex}.jWZYzW_catalogError button{color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:0;padding:0}.jWZYzW_models{border:.5px solid var(--dsw-alias-border-l4);border-radius:8px;gap:6px;min-width:0;max-height:280px;margin:0;padding:10px;display:grid;overflow:auto}.jWZYzW_models legend{color:var(--dsw-alias-label-secondary);padding:0 4px;font-size:12px}.jWZYzW_modelGroup{gap:6px;display:grid}.jWZYzW_modelGroup+.jWZYzW_modelGroup{border-top:.5px solid var(--dsw-alias-border-l3);margin-top:4px;padding-top:10px}.jWZYzW_providerName{color:var(--dsw-alias-label-tertiary);padding:0 6px;font-size:11px;font-weight:500}.jWZYzW_model{cursor:pointer;border-radius:6px;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;min-width:0;padding:6px;display:grid}.jWZYzW_model:hover{background:var(--dsw-alias-bg-layer-4)}.jWZYzW_modelName,.jWZYzW_route{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.jWZYzW_modelName{color:var(--dsw-alias-label-primary);font-size:13px}.jWZYzW_route{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px}.jWZYzW_unavailable{color:var(--dsw-alias-label-tertiary);font-size:11px}";
		...
		var SubagentModelSelectionCard_module_css_default = {
			"catalogError": "jWZYzW_catalogError",
			"conflict": "jWZYzW_conflict",
			"hint": "jWZYzW_hint",
			"invalid": "jWZYzW_invalid",
			"model": "jWZYzW_model",
			"modelGroup": "jWZYzW_modelGroup",
			"modelName": "jWZYzW_modelName",
			"models": "jWZYzW_models",
			"notice": "jWZYzW_notice",
			"permission": "jWZYzW_permission",
			"providerName": "jWZYzW_providerName",
			"route": "jWZYzW_route",
			"selection": "jWZYzW_selection",
			"switch": "jWZYzW_switch",
			"switchOn": "jWZYzW_switchOn",
			"thumb": "jWZYzW_thumb",
			"toggleLabel": "jWZYzW_toggleLabel",
			"toggleRow": "jWZYzW_toggleRow",
			"unavailable": "jWZYzW_unavailable"
		};
		//#endregion
