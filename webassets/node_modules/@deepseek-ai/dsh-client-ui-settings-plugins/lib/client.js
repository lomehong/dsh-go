window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-settings-plugins\src\client\fields.module.css.mjs
		const css$3 = ".yzuODa_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.yzuODa_field+.yzuODa_field{border-top:.5px solid var(--dsw-alias-border-l2)}.yzuODa_head{align-items:center;gap:8px;display:flex}.yzuODa_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.yzuODa_badges{align-items:center;gap:8px;display:inline-flex}.yzuODa_badge{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.yzuODa_badgeMuted{corner-shape:round;white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.yzuODa_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.yzuODa_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.yzuODa_reset:disabled{cursor:default}.yzuODa_input{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.yzuODa_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.yzuODa_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.yzuODa_inputInvalid{border-color:var(--dsw-alias-label-error);}.yzuODa_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.yzuODa_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badge": "yzuODa_badge",
			"badgeMuted": "yzuODa_badgeMuted",
			"badges": "yzuODa_badges",
			"field": "yzuODa_field",
			"head": "yzuODa_head",
			"hint": "yzuODa_hint",
			"input": "yzuODa_input",
			"inputInvalid": "yzuODa_inputInvalid",
			"invalid": "yzuODa_invalid",
			"label": "yzuODa_label",
			"reset": "yzuODa_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginCard.module.css.mjs
		const css$2 = ".f9_Gjq_card{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-3);border-radius:16px;list-style:none;transition:border-color .16s,background .16s}.f9_Gjq_card:hover{border-color:var(--dsw-alias-label-dimmed)}.f9_Gjq_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.f9_Gjq_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.f9_Gjq_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.f9_Gjq_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.f9_Gjq_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.f9_Gjq_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.f9_Gjq_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.f9_Gjq_chevronOpen{transform:rotate(180deg)}.f9_Gjq_body{border-top:.5px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.f9_Gjq_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.f9_Gjq_pending{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.f9_Gjq_footer{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.f9_Gjq_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.f9_Gjq_discard,.f9_Gjq_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.f9_Gjq_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.f9_Gjq_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.f9_Gjq_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.f9_Gjq_discard:disabled,.f9_Gjq_save:disabled{opacity:.4;cursor:default}.f9_Gjq_discard:focus-visible,.f9_Gjq_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "f9_Gjq_body",
			"card": "f9_Gjq_card",
			"cardOpen": "f9_Gjq_cardOpen",
			"chevron": "f9_Gjq_chevron",
			"chevronOpen": "f9_Gjq_chevronOpen",
			"description": "f9_Gjq_description",
			"discard": "f9_Gjq_discard",
			"failed": "f9_Gjq_failed",
			"footer": "f9_Gjq_footer",
			"headText": "f9_Gjq_headText",
			"header": "f9_Gjq_header",
			"name": "f9_Gjq_name",
			"pending": "f9_Gjq_pending",
			"readOnly": "f9_Gjq_readOnly",
			"save": "f9_Gjq_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginsSettingsSection.module.css.mjs
		const css$1 = ".Mn17wa_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.Mn17wa_heading{margin:0;font-size:18px;font-weight:600}.Mn17wa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.Mn17wa_tabs{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.Mn17wa_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.Mn17wa_tab:hover,.Mn17wa_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.Mn17wa_tab[data-active=true]:after,.Mn17wa_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.Mn17wa_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.Mn17wa_panel{min-width:0;padding-top:2px}.Mn17wa_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.Mn17wa_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "Mn17wa_cards",
			"empty": "Mn17wa_empty",
			"heading": "Mn17wa_heading",
			"intro": "Mn17wa_intro",
			"panel": "Mn17wa_panel",
			"section": "Mn17wa_section",
			"tab": "Mn17wa_tab",
			"tabs": "Mn17wa_tabs"
		};
		//#endregion
		...
		*/
		function ConfigurablePluginsTab(props) {
			...
			if (namespaces.length > 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
				className: PluginsSettingsSection_module_css_default.cards,
				children: namespaces.map((ns) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: renderSlot("settings.plugin.item", {}, { entryKey: ns }) }, ns))
			});
			return loaded ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-settings-plugins\src\client\SubagentModelSelectionCard.module.css.mjs
		const css = ".V1qMXG_permission{gap:6px;padding:12px 0;display:grid}.V1qMXG_toggleRow{color:var(--dsw-alias-label-primary);justify-content:space-between;align-items:flex-start;gap:16px;font-size:13px;line-height:1.5;display:flex}.V1qMXG_toggleLabel{flex:1;min-width:0}.V1qMXG_switch{box-sizing:border-box;background:var(--dsw-alias-border-l3);cursor:pointer;border:0;border-radius:10px;flex:none;width:36px;height:20px;padding:2px;position:relative}.V1qMXG_switchOn{background:var(--dsw-alias-brand-primary)}.V1qMXG_switch:disabled{cursor:default;opacity:.5}.V1qMXG_switch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.V1qMXG_thumb{corner-shape:round;background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block}.V1qMXG_switchOn .V1qMXG_thumb{transform:translate(16px)}.V1qMXG_selection{gap:10px;display:grid}.V1qMXG_hint,.V1qMXG_notice,.V1qMXG_invalid,.V1qMXG_conflict{margin:0;font-size:12px;line-height:1.5}.V1qMXG_hint,.V1qMXG_notice{color:var(--dsw-alias-label-tertiary)}.V1qMXG_invalid,.V1qMXG_conflict{color:var(--dsw-alias-label-error)}.V1qMXG_catalogError{color:var(--dsw-alias-label-error);justify-content:space-between;align-items:center;gap:12px;font-size:12px;display:flex}.V1qMXG_catalogError button{color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:0;padding:0}.V1qMXG_models{border:.5px solid var(--dsw-alias-border-l4);border-radius:8px;gap:6px;min-width:0;max-height:280px;margin:0;padding:10px;display:grid;overflow:auto}.V1qMXG_models legend{color:var(--dsw-alias-label-secondary);padding:0 4px;font-size:12px}.V1qMXG_modelGroup{gap:6px;display:grid}.V1qMXG_modelGroup+.V1qMXG_modelGroup{border-top:.5px solid var(--dsw-alias-border-l3);margin-top:4px;padding-top:10px}.V1qMXG_providerName{color:var(--dsw-alias-label-tertiary);padding:0 6px;font-size:11px;font-weight:500}.V1qMXG_model{cursor:pointer;border-radius:6px;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;min-width:0;padding:6px;display:grid}.V1qMXG_model:hover{background:var(--dsw-alias-bg-layer-4)}.V1qMXG_modelName,.V1qMXG_route{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.V1qMXG_modelName{color:var(--dsw-alias-label-primary);font-size:13px}.V1qMXG_route{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px}.V1qMXG_unavailable{color:var(--dsw-alias-label-tertiary);font-size:11px}";
		...
		var SubagentModelSelectionCard_module_css_default = {
			"catalogError": "V1qMXG_catalogError",
			"conflict": "V1qMXG_conflict",
			"hint": "V1qMXG_hint",
			"invalid": "V1qMXG_invalid",
			"model": "V1qMXG_model",
			"modelGroup": "V1qMXG_modelGroup",
			"modelName": "V1qMXG_modelName",
			"models": "V1qMXG_models",
			"notice": "V1qMXG_notice",
			"permission": "V1qMXG_permission",
			"providerName": "V1qMXG_providerName",
			"route": "V1qMXG_route",
			"selection": "V1qMXG_selection",
			"switch": "V1qMXG_switch",
			"switchOn": "V1qMXG_switchOn",
			"thumb": "V1qMXG_thumb",
			"toggleLabel": "V1qMXG_toggleLabel",
			"toggleRow": "V1qMXG_toggleRow",
			"unavailable": "V1qMXG_unavailable"
		};
		//#endregion
		//#region src/client/SubagentModelSelectionCard.tsx
		...
		function SubagentModelSelectionCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(PluginCard, {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: SubagentModelSelectionCard_module_css_default.thumb })
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					state.enabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: SubagentModelSelectionCard_module_css_default.selection,
						children: [
							state.catalogStatus === "loading" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: SubagentModelSelectionCard_module_css_default.notice,
								role: "status",
								children: t("subagentModelSelectionLoading")
							}) : null,
							state.catalogStatus === "error" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: SubagentModelSelectionCard_module_css_default.catalogError,
								role: "alert",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("subagentModelSelectionLoadFailed") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
							...
							state.catalogPartial ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: SubagentModelSelectionCard_module_css_default.notice,
								children: t("subagentModelSelectionPartial")
							}) : null,
							state.candidates.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("fieldset", {
								className: SubagentModelSelectionCard_module_css_default.models,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("legend", { children: t("subagentModelSelectionAllowed") }),
							...
							}) : state.catalogStatus === "ready" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: SubagentModelSelectionCard_module_css_default.notice,
		...
		*/
		...
		//#endregion
		//#region src/client/subagent-model-selection-card-controller.ts
