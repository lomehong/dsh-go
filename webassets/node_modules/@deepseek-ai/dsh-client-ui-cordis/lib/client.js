window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisRunRow.module.css.mjs
		const css$2 = ".ISHFgq_card{flex-direction:column;gap:8px;display:flex}.ISHFgq_row{align-items:center;min-height:32px;display:flex}.ISHFgq_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.ISHFgq_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.ISHFgq_separator{corner-shape:round;background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.ISHFgq_summary,.ISHFgq_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.ISHFgq_error{color:var(--dsw-alias-state-error-primary)}.ISHFgq_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.ISHFgq_card[data-cordis-status=awaiting-approval] .ISHFgq_status,.ISHFgq_card[data-cordis-status=client-pending] .ISHFgq_status{color:var(--dsw-alias-state-warn-label)}.ISHFgq_card[data-cordis-status=running] .ISHFgq_status{color:var(--dsw-alias-state-success-primary)}.ISHFgq_card[data-cordis-status=failed] .ISHFgq_status{color:var(--dsw-alias-state-error-primary)}.ISHFgq_inspect{corner-shape:round;width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.ISHFgq_card:hover .ISHFgq_inspect,.ISHFgq_inspect:focus-visible{opacity:1}.ISHFgq_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.ISHFgq_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.ISHFgq_business{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.ISHFgq_output{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.ISHFgq_business .ISHFgq_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "ISHFgq_business",
			"card": "ISHFgq_card",
			"error": "ISHFgq_error",
			"icon": "ISHFgq_icon",
			"inspect": "ISHFgq_inspect",
			"message": "ISHFgq_message",
			"output": "ISHFgq_output",
			"row": "ISHFgq_row",
			"separator": "ISHFgq_separator",
			"status": "ISHFgq_status",
			"summary": "ISHFgq_summary",
			"title": "ISHFgq_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisDefineRow.module.css.mjs
		const css$1 = ".SIEMbG_card{flex-direction:column;display:flex}.SIEMbG_card .SIEMbG_title,.SIEMbG_card .SIEMbG_chevron{color:var(--dsw-alias-state-business-primary)}.SIEMbG_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.SIEMbG_row{gap:0}.SIEMbG_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.SIEMbG_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.SIEMbG_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.SIEMbG_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.SIEMbG_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.SIEMbG_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.SIEMbG_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.SIEMbG_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.SIEMbG_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.SIEMbG_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.SIEMbG_switch{height:22px;padding:0 8px;font-size:12px}.SIEMbG_card[data-terminal] .SIEMbG_title,.SIEMbG_card[data-terminal] .SIEMbG_name,.SIEMbG_card[data-terminal] .SIEMbG_purpose,.SIEMbG_card[data-terminal] .SIEMbG_statusLabel{color:var(--dsw-alias-label-caption)}.SIEMbG_card[data-terminal] .SIEMbG_separator{background:var(--dsw-alias-label-caption)}.SIEMbG_bodyWrap{flex-direction:column;display:flex}.SIEMbG_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.SIEMbG_sourceTabs{border-bottom:.5px solid var(--dsw-alias-border-l2);height:32px;display:flex}.SIEMbG_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.SIEMbG_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.SIEMbG_sourceTab:disabled{cursor:default;opacity:.4}.SIEMbG_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.SIEMbG_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.SIEMbG_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.SIEMbG_sourcePanel{max-height:260px;overflow:auto}.SIEMbG_sourceCode{margin:0}.SIEMbG_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.SIEMbG_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.SIEMbG_output{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.SIEMbG_output[data-error]{color:var(--dsw-alias-state-error-primary)}.SIEMbG_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.SIEMbG_card:hover .SIEMbG_inspectButton,.SIEMbG_inspectButton:focus-visible{opacity:1}.SIEMbG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.SIEMbG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.SIEMbG_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "SIEMbG_approvalPrompt",
			"bodyWrap": "SIEMbG_bodyWrap",
			"card": "SIEMbG_card",
			"chevron": "SIEMbG_chevron",
			"codeSection": "SIEMbG_codeSection",
			"errorSummary": "SIEMbG_errorSummary",
			"inspectButton": "SIEMbG_inspectButton",
			"name": "SIEMbG_name",
			"notice": "SIEMbG_notice",
			"output": "SIEMbG_output",
			"panelHint": "SIEMbG_panelHint",
			"purpose": "SIEMbG_purpose",
			"readout": "SIEMbG_readout",
			"requestError": "SIEMbG_requestError",
			"row": "SIEMbG_row",
			"sectionLabel": "SIEMbG_sectionLabel",
			"separator": "SIEMbG_separator",
			"sourceCard": "SIEMbG_sourceCard",
			"sourceCode": "SIEMbG_sourceCode",
			"sourcePanel": "SIEMbG_sourcePanel",
			"sourceTab": "SIEMbG_sourceTab",
			"sourceTabActive": "SIEMbG_sourceTabActive",
			"sourceTabs": "SIEMbG_sourceTabs",
			"statusLabel": "SIEMbG_statusLabel",
			"switch": "SIEMbG_switch",
			"title": "SIEMbG_title",
			"visuallyHidden": "SIEMbG_visuallyHidden"
		};
		//#endregion
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							inspect !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								onClick: inspect,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconInspectOutline12, {}), t("action.inspect")]
							})
						]
					})
				})]
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisPanel.module.css.mjs
		const css = ".mojCrG_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.mojCrG_footerButtons{align-items:center;width:100%;display:flex}.mojCrG_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.mojCrG_badge:hover,.mojCrG_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.mojCrG_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.mojCrG_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.mojCrG_layer.mojCrG_rail{width:36px;height:36px;margin:0}.mojCrG_rail .mojCrG_badge{corner-shape:round;border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.mojCrG_rail .mojCrG_footerButtons{flex-direction:column;gap:2px}.mojCrG_panel{z-index:30;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.mojCrG_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.mojCrG_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.mojCrG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.mojCrG_note,.mojCrG_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.mojCrG_readError{color:var(--dsw-alias-state-error-primary)}.mojCrG_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.mojCrG_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.mojCrG_row{border:.5px solid var(--dsw-alias-border-l4);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.mojCrG_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.mojCrG_rowHead{align-items:center;gap:8px;display:flex}.mojCrG_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.mojCrG_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.mojCrG_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.mojCrG_row[data-cordis-status=idle] .mojCrG_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.mojCrG_row[data-cordis-status=awaiting-approval] .mojCrG_rowStatus,.mojCrG_row[data-cordis-status=client-pending] .mojCrG_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.mojCrG_row[data-cordis-status=failed] .mojCrG_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.mojCrG_row[data-cordis-status=running] .mojCrG_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.mojCrG_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.mojCrG_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.mojCrG_versionPicker select{border:.5px solid var(--dsw-alias-border-l3);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.mojCrG_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.mojCrG_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.mojCrG_rowActions{flex:none;align-items:center;gap:10px;display:flex}.mojCrG_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.mojCrG_transitionActions{gap:6px;margin-left:auto;display:flex}.mojCrG_transitionActions button{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.mojCrG_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.mojCrG_transitionActions button:disabled{opacity:.4;cursor:default}.mojCrG_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.mojCrG_actionButton{corner-shape:round;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.mojCrG_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.mojCrG_actionButton:disabled{opacity:.4;cursor:default}.mojCrG_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.mojCrG_doubleCheck svg{position:absolute;top:1px}.mojCrG_doubleCheck svg:first-child{opacity:.7;left:0}.mojCrG_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "mojCrG_actionButton",
			"activeVersion": "mojCrG_activeVersion",
			"badge": "mojCrG_badge",
			"badgeCount": "mojCrG_badgeCount",
			"badgeLabel": "mojCrG_badgeLabel",
			"body": "mojCrG_body",
			"doubleCheck": "mojCrG_doubleCheck",
			"footerButtons": "mojCrG_footerButtons",
			"group": "mojCrG_group",
			"header": "mojCrG_header",
			"layer": "mojCrG_layer",
			"note": "mojCrG_note",
			"panel": "mojCrG_panel",
			"rail": "mojCrG_rail",
			"readError": "mojCrG_readError",
			"row": "mojCrG_row",
			"rowActions": "mojCrG_rowActions",
			"rowDetail": "mojCrG_rowDetail",
			"rowError": "mojCrG_rowError",
			"rowHead": "mojCrG_rowHead",
			"rowId": "mojCrG_rowId",
			"rowName": "mojCrG_rowName",
			"rowPurpose": "mojCrG_rowPurpose",
			"rowStatus": "mojCrG_rowStatus",
			"rows": "mojCrG_rows",
			"title": "mojCrG_title",
			"transition": "mojCrG_transition",
			"transitionActions": "mojCrG_transitionActions",
			"versionPicker": "mojCrG_versionPicker"
		};
		//#endregion
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [open && anchor !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCordisPluginOutline14, { size: wide ? 16 : 18 }), wide && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
