window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/trajectory-event-projection.ts
		...
		*/
		...
		//#endregion
		//#region src/client/copy-codes.ts
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = "._3wsoOW_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}._3wsoOW_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:_3wsoOW_trajectory-table/inline-size}._3wsoOW_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}._3wsoOW_historyLoadingBar{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}._3wsoOW_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);corner-shape:round;border-radius:50%;width:10px;height:10px;animation:.7s linear infinite _3wsoOW_history-loading-spin}._3wsoOW_table tbody ._3wsoOW_historyLoadRow td{height:30px;padding:0}._3wsoOW_table tbody ._3wsoOW_historyLoadRow+tr[data-turn-start=true] td:before{content:none}._3wsoOW_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}._3wsoOW_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._3wsoOW_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._3wsoOW_historyLoadButton:disabled{cursor:default}._3wsoOW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}._3wsoOW_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes _3wsoOW_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){._3wsoOW_historyLoadingSpinner{animation:none}}._3wsoOW_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}._3wsoOW_eventColumn{width:122px}._3wsoOW_contentColumn{width:auto}._3wsoOW_table th{z-index:3;box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}._3wsoOW_eventHeader{text-align:right!important;padding-right:4px!important}._3wsoOW_table td{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}._3wsoOW_table tbody ._3wsoOW_virtualSpacer{pointer-events:none}._3wsoOW_table tbody ._3wsoOW_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}._3wsoOW_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}._3wsoOW_table tbody tr[data-timeline-focus=outside]{opacity:.24}._3wsoOW_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}._3wsoOW_table tbody tr[data-request-only=true]:hover{background:0 0}._3wsoOW_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}._3wsoOW_table tbody tr[data-terminal-request-boundary=true] td{height:9px}._3wsoOW_table tbody tr[data-request-only=true] ._3wsoOW_turnRail{top:-15px;bottom:0}._3wsoOW_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}._3wsoOW_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}._3wsoOW_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}._3wsoOW_requestBoundaryControl:before{corner-shape:round;background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}._3wsoOW_requestBoundaryControl:after{border:.5px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}._3wsoOW_requestBoundaryControl:hover:before,._3wsoOW_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}._3wsoOW_requestBoundaryControlActive:before,._3wsoOW_requestBoundaryControlActive:hover:before,._3wsoOW_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}._3wsoOW_requestBoundaryControl[data-request-status=error]:before,._3wsoOW_requestBoundaryControl[data-request-status=error]:hover:before,._3wsoOW_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}._3wsoOW_requestBoundaryControl:hover:after,._3wsoOW_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}._3wsoOW_requestBoundaryControl:focus-visible{outline:none}._3wsoOW_table tbody tr:has(._3wsoOW_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}._3wsoOW_event{position:relative}._3wsoOW_turnRail,._3wsoOW_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}._3wsoOW_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}._3wsoOW_table tbody tr[data-turn-end=true] ._3wsoOW_turnRail{bottom:0}._3wsoOW_selectionRail{z-index:5;width:3px;top:0;bottom:0}._3wsoOW_table tbody tr[data-error=true] ._3wsoOW_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}._3wsoOW_table tbody tr[data-error=true] ._3wsoOW_selectionRail{background:var(--dsw-alias-state-error-primary)}._3wsoOW_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}._3wsoOW_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}._3wsoOW_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}._3wsoOW_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}._3wsoOW_turnLabelFull,._3wsoOW_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}._3wsoOW_turnLabelCompact{opacity:0;max-width:0}._3wsoOW_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}._3wsoOW_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}._3wsoOW_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}._3wsoOW_kindSlot [role=tooltip]{background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);border:0}._3wsoOW_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}._3wsoOW_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}._3wsoOW_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}._3wsoOW_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}._3wsoOW_table ._3wsoOW_kindSlot ._3wsoOW_message{justify-content:center;width:100%}@container _3wsoOW_trajectory-table (width<=620px){._3wsoOW_eventColumn{width:50px}._3wsoOW_event{padding-left:28px!important;padding-right:3px!important}._3wsoOW_requestBoundaryControl{--request-boundary-base-left:6px}._3wsoOW_kindSlot{width:19px}._3wsoOW_kindTag,._3wsoOW_table ._3wsoOW_kindSlot ._3wsoOW_message{justify-content:center;width:19px;padding-left:0;padding-right:0}._3wsoOW_kindTagIcon{opacity:1;width:13px;transform:scale(1)}._3wsoOW_kindTagLabel,._3wsoOW_turnLabelFull{opacity:0;max-width:0}._3wsoOW_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){._3wsoOW_eventColumn,._3wsoOW_event,._3wsoOW_requestBoundaryControl,._3wsoOW_kindSlot,._3wsoOW_kindTag,._3wsoOW_kindTagIcon,._3wsoOW_kindTagLabel,._3wsoOW_turnLabelFull,._3wsoOW_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}._3wsoOW_eventColumn,._3wsoOW_kindSlot{transition-property:width}._3wsoOW_event{transition-property:padding-right,padding-left}._3wsoOW_requestBoundaryControl{transition-property:left}._3wsoOW_kindTag{transition-property:padding-right,padding-left}._3wsoOW_kindTagIcon{transition-property:width,opacity,transform}._3wsoOW_kindTagLabel,._3wsoOW_turnLabelFull,._3wsoOW_turnLabelCompact{transition-property:max-width,opacity}}._3wsoOW_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}._3wsoOW_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}._3wsoOW_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}._3wsoOW_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}._3wsoOW_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}._3wsoOW_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}._3wsoOW_promptDiffSection{min-width:0}._3wsoOW_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}._3wsoOW_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}._3wsoOW_promptDiff span{min-width:max-content;padding:0 6px;display:block}._3wsoOW_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}._3wsoOW_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}._3wsoOW_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}._3wsoOW_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}._3wsoOW_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}._3wsoOW_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}._3wsoOW_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}._3wsoOW_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}._3wsoOW_toolCallOnly{color:var(--dsw-alias-label-tertiary)}._3wsoOW_table tbody tr[data-collapsed-summary=turn] td,._3wsoOW_table tbody tr[data-collapsed-summary=assistant] td{height:20px}._3wsoOW_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}._3wsoOW_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}._3wsoOW_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}._3wsoOW_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}._3wsoOW_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}._3wsoOW_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._3wsoOW_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}._3wsoOW_resultRequest,._3wsoOW_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._3wsoOW_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}._3wsoOW_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}._3wsoOW_table tbody tr[data-kind=tool] ._3wsoOW_contentText,._3wsoOW_table tbody tr[data-kind=subtool] ._3wsoOW_contentText,._3wsoOW_table tbody tr[data-kind=tool] ._3wsoOW_resultPreview,._3wsoOW_table tbody tr[data-kind=subtool] ._3wsoOW_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}._3wsoOW_table tbody tr[data-kind=subtool] ._3wsoOW_content{padding-left:26px}._3wsoOW_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}._3wsoOW_noOutputText{color:var(--dsw-alias-label-caption)}._3wsoOW_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}._3wsoOW_error,._3wsoOW_overview dd._3wsoOW_error,._3wsoOW_details ._3wsoOW_errorPayload{color:var(--dsw-alias-state-error-primary)}._3wsoOW_details ._3wsoOW_errorPayload ._3wsoOW_resultBlockText{color:inherit}._3wsoOW_details ._3wsoOW_jsonPayload._3wsoOW_errorPayload,._3wsoOW_details ._3wsoOW_jsonPreview._3wsoOW_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}._3wsoOW_details{border-left:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}._3wsoOW_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}._3wsoOW_detailsResizeHandle:focus-visible{outline:none}._3wsoOW_detailsHeader{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}._3wsoOW_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}._3wsoOW_requestDetailsDot{corner-shape:round;background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}._3wsoOW_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}._3wsoOW_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3wsoOW_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}._3wsoOW_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._3wsoOW_detailTabs{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}._3wsoOW_detailTabs::-webkit-scrollbar{display:none}._3wsoOW_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}._3wsoOW_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._3wsoOW_detailTabActive{color:var(--dsw-alias-state-business-primary)}._3wsoOW_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}._3wsoOW_close:focus-visible,._3wsoOW_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._3wsoOW_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}._3wsoOW_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}._3wsoOW_detailBodySummary>._3wsoOW_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}._3wsoOW_detailBodySummary>._3wsoOW_compactedSummary{flex:1;min-height:0;overflow:auto}._3wsoOW_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}._3wsoOW_summaryScrollRegion:hover,._3wsoOW_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}._3wsoOW_compactedSummary ._3wsoOW_markdownPayload{padding-right:18px}._3wsoOW_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}._3wsoOW_overviewParentLinks{gap:14px;display:flex}._3wsoOW_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}._3wsoOW_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}._3wsoOW_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}._3wsoOW_overviewHierarchyNavLink:hover ._3wsoOW_overviewHierarchyJumpIconTight,._3wsoOW_overviewHierarchyNavLink:focus-visible ._3wsoOW_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}._3wsoOW_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._3wsoOW_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}._3wsoOW_overview>._3wsoOW_requestTokenDetail dt{padding-left:12px}._3wsoOW_usagePanel{padding:4px 0 10px}._3wsoOW_usageGroup+._3wsoOW_usageGroup{margin-top:8px}._3wsoOW_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}._3wsoOW_usageGroup ._3wsoOW_overview{padding:0}._3wsoOW_overview dt{color:var(--dsw-alias-label-tertiary)}._3wsoOW_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}._3wsoOW_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}._3wsoOW_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._3wsoOW_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}._3wsoOW_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}._3wsoOW_overviewSection+._3wsoOW_overviewSection{padding-top:8px}._3wsoOW_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}._3wsoOW_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}._3wsoOW_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}._3wsoOW_overviewTitle:hover ._3wsoOW_overviewTitleIcon{color:var(--dsw-alias-label-primary)}._3wsoOW_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._3wsoOW_overviewTitle:focus-visible ._3wsoOW_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}._3wsoOW_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}._3wsoOW_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}._3wsoOW_overviewPreview ._3wsoOW_jsonPreview>:first-child,._3wsoOW_overviewPreview ._3wsoOW_schemaTree>:first-child{padding-bottom:0}._3wsoOW_overviewPreview ._3wsoOW_schemaTree{margin-bottom:0}._3wsoOW_overviewPreview ._3wsoOW_overview{padding:2px 0 0}._3wsoOW_overviewPreview ._3wsoOW_overview>div{min-height:22px}._3wsoOW_markdownPreview,._3wsoOW_markdownPayload{color:var(--dsw-alias-label-primary)}._3wsoOW_markdownPreview>div,._3wsoOW_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}._3wsoOW_markdownPreview>div h1,._3wsoOW_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}._3wsoOW_markdownPreview>div h2,._3wsoOW_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}._3wsoOW_markdownPreview>div :where(h3,h4,h5,h6),._3wsoOW_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}._3wsoOW_markdownPreview>div :not(pre)>code,._3wsoOW_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}._3wsoOW_markdownPreview>div table,._3wsoOW_markdownPayload>div table{font:var(--dsw-font-xs-13)}._3wsoOW_markdownPreview>div>:first-child{margin-top:0}._3wsoOW_markdownPreview>div>:last-child{margin-bottom:0}._3wsoOW_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}._3wsoOW_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}._3wsoOW_markdownPreview>div :where(p,ul,ol){margin:8px 0}._3wsoOW_markdownPreview>div li:not(:first-child){margin-top:3px}._3wsoOW_markdownPreview>div blockquote{margin-top:8px}._3wsoOW_markdownPreview>div hr{margin:14px 0}._3wsoOW_markdownPreview>div>.md-code-block{margin:10px 0}._3wsoOW_assistantContent ._3wsoOW_markdownPayload,._3wsoOW_assistantContent ._3wsoOW_payload{min-height:0}._3wsoOW_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}._3wsoOW_thinkingQuoteOnlyPreview{margin-bottom:8px}._3wsoOW_detailBody>._3wsoOW_assistantContentRendered ._3wsoOW_thinkingQuote{margin-top:14px}._3wsoOW_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}._3wsoOW_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}._3wsoOW_thinkingToggle[aria-expanded=true] ._3wsoOW_thinkingChevron{transform:rotate(90deg)}._3wsoOW_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}._3wsoOW_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._3wsoOW_thinkingQuote ._3wsoOW_markdownPreview,._3wsoOW_thinkingQuote ._3wsoOW_markdownPayload,._3wsoOW_thinkingQuote ._3wsoOW_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}._3wsoOW_assistantOutput{background:var(--dsw-alias-bg-layer-1)}._3wsoOW_markdownPreview{padding:6px 14px 8px}._3wsoOW_markdownPayload{min-height:100%;padding:14px}._3wsoOW_jsonPayload{min-height:100%}._3wsoOW_jsonPreview{min-height:0}._3wsoOW_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}._3wsoOW_schemaPreview{min-height:0}._3wsoOW_schemaIntro{padding:12px 14px 6px}._3wsoOW_schemaPreview ._3wsoOW_schemaIntro{padding-top:6px}._3wsoOW_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}._3wsoOW_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}._3wsoOW_schemaParameters{min-width:0}._3wsoOW_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}._3wsoOW_schemaTree{margin:0 6px 8px 0}._3wsoOW_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}._3wsoOW_payloadPreview{min-height:0;padding:6px 14px 8px}._3wsoOW_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}._3wsoOW_sourceBlock+._3wsoOW_sourceBlock{margin-top:14px}._3wsoOW_sourceBlockHeader,._3wsoOW_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}._3wsoOW_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}._3wsoOW_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}._3wsoOW_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}._3wsoOW_sourceBlockJumpTarget:hover ._3wsoOW_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}._3wsoOW_sourceBlockJumpTarget:focus-visible{outline:none}._3wsoOW_sourceBlockJumpTarget:focus-visible ._3wsoOW_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}._3wsoOW_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}._3wsoOW_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}._3wsoOW_messageImagesPreview{gap:6px;margin:6px 14px 8px}._3wsoOW_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}._3wsoOW_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}._3wsoOW_assistantToolCalls li{min-width:0}._3wsoOW_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}._3wsoOW_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._3wsoOW_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._3wsoOW_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}._3wsoOW_assistantToolCallButton:hover ._3wsoOW_assistantToolCallIcon,._3wsoOW_assistantToolCallButton:focus-visible ._3wsoOW_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}._3wsoOW_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}._3wsoOW_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}._3wsoOW_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3wsoOW_systemPrompt{box-sizing:border-box}._3wsoOW_toolCatalog{min-height:100%;padding:8px 0 16px}._3wsoOW_toolCatalogItem{border-bottom:.5px solid var(--dsw-alias-border-l1)}._3wsoOW_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}._3wsoOW_toolCatalogSummary::-webkit-details-marker{display:none}._3wsoOW_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}._3wsoOW_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._3wsoOW_toolCatalogChevron,._3wsoOW_toolCatalogIcon{color:var(--dsw-alias-label-caption)}._3wsoOW_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}._3wsoOW_toolCatalogItem[open] ._3wsoOW_toolCatalogChevron{transform:rotate(90deg)}._3wsoOW_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}._3wsoOW_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3wsoOW_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}._3wsoOW_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}._3wsoOW_toolCatalogTree{margin-left:-14px;margin-right:6px}._3wsoOW_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}._3wsoOW_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}._3wsoOW_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}._3wsoOW_overviewPreview ._3wsoOW_noPayload{padding:6px 14px 8px}._3wsoOW_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){._3wsoOW_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "_3wsoOW_arrow",
			"assistantContent": "_3wsoOW_assistantContent",
			"assistantContentRendered": "_3wsoOW_assistantContentRendered",
			"assistantOutput": "_3wsoOW_assistantOutput",
			"assistantToolCallArgs": "_3wsoOW_assistantToolCallArgs",
			"assistantToolCallButton": "_3wsoOW_assistantToolCallButton",
			"assistantToolCallIcon": "_3wsoOW_assistantToolCallIcon",
			"assistantToolCallName": "_3wsoOW_assistantToolCallName",
			"assistantToolCallText": "_3wsoOW_assistantToolCallText",
			"assistantToolCalls": "_3wsoOW_assistantToolCalls",
			"assistantToolCallsPreview": "_3wsoOW_assistantToolCallsPreview",
			"assistantVioletBright": "_3wsoOW_assistantVioletBright",
			"close": "_3wsoOW_close",
			"collapsedTurnContent": "_3wsoOW_collapsedTurnContent",
			"collapsedTurnEllipsis": "_3wsoOW_collapsedTurnEllipsis",
			"collapsedTurnText": "_3wsoOW_collapsedTurnText",
			"compacted": "_3wsoOW_compacted",
			"compactedSummary": "_3wsoOW_compactedSummary",
			"content": "_3wsoOW_content",
			"contentColumn": "_3wsoOW_contentColumn",
			"contentText": "_3wsoOW_contentText",
			"contextGreen": "_3wsoOW_contextGreen",
			"detailBody": "_3wsoOW_detailBody",
			"detailBodySummary": "_3wsoOW_detailBodySummary",
			"detailTab": "_3wsoOW_detailTab",
			"detailTabActive": "_3wsoOW_detailTabActive",
			"detailTabs": "_3wsoOW_detailTabs",
			"details": "_3wsoOW_details",
			"detailsHeader": "_3wsoOW_detailsHeader",
			"detailsLocation": "_3wsoOW_detailsLocation",
			"detailsResizeHandle": "_3wsoOW_detailsResizeHandle",
			"detailsTitle": "_3wsoOW_detailsTitle",
			"error": "_3wsoOW_error",
			"errorPayload": "_3wsoOW_errorPayload",
			"event": "_3wsoOW_event",
			"eventColumn": "_3wsoOW_eventColumn",
			"eventHeader": "_3wsoOW_eventHeader",
			"eventInner": "_3wsoOW_eventInner",
			"history-loading-spin": "_3wsoOW_history-loading-spin",
			"historyLoadButton": "_3wsoOW_historyLoadButton",
			"historyLoadRow": "_3wsoOW_historyLoadRow",
			"historyLoading": "_3wsoOW_historyLoading",
			"historyLoadingBar": "_3wsoOW_historyLoadingBar",
			"historyLoadingSpinner": "_3wsoOW_historyLoadingSpinner",
			"inlineResult": "_3wsoOW_inlineResult",
			"inlineResultText": "_3wsoOW_inlineResultText",
			"jsonPayload": "_3wsoOW_jsonPayload",
			"jsonPreview": "_3wsoOW_jsonPreview",
			"kindSlot": "_3wsoOW_kindSlot",
			"kindTag": "_3wsoOW_kindTag",
			"kindTagIcon": "_3wsoOW_kindTagIcon",
			"kindTagLabel": "_3wsoOW_kindTagLabel",
			"markdownPayload": "_3wsoOW_markdownPayload",
			"markdownPreview": "_3wsoOW_markdownPreview",
			"message": "_3wsoOW_message",
			"messageImages": "_3wsoOW_messageImages",
			"messageImagesPreview": "_3wsoOW_messageImagesPreview",
			"noOutputText": "_3wsoOW_noOutputText",
			"noPayload": "_3wsoOW_noPayload",
			"overview": "_3wsoOW_overview",
			"overviewHeading": "_3wsoOW_overviewHeading",
			"overviewHierarchyJumpIconTight": "_3wsoOW_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "_3wsoOW_overviewHierarchyNavLink",
			"overviewParentLinks": "_3wsoOW_overviewParentLinks",
			"overviewPreview": "_3wsoOW_overviewPreview",
			"overviewSection": "_3wsoOW_overviewSection",
			"overviewSections": "_3wsoOW_overviewSections",
			"overviewTitle": "_3wsoOW_overviewTitle",
			"overviewTitleIcon": "_3wsoOW_overviewTitleIcon",
			"payload": "_3wsoOW_payload",
			"payloadPreview": "_3wsoOW_payloadPreview",
			"promptDiff": "_3wsoOW_promptDiff",
			"promptDiffLineadded": "_3wsoOW_promptDiffLineadded",
			"promptDiffLinecontext": "_3wsoOW_promptDiffLinecontext",
			"promptDiffLinemeta": "_3wsoOW_promptDiffLinemeta",
			"promptDiffLineremoved": "_3wsoOW_promptDiffLineremoved",
			"promptDiffSection": "_3wsoOW_promptDiffSection",
			"promptDiffSections": "_3wsoOW_promptDiffSections",
			"promptDiffTitle": "_3wsoOW_promptDiffTitle",
			"requestBoundaryControl": "_3wsoOW_requestBoundaryControl",
			"requestBoundaryControlActive": "_3wsoOW_requestBoundaryControlActive",
			"requestDetailsDot": "_3wsoOW_requestDetailsDot",
			"requestDetailsName": "_3wsoOW_requestDetailsName",
			"requestTokenDetail": "_3wsoOW_requestTokenDetail",
			"resultBlockText": "_3wsoOW_resultBlockText",
			"resultBlocks": "_3wsoOW_resultBlocks",
			"resultBlocksPreview": "_3wsoOW_resultBlocksPreview",
			"resultPreview": "_3wsoOW_resultPreview",
			"resultRequest": "_3wsoOW_resultRequest",
			"schema": "_3wsoOW_schema",
			"schemaDescription": "_3wsoOW_schemaDescription",
			"schemaIntro": "_3wsoOW_schemaIntro",
			"schemaName": "_3wsoOW_schemaName",
			"schemaParameters": "_3wsoOW_schemaParameters",
			"schemaParametersTitle": "_3wsoOW_schemaParametersTitle",
			"schemaPreview": "_3wsoOW_schemaPreview",
			"schemaTree": "_3wsoOW_schemaTree",
			"selectionRail": "_3wsoOW_selectionRail",
			"sourceBlock": "_3wsoOW_sourceBlock",
			"sourceBlockContent": "_3wsoOW_sourceBlockContent",
			"sourceBlockHeader": "_3wsoOW_sourceBlockHeader",
			"sourceBlockJumpIcon": "_3wsoOW_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "_3wsoOW_sourceBlockJumpTarget",
			"sourceBlockLabel": "_3wsoOW_sourceBlockLabel",
			"sourceBlocks": "_3wsoOW_sourceBlocks",
			"split": "_3wsoOW_split",
			"subtoolAmber": "_3wsoOW_subtoolAmber",
			"summaryScrollRegion": "_3wsoOW_summaryScrollRegion",
			"systemNeutral": "_3wsoOW_systemNeutral",
			"systemPrompt": "_3wsoOW_systemPrompt",
			"table": "_3wsoOW_table",
			"tablePane": "_3wsoOW_tablePane",
			"thinkingChevron": "_3wsoOW_thinkingChevron",
			"thinkingQuote": "_3wsoOW_thinkingQuote",
			"thinkingQuoteOnlyPreview": "_3wsoOW_thinkingQuoteOnlyPreview",
			"thinkingToggle": "_3wsoOW_thinkingToggle",
			"timestampToggle": "_3wsoOW_timestampToggle",
			"toolAmber": "_3wsoOW_toolAmber",
			"toolCallNameTypeface": "_3wsoOW_toolCallNameTypeface",
			"toolCallOnly": "_3wsoOW_toolCallOnly",
			"toolCallPayload": "_3wsoOW_toolCallPayload",
			"toolCatalog": "_3wsoOW_toolCatalog",
			"toolCatalogChevron": "_3wsoOW_toolCatalogChevron",
			"toolCatalogDefinition": "_3wsoOW_toolCatalogDefinition",
			"toolCatalogDescription": "_3wsoOW_toolCatalogDescription",
			"toolCatalogFullDescription": "_3wsoOW_toolCatalogFullDescription",
			"toolCatalogIcon": "_3wsoOW_toolCatalogIcon",
			"toolCatalogItem": "_3wsoOW_toolCatalogItem",
			"toolCatalogName": "_3wsoOW_toolCatalogName",
			"toolCatalogSummary": "_3wsoOW_toolCatalogSummary",
			"toolCatalogTree": "_3wsoOW_toolCatalogTree",
			"trajectory-table": "_3wsoOW_trajectory-table",
			"turnLabel": "_3wsoOW_turnLabel",
			"turnLabelActive": "_3wsoOW_turnLabelActive",
			"turnLabelCompact": "_3wsoOW_turnLabelCompact",
			"turnLabelFull": "_3wsoOW_turnLabelFull",
			"turnRail": "_3wsoOW_turnRail",
			"usageGroup": "_3wsoOW_usageGroup",
			"usageHeading": "_3wsoOW_usageHeading",
			"usagePanel": "_3wsoOW_usagePanel",
			"user": "_3wsoOW_user",
			"virtualSpacer": "_3wsoOW_virtualSpacer",
			"visuallyHidden": "_3wsoOW_visuallyHidden"
		};
		//#endregion
		...
		function StartedAtValue({ timestamp, t }) {
			...
			if (timestamp === null || !Number.isFinite(timestamp)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("timing.notAvailable") });
		...
		function AssistantTimingPanel({ metrics, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.started") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StartedAtValue, {
						timestamp: metrics.stepStartTime,
						t
					})] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.totalDuration") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: totalTime(metrics, t) })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.ttft") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: ttft(metrics, t) })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.generation") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: generationTime(metrics, t) })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.throughput") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: throughput(metrics, t) })] })
				]
			});
		}
		...
		function TokenRows({ cell, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.tokens") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: cell.output === void 0 ? "—" : t("unit.tokens", { value: cell.output }) })] }),
				cell.think !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: TrajectoryTable_module_css_default.requestTokenDetail,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.reasoning") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: cell.think }) })]
				}),
				content !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: TrajectoryTable_module_css_default.requestTokenDetail,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.content") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: content }) })]
				})
			] });
		}
		...
		function UsageRows({ usage, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
				className: TrajectoryTable_module_css_default.overview,
				children: [
					totalInput !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.input") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: totalInput }) })] }),
					usage.cacheRead !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.cached") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: usage.cacheRead }) })]
					}),
					usage.cacheWrite !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.cacheCreated") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: usage.cacheWrite }) })]
					}),
					usage.input !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.other") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: usage.input }) })]
					}),
					usage.output !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.output") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: usage.output }) })] }),
					usage.reasoning !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.reasoning") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: usage.reasoning }) })]
					}),
					otherOutput !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.content") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("unit.tokens", { value: otherOutput }) })]
					})
				]
			});
		}
		...
		function ToolOutputBlocks({ blocks, error, errorDetail, preview, renderImages }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [error && errorDetail !== void 0 && errorDetail !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
					className: TrajectoryTable_module_css_default.resultBlockText,
					children: errorDetail
				}), blocks.map((block, index) => block.attachment !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [t("record.thinking"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
		...
		function RecordTiming({ record, t }) {
			return record.cell.kind === "message" && record.cell.assistantMetrics !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantTimingPanel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.duration") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(record.cell.timeSeconds, t) })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.source") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: record.cell.timeSeconds === null ? t("timing.notAvailable") : t("timing.sessionTimestamps") })] })
				]
			});
		}
		function RequestTiming({ assistant, anchor, request, t }) {
			if (assistant !== void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RecordTiming, {
				record: assistant,
				t
			});
			if (request?.startedAt !== void 0) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.duration") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(duration, t) })] }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.source") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: duration === null ? t("timing.sessionTimestampsRunning") : t("timing.sessionTimestamps") })] })
					]
				});
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
				className: TrajectoryTable_module_css_default.overview,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.started") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StartedAtValue, {
					timestamp: anchor?.cell.startedAt ?? null,
					t
				})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.duration") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(null, t) })] })]
			});
		}
		function RecordPayload({ record, direction, preview = false, renderImages, t }) {
			...
			if (direction === "output" && record.cell.outputBlocks?.some((block) => block.attachment !== void 0 || block.content !== "") === true) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolOutputBlocks, {
		...
		*/
		function TrajectoryTable({ t, renderImages, requestNumbers: sessionRequestNumbers, turns, streamingCells = [], timelineFocusIndexes = null, searchMatchIndexes = null, onSelectedIndexChange, onRecordSelect, recordSelection = null, recordFocus = null, historyLoading = false, olderHistoryLoading = false, historyStartSeq, hasOlderRecords = false, onLoadOlder, onClearSelection, collapsedTurns, onToggleTurn, collapsedAssistants, onToggleAssistant, inspectCallId = null, onInspectApplied }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
											...
											children: [
												...
												!isCollapsedSummary && !isRequestOnly && record.turnStart && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													...
													children: record.turn === null ? sectionLabel(record.turn, t) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				}), (selectedRequestInfo !== void 0 || promptSelected || selected !== void 0 && selectedState !== void 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: selectedRequestInfo !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								selectedRequestInfo !== void 0 && selectedRequestState !== void 0 && activeTab === "overview" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
									className: `${TrajectoryTable_module_css_default.overview} ${TrajectoryTable_module_css_default.summaryScrollRegion}`,
									"data-summary-scroll-region": "",
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.status") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", {
										...
										selectedRequestInfo.purpose === "compaction" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.purpose") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: t("request.compactionPurpose") })] }),
										(selectedRequestInfo.provider ?? selectedRequestInfo.requestConfig?.provider) !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.provider") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestInfo.provider ?? selectedRequestInfo.requestConfig?.provider })] }),
										(selectedRequestInfo.model ?? selectedRequestInfo.requestConfig?.model) !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.model") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestInfo.model ?? selectedRequestInfo.requestConfig?.model })] }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.toolCalls") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestToolCalls })] }),
										selectedRequestSubtoolCalls > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.subtoolCalls") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestSubtoolCalls })] }),
										selectedRequestInfo.error !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.error") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", {
											className: TrajectoryTable_module_css_default.error,
											children: requestErrorMessage(selectedRequestInfo, t)
										})] }),
										selectedRequestInfo.retry !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.retry") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dd", { children: [
											t("details.scheduled"),
											" ",
										...
										selectedRequestInfo.retryDelayMs !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.retryDelay") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatDurationMs(selectedRequestInfo.retryDelayMs, t) })] }),
										selectedRequestResult !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.result") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", {
											...
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: selectedRequestInfo.purpose === "compaction" ? t("details.compacted") : t("details.assistantMessage") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)(OverviewSection, {
											...
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UsageRows, {
								...
								selectedRequestInfo !== void 0 && activeTab === "options" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RequestOptions, {
									options: selectedRequestOptions,
									t
								}),
								selectedRequestInfo !== void 0 && activeTab === "usage" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RequestUsagePanel, {
									usage: selectedRequestUsage,
									cumulative: selectedRequestCumulativeUsage,
									t
								}),
								selectedRequestInfo !== void 0 && activeTab === "timing" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RequestTiming, {
									assistant: selectedRequestAssistant,
									anchor: selectedRequestAnchor,
									request: selectedRequestInfo,
									t
								...
								promptSelected && activeTab === "tools" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolCatalog, {
								...
								!promptSelected && selected?.cell.kind === "compacted" && selectedState !== void 0 && activeTab === "overview" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.duration") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(selected.cell.timeSeconds, t) })] }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("usage.tokens") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: "—" })] })
									]
								...
								!promptSelected && selected !== void 0 && selected.cell.kind !== "compacted" && selectedState !== void 0 && activeTab === "overview" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
									...
									"data-summary-scroll-region": "",
									children: [
										selected.cell.messageSource !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("details.source") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", {
											className: TrajectoryTable_module_css_default.overviewParentLinks,
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												type: "button",
												className: TrajectoryTable_module_css_default.overviewHierarchyNavLink,
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: messageSourceLabel(selected.cell.messageSource, t) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
													className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
													size: 11
												})]
											})
										})] }),
										hasSelectedHierarchy && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: selectedAssistantRequestTarget !== void 0 ? t("details.source") : t("details.hierarchy") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dd", {
											className: TrajectoryTable_module_css_default.overviewParentLinks,
											children: [
												selectedAssistantRequestTarget !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("request.label", { request: selectedAssistantRequest ?? "—" }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
														className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
														size: 11
													})]
												}),
												selectedParentMessage !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("details.assistantMessage") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
														className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
														size: 11
													})]
												}),
												selectedParentTool !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("details.toolCall") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
														className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
														size: 11
													})]
												})
										...
										selected.cell.kind === "message" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TokenRows, {
											cell: selected.cell,
											t
										}),
										(selected.cell.kind === "user" || selected.cell.kind === "context") && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("timing.duration") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(selected.cell.timeSeconds, t) })] })
									]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: TrajectoryTable_module_css_default.overviewSections,
									children: [
										...
										selectedAssistantRequestTarget !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OverviewSection, {
											...
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RecordTiming, {
												record: selected,
												t
											})
										}),
								...
								!promptSelected && selected !== void 0 && activeTab === "source" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MessageSource, {
									record: selected,
									t
								}),
								...
								!promptSelected && selected !== void 0 && activeTab === "schema" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RecordSchema, {
									record: selected,
									t
								}),
								!promptSelected && selected !== void 0 && activeTab === "timing" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RecordTiming, {
									record: selected,
									t
								})
							]
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".Wp66Ka_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.Wp66Ka_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.Wp66Ka_actions{flex:none;align-items:center;gap:2px;display:flex}.Wp66Ka_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.Wp66Ka_toggle:hover,.Wp66Ka_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Wp66Ka_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Wp66Ka_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.Wp66Ka_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.Wp66Ka_control[hidden]{display:none}.Wp66Ka_control:hover:not(:disabled),.Wp66Ka_control[aria-checked=true],.Wp66Ka_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.Wp66Ka_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Wp66Ka_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.Wp66Ka_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.Wp66Ka_controlThumb{corner-shape:round;background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.Wp66Ka_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.Wp66Ka_controlTrack[data-on=true] .Wp66Ka_controlThumb{transform:translate(10px)}.Wp66Ka_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.Wp66Ka_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Wp66Ka_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Wp66Ka_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.Wp66Ka_search{border:.5px solid var(--dsw-alias-border-l4);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.Wp66Ka_search:hover{border-color:var(--dsw-alias-label-caption)}.Wp66Ka_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.Wp66Ka_searchIcon{flex:none}.Wp66Ka_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.Wp66Ka_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.Wp66Ka_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "Wp66Ka_action",
			"actionIcon": "Wp66Ka_actionIcon",
			"actions": "Wp66Ka_actions",
			"control": "Wp66Ka_control",
			"controlThumb": "Wp66Ka_controlThumb",
			"controlTrack": "Wp66Ka_controlTrack",
			"inner": "Wp66Ka_inner",
			"root": "Wp66Ka_root",
			"search": "Wp66Ka_search",
			"searchIcon": "Wp66Ka_searchIcon",
			"searchInput": "Wp66Ka_searchInput",
			"toggle": "Wp66Ka_toggle",
			"toggleIcon": "Wp66Ka_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = ".M1L0kG_root{z-index:1;isolation:isolate;border-bottom:.5px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.M1L0kG_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.M1L0kG_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.M1L0kG_labels{border-right:.5px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.M1L0kG_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.M1L0kG_labels span:first-child{top:7px}.M1L0kG_labels span:nth-child(2){top:21px}.M1L0kG_labels span:nth-child(3){top:35px}.M1L0kG_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.M1L0kG_track[data-panning=true]{cursor:grabbing}.M1L0kG_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.M1L0kG_earlierHistory:hover{opacity:1}.M1L0kG_earlierHistory[aria-disabled=true]{cursor:default}.M1L0kG_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.M1L0kG_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.M1L0kG_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.M1L0kG_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.M1L0kG_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.M1L0kG_lanes[data-animate-viewport=true],.M1L0kG_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.M1L0kG_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:.5px;position:absolute}.M1L0kG_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.M1L0kG_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.M1L0kG_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.M1L0kG_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.M1L0kG_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.M1L0kG_span[data-timeline-span=tool],.M1L0kG_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.M1L0kG_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.M1L0kG_span[data-equal-duration=true]{width:8px;min-width:8px}.M1L0kG_span[data-selected=false]{opacity:.2}.M1L0kG_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.M1L0kG_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.M1L0kG_span[data-search-match=false]{opacity:.14}.M1L0kG_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.M1L0kG_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.M1L0kG_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.M1L0kG_selectionEdges:before,.M1L0kG_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.M1L0kG_selectionEdges:before{left:0}.M1L0kG_selectionEdges:after{right:0}.M1L0kG_selectionEdges[data-dragging=true]:before,.M1L0kG_selectionEdges[data-dragging=true]:after{width:2px}.M1L0kG_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "M1L0kG_earlierHistory",
			"empty": "M1L0kG_empty",
			"hoverLine": "M1L0kG_hoverLine",
			"labels": "M1L0kG_labels",
			"lanes": "M1L0kG_lanes",
			"plot": "M1L0kG_plot",
			"root": "M1L0kG_root",
			"selection": "M1L0kG_selection",
			"selectionEdges": "M1L0kG_selectionEdges",
			"span": "M1L0kG_span",
			"track": "M1L0kG_track",
			"turnBoundaries": "M1L0kG_turnBoundaries",
			"turnBoundary": "M1L0kG_turnBoundary"
		};
		//#endregion
		...
		function LaneLabels({ t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				"aria-hidden": "true",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("column.input") }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("column.model") }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("column.tools") })
				]
			});
		}
		...
		const TrajectoryTimeline = (0, react.memo)(function TrajectoryTimeline({ t, turns, mode, range, hasEarlierRecords = false, onLoadEarlier, selectedIndex = null, searchMatchIndexes = null, onRangeChange, onRecordSelect, onRecordFocus }) {
			...
			if (model === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(LaneLabels, { t }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".iLch4G_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.iLch4G_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
