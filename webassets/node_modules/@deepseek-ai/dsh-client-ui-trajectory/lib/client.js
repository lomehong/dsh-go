window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".Vp9Pgq_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.Vp9Pgq_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:Vp9Pgq_trajectory-table/inline-size}.Vp9Pgq_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.Vp9Pgq_historyLoadingBar{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.Vp9Pgq_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);corner-shape:round;border-radius:50%;width:10px;height:10px;animation:.7s linear infinite Vp9Pgq_history-loading-spin}.Vp9Pgq_table tbody .Vp9Pgq_historyLoadRow td{height:30px;padding:0}.Vp9Pgq_table tbody .Vp9Pgq_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.Vp9Pgq_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.Vp9Pgq_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Vp9Pgq_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.Vp9Pgq_historyLoadButton:disabled{cursor:default}.Vp9Pgq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.Vp9Pgq_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes Vp9Pgq_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.Vp9Pgq_historyLoadingSpinner{animation:none}}.Vp9Pgq_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.Vp9Pgq_eventColumn{width:122px}.Vp9Pgq_contentColumn{width:auto}.Vp9Pgq_table th{z-index:3;box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.Vp9Pgq_eventHeader{text-align:right!important;padding-right:4px!important}.Vp9Pgq_table td{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.Vp9Pgq_table tbody .Vp9Pgq_virtualSpacer{pointer-events:none}.Vp9Pgq_table tbody .Vp9Pgq_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.Vp9Pgq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.Vp9Pgq_table tbody tr[data-timeline-focus=outside]{opacity:.24}.Vp9Pgq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.Vp9Pgq_table tbody tr[data-request-only=true]:hover{background:0 0}.Vp9Pgq_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.Vp9Pgq_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.Vp9Pgq_table tbody tr[data-request-only=true] .Vp9Pgq_turnRail{top:-15px;bottom:0}.Vp9Pgq_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.Vp9Pgq_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.Vp9Pgq_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.Vp9Pgq_requestBoundaryControl:before{corner-shape:round;background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.Vp9Pgq_requestBoundaryControl:after{border:.5px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.Vp9Pgq_requestBoundaryControl:hover:before,.Vp9Pgq_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.Vp9Pgq_requestBoundaryControlActive:before,.Vp9Pgq_requestBoundaryControlActive:hover:before,.Vp9Pgq_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.Vp9Pgq_requestBoundaryControl[data-request-status=error]:before,.Vp9Pgq_requestBoundaryControl[data-request-status=error]:hover:before,.Vp9Pgq_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.Vp9Pgq_requestBoundaryControl:hover:after,.Vp9Pgq_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.Vp9Pgq_requestBoundaryControl:focus-visible{outline:none}.Vp9Pgq_table tbody tr:has(.Vp9Pgq_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.Vp9Pgq_event{position:relative}.Vp9Pgq_turnRail,.Vp9Pgq_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.Vp9Pgq_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.Vp9Pgq_table tbody tr[data-turn-end=true] .Vp9Pgq_turnRail{bottom:0}.Vp9Pgq_selectionRail{z-index:5;width:3px;top:0;bottom:0}.Vp9Pgq_table tbody tr[data-error=true] .Vp9Pgq_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.Vp9Pgq_table tbody tr[data-error=true] .Vp9Pgq_selectionRail{background:var(--dsw-alias-state-error-primary)}.Vp9Pgq_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.Vp9Pgq_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.Vp9Pgq_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.Vp9Pgq_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.Vp9Pgq_turnLabelFull,.Vp9Pgq_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.Vp9Pgq_turnLabelCompact{opacity:0;max-width:0}.Vp9Pgq_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.Vp9Pgq_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.Vp9Pgq_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.Vp9Pgq_kindSlot [role=tooltip]{background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);border:0}.Vp9Pgq_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.Vp9Pgq_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.Vp9Pgq_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.Vp9Pgq_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.Vp9Pgq_table .Vp9Pgq_kindSlot .Vp9Pgq_message{justify-content:center;width:100%}@container Vp9Pgq_trajectory-table (width<=620px){.Vp9Pgq_eventColumn{width:50px}.Vp9Pgq_event{padding-left:28px!important;padding-right:3px!important}.Vp9Pgq_requestBoundaryControl{--request-boundary-base-left:6px}.Vp9Pgq_kindSlot{width:19px}.Vp9Pgq_kindTag,.Vp9Pgq_table .Vp9Pgq_kindSlot .Vp9Pgq_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.Vp9Pgq_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.Vp9Pgq_kindTagLabel,.Vp9Pgq_turnLabelFull{opacity:0;max-width:0}.Vp9Pgq_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.Vp9Pgq_eventColumn,.Vp9Pgq_event,.Vp9Pgq_requestBoundaryControl,.Vp9Pgq_kindSlot,.Vp9Pgq_kindTag,.Vp9Pgq_kindTagIcon,.Vp9Pgq_kindTagLabel,.Vp9Pgq_turnLabelFull,.Vp9Pgq_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.Vp9Pgq_eventColumn,.Vp9Pgq_kindSlot{transition-property:width}.Vp9Pgq_event{transition-property:padding-right,padding-left}.Vp9Pgq_requestBoundaryControl{transition-property:left}.Vp9Pgq_kindTag{transition-property:padding-right,padding-left}.Vp9Pgq_kindTagIcon{transition-property:width,opacity,transform}.Vp9Pgq_kindTagLabel,.Vp9Pgq_turnLabelFull,.Vp9Pgq_turnLabelCompact{transition-property:max-width,opacity}}.Vp9Pgq_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.Vp9Pgq_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.Vp9Pgq_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.Vp9Pgq_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.Vp9Pgq_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.Vp9Pgq_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.Vp9Pgq_promptDiffSection{min-width:0}.Vp9Pgq_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.Vp9Pgq_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.Vp9Pgq_promptDiff span{min-width:max-content;padding:0 6px;display:block}.Vp9Pgq_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.Vp9Pgq_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.Vp9Pgq_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.Vp9Pgq_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.Vp9Pgq_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.Vp9Pgq_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.Vp9Pgq_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.Vp9Pgq_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.Vp9Pgq_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.Vp9Pgq_table tbody tr[data-collapsed-summary=turn] td,.Vp9Pgq_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.Vp9Pgq_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.Vp9Pgq_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.Vp9Pgq_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.Vp9Pgq_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.Vp9Pgq_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.Vp9Pgq_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Vp9Pgq_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.Vp9Pgq_resultRequest,.Vp9Pgq_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Vp9Pgq_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.Vp9Pgq_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.Vp9Pgq_table tbody tr[data-kind=tool] .Vp9Pgq_contentText,.Vp9Pgq_table tbody tr[data-kind=subtool] .Vp9Pgq_contentText,.Vp9Pgq_table tbody tr[data-kind=tool] .Vp9Pgq_resultPreview,.Vp9Pgq_table tbody tr[data-kind=subtool] .Vp9Pgq_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.Vp9Pgq_table tbody tr[data-kind=subtool] .Vp9Pgq_content{padding-left:26px}.Vp9Pgq_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.Vp9Pgq_noOutputText{color:var(--dsw-alias-label-caption)}.Vp9Pgq_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.Vp9Pgq_error,.Vp9Pgq_overview dd.Vp9Pgq_error,.Vp9Pgq_details .Vp9Pgq_errorPayload{color:var(--dsw-alias-state-error-primary)}.Vp9Pgq_details .Vp9Pgq_errorPayload .Vp9Pgq_resultBlockText{color:inherit}.Vp9Pgq_details .Vp9Pgq_jsonPayload.Vp9Pgq_errorPayload,.Vp9Pgq_details .Vp9Pgq_jsonPreview.Vp9Pgq_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.Vp9Pgq_details{border-left:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.Vp9Pgq_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.Vp9Pgq_detailsResizeHandle:focus-visible{outline:none}.Vp9Pgq_detailsHeader{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.Vp9Pgq_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.Vp9Pgq_requestDetailsDot{corner-shape:round;background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.Vp9Pgq_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.Vp9Pgq_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Vp9Pgq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.Vp9Pgq_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Vp9Pgq_detailTabs{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.Vp9Pgq_detailTabs::-webkit-scrollbar{display:none}.Vp9Pgq_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.Vp9Pgq_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Vp9Pgq_detailTabActive{color:var(--dsw-alias-state-business-primary)}.Vp9Pgq_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.Vp9Pgq_close:focus-visible,.Vp9Pgq_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Vp9Pgq_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.Vp9Pgq_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.Vp9Pgq_detailBodySummary>.Vp9Pgq_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.Vp9Pgq_detailBodySummary>.Vp9Pgq_compactedSummary{flex:1;min-height:0;overflow:auto}.Vp9Pgq_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.Vp9Pgq_summaryScrollRegion:hover,.Vp9Pgq_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.Vp9Pgq_compactedSummary .Vp9Pgq_markdownPayload{padding-right:18px}.Vp9Pgq_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.Vp9Pgq_overviewParentLinks{gap:14px;display:flex}.Vp9Pgq_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.Vp9Pgq_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.Vp9Pgq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.Vp9Pgq_overviewHierarchyNavLink:hover .Vp9Pgq_overviewHierarchyJumpIconTight,.Vp9Pgq_overviewHierarchyNavLink:focus-visible .Vp9Pgq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.Vp9Pgq_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Vp9Pgq_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.Vp9Pgq_overview>.Vp9Pgq_requestTokenDetail dt{padding-left:12px}.Vp9Pgq_usagePanel{padding:4px 0 10px}.Vp9Pgq_usageGroup+.Vp9Pgq_usageGroup{margin-top:8px}.Vp9Pgq_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.Vp9Pgq_usageGroup .Vp9Pgq_overview{padding:0}.Vp9Pgq_overview dt{color:var(--dsw-alias-label-tertiary)}.Vp9Pgq_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.Vp9Pgq_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.Vp9Pgq_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Vp9Pgq_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.Vp9Pgq_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.Vp9Pgq_overviewSection+.Vp9Pgq_overviewSection{padding-top:8px}.Vp9Pgq_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.Vp9Pgq_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.Vp9Pgq_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.Vp9Pgq_overviewTitle:hover .Vp9Pgq_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.Vp9Pgq_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Vp9Pgq_overviewTitle:focus-visible .Vp9Pgq_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.Vp9Pgq_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.Vp9Pgq_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.Vp9Pgq_overviewPreview .Vp9Pgq_jsonPreview>:first-child,.Vp9Pgq_overviewPreview .Vp9Pgq_schemaTree>:first-child{padding-bottom:0}.Vp9Pgq_overviewPreview .Vp9Pgq_schemaTree{margin-bottom:0}.Vp9Pgq_overviewPreview .Vp9Pgq_overview{padding:2px 0 0}.Vp9Pgq_overviewPreview .Vp9Pgq_overview>div{min-height:22px}.Vp9Pgq_markdownPreview,.Vp9Pgq_markdownPayload{color:var(--dsw-alias-label-primary)}.Vp9Pgq_markdownPreview>div,.Vp9Pgq_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.Vp9Pgq_markdownPreview>div h1,.Vp9Pgq_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.Vp9Pgq_markdownPreview>div h2,.Vp9Pgq_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.Vp9Pgq_markdownPreview>div :where(h3,h4,h5,h6),.Vp9Pgq_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.Vp9Pgq_markdownPreview>div :not(pre)>code,.Vp9Pgq_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.Vp9Pgq_markdownPreview>div table,.Vp9Pgq_markdownPayload>div table{font:var(--dsw-font-xs-13)}.Vp9Pgq_markdownPreview>div>:first-child{margin-top:0}.Vp9Pgq_markdownPreview>div>:last-child{margin-bottom:0}.Vp9Pgq_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.Vp9Pgq_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.Vp9Pgq_markdownPreview>div :where(p,ul,ol){margin:8px 0}.Vp9Pgq_markdownPreview>div li:not(:first-child){margin-top:3px}.Vp9Pgq_markdownPreview>div blockquote{margin-top:8px}.Vp9Pgq_markdownPreview>div hr{margin:14px 0}.Vp9Pgq_markdownPreview>div>.md-code-block{margin:10px 0}.Vp9Pgq_assistantContent .Vp9Pgq_markdownPayload,.Vp9Pgq_assistantContent .Vp9Pgq_payload{min-height:0}.Vp9Pgq_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.Vp9Pgq_thinkingQuoteOnlyPreview{margin-bottom:8px}.Vp9Pgq_detailBody>.Vp9Pgq_assistantContentRendered .Vp9Pgq_thinkingQuote{margin-top:14px}.Vp9Pgq_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.Vp9Pgq_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.Vp9Pgq_thinkingToggle[aria-expanded=true] .Vp9Pgq_thinkingChevron{transform:rotate(90deg)}.Vp9Pgq_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.Vp9Pgq_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Vp9Pgq_thinkingQuote .Vp9Pgq_markdownPreview,.Vp9Pgq_thinkingQuote .Vp9Pgq_markdownPayload,.Vp9Pgq_thinkingQuote .Vp9Pgq_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.Vp9Pgq_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.Vp9Pgq_markdownPreview{padding:6px 14px 8px}.Vp9Pgq_markdownPayload{min-height:100%;padding:14px}.Vp9Pgq_jsonPayload{min-height:100%}.Vp9Pgq_jsonPreview{min-height:0}.Vp9Pgq_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.Vp9Pgq_schemaPreview{min-height:0}.Vp9Pgq_schemaIntro{padding:12px 14px 6px}.Vp9Pgq_schemaPreview .Vp9Pgq_schemaIntro{padding-top:6px}.Vp9Pgq_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.Vp9Pgq_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.Vp9Pgq_schemaParameters{min-width:0}.Vp9Pgq_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.Vp9Pgq_schemaTree{margin:0 6px 8px 0}.Vp9Pgq_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.Vp9Pgq_payloadPreview{min-height:0;padding:6px 14px 8px}.Vp9Pgq_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.Vp9Pgq_sourceBlock+.Vp9Pgq_sourceBlock{margin-top:14px}.Vp9Pgq_sourceBlockHeader,.Vp9Pgq_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.Vp9Pgq_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.Vp9Pgq_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.Vp9Pgq_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.Vp9Pgq_sourceBlockJumpTarget:hover .Vp9Pgq_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.Vp9Pgq_sourceBlockJumpTarget:focus-visible{outline:none}.Vp9Pgq_sourceBlockJumpTarget:focus-visible .Vp9Pgq_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.Vp9Pgq_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.Vp9Pgq_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.Vp9Pgq_messageImagesPreview{gap:6px;margin:6px 14px 8px}.Vp9Pgq_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.Vp9Pgq_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.Vp9Pgq_assistantToolCalls li{min-width:0}.Vp9Pgq_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.Vp9Pgq_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Vp9Pgq_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Vp9Pgq_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.Vp9Pgq_assistantToolCallButton:hover .Vp9Pgq_assistantToolCallIcon,.Vp9Pgq_assistantToolCallButton:focus-visible .Vp9Pgq_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.Vp9Pgq_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.Vp9Pgq_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.Vp9Pgq_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Vp9Pgq_systemPrompt{box-sizing:border-box}.Vp9Pgq_toolCatalog{min-height:100%;padding:8px 0 16px}.Vp9Pgq_toolCatalogItem{border-bottom:.5px solid var(--dsw-alias-border-l1)}.Vp9Pgq_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.Vp9Pgq_toolCatalogSummary::-webkit-details-marker{display:none}.Vp9Pgq_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.Vp9Pgq_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Vp9Pgq_toolCatalogChevron,.Vp9Pgq_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.Vp9Pgq_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.Vp9Pgq_toolCatalogItem[open] .Vp9Pgq_toolCatalogChevron{transform:rotate(90deg)}.Vp9Pgq_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.Vp9Pgq_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Vp9Pgq_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.Vp9Pgq_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.Vp9Pgq_toolCatalogTree{margin-left:-14px;margin-right:6px}.Vp9Pgq_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.Vp9Pgq_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.Vp9Pgq_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.Vp9Pgq_overviewPreview .Vp9Pgq_noPayload{padding:6px 14px 8px}.Vp9Pgq_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.Vp9Pgq_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "Vp9Pgq_arrow",
			"assistantContent": "Vp9Pgq_assistantContent",
			"assistantContentRendered": "Vp9Pgq_assistantContentRendered",
			"assistantOutput": "Vp9Pgq_assistantOutput",
			"assistantToolCallArgs": "Vp9Pgq_assistantToolCallArgs",
			"assistantToolCallButton": "Vp9Pgq_assistantToolCallButton",
			"assistantToolCallIcon": "Vp9Pgq_assistantToolCallIcon",
			"assistantToolCallName": "Vp9Pgq_assistantToolCallName",
			"assistantToolCallText": "Vp9Pgq_assistantToolCallText",
			"assistantToolCalls": "Vp9Pgq_assistantToolCalls",
			"assistantToolCallsPreview": "Vp9Pgq_assistantToolCallsPreview",
			"assistantVioletBright": "Vp9Pgq_assistantVioletBright",
			"close": "Vp9Pgq_close",
			"collapsedTurnContent": "Vp9Pgq_collapsedTurnContent",
			"collapsedTurnEllipsis": "Vp9Pgq_collapsedTurnEllipsis",
			"collapsedTurnText": "Vp9Pgq_collapsedTurnText",
			"compacted": "Vp9Pgq_compacted",
			"compactedSummary": "Vp9Pgq_compactedSummary",
			"content": "Vp9Pgq_content",
			"contentColumn": "Vp9Pgq_contentColumn",
			"contentText": "Vp9Pgq_contentText",
			"contextGreen": "Vp9Pgq_contextGreen",
			"detailBody": "Vp9Pgq_detailBody",
			"detailBodySummary": "Vp9Pgq_detailBodySummary",
			"detailTab": "Vp9Pgq_detailTab",
			"detailTabActive": "Vp9Pgq_detailTabActive",
			"detailTabs": "Vp9Pgq_detailTabs",
			"details": "Vp9Pgq_details",
			"detailsHeader": "Vp9Pgq_detailsHeader",
			"detailsLocation": "Vp9Pgq_detailsLocation",
			"detailsResizeHandle": "Vp9Pgq_detailsResizeHandle",
			"detailsTitle": "Vp9Pgq_detailsTitle",
			"error": "Vp9Pgq_error",
			"errorPayload": "Vp9Pgq_errorPayload",
			"event": "Vp9Pgq_event",
			"eventColumn": "Vp9Pgq_eventColumn",
			"eventHeader": "Vp9Pgq_eventHeader",
			"eventInner": "Vp9Pgq_eventInner",
			"history-loading-spin": "Vp9Pgq_history-loading-spin",
			"historyLoadButton": "Vp9Pgq_historyLoadButton",
			"historyLoadRow": "Vp9Pgq_historyLoadRow",
			"historyLoading": "Vp9Pgq_historyLoading",
			"historyLoadingBar": "Vp9Pgq_historyLoadingBar",
			"historyLoadingSpinner": "Vp9Pgq_historyLoadingSpinner",
			"inlineResult": "Vp9Pgq_inlineResult",
			"inlineResultText": "Vp9Pgq_inlineResultText",
			"jsonPayload": "Vp9Pgq_jsonPayload",
			"jsonPreview": "Vp9Pgq_jsonPreview",
			"kindSlot": "Vp9Pgq_kindSlot",
			"kindTag": "Vp9Pgq_kindTag",
			"kindTagIcon": "Vp9Pgq_kindTagIcon",
			"kindTagLabel": "Vp9Pgq_kindTagLabel",
			"markdownPayload": "Vp9Pgq_markdownPayload",
			"markdownPreview": "Vp9Pgq_markdownPreview",
			"message": "Vp9Pgq_message",
			"messageImages": "Vp9Pgq_messageImages",
			"messageImagesPreview": "Vp9Pgq_messageImagesPreview",
			"noOutputText": "Vp9Pgq_noOutputText",
			"noPayload": "Vp9Pgq_noPayload",
			"overview": "Vp9Pgq_overview",
			"overviewHeading": "Vp9Pgq_overviewHeading",
			"overviewHierarchyJumpIconTight": "Vp9Pgq_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "Vp9Pgq_overviewHierarchyNavLink",
			"overviewParentLinks": "Vp9Pgq_overviewParentLinks",
			"overviewPreview": "Vp9Pgq_overviewPreview",
			"overviewSection": "Vp9Pgq_overviewSection",
			"overviewSections": "Vp9Pgq_overviewSections",
			"overviewTitle": "Vp9Pgq_overviewTitle",
			"overviewTitleIcon": "Vp9Pgq_overviewTitleIcon",
			"payload": "Vp9Pgq_payload",
			"payloadPreview": "Vp9Pgq_payloadPreview",
			"promptDiff": "Vp9Pgq_promptDiff",
			"promptDiffLineadded": "Vp9Pgq_promptDiffLineadded",
			"promptDiffLinecontext": "Vp9Pgq_promptDiffLinecontext",
			"promptDiffLinemeta": "Vp9Pgq_promptDiffLinemeta",
			"promptDiffLineremoved": "Vp9Pgq_promptDiffLineremoved",
			"promptDiffSection": "Vp9Pgq_promptDiffSection",
			"promptDiffSections": "Vp9Pgq_promptDiffSections",
			"promptDiffTitle": "Vp9Pgq_promptDiffTitle",
			"requestBoundaryControl": "Vp9Pgq_requestBoundaryControl",
			"requestBoundaryControlActive": "Vp9Pgq_requestBoundaryControlActive",
			"requestDetailsDot": "Vp9Pgq_requestDetailsDot",
			"requestDetailsName": "Vp9Pgq_requestDetailsName",
			"requestTokenDetail": "Vp9Pgq_requestTokenDetail",
			"resultBlockText": "Vp9Pgq_resultBlockText",
			"resultBlocks": "Vp9Pgq_resultBlocks",
			"resultBlocksPreview": "Vp9Pgq_resultBlocksPreview",
			"resultPreview": "Vp9Pgq_resultPreview",
			"resultRequest": "Vp9Pgq_resultRequest",
			"schema": "Vp9Pgq_schema",
			"schemaDescription": "Vp9Pgq_schemaDescription",
			"schemaIntro": "Vp9Pgq_schemaIntro",
			"schemaName": "Vp9Pgq_schemaName",
			"schemaParameters": "Vp9Pgq_schemaParameters",
			"schemaParametersTitle": "Vp9Pgq_schemaParametersTitle",
			"schemaPreview": "Vp9Pgq_schemaPreview",
			"schemaTree": "Vp9Pgq_schemaTree",
			"selectionRail": "Vp9Pgq_selectionRail",
			"sourceBlock": "Vp9Pgq_sourceBlock",
			"sourceBlockContent": "Vp9Pgq_sourceBlockContent",
			"sourceBlockHeader": "Vp9Pgq_sourceBlockHeader",
			"sourceBlockJumpIcon": "Vp9Pgq_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "Vp9Pgq_sourceBlockJumpTarget",
			"sourceBlockLabel": "Vp9Pgq_sourceBlockLabel",
			"sourceBlocks": "Vp9Pgq_sourceBlocks",
			"split": "Vp9Pgq_split",
			"subtoolAmber": "Vp9Pgq_subtoolAmber",
			"summaryScrollRegion": "Vp9Pgq_summaryScrollRegion",
			"systemNeutral": "Vp9Pgq_systemNeutral",
			"systemPrompt": "Vp9Pgq_systemPrompt",
			"table": "Vp9Pgq_table",
			"tablePane": "Vp9Pgq_tablePane",
			"thinkingChevron": "Vp9Pgq_thinkingChevron",
			"thinkingQuote": "Vp9Pgq_thinkingQuote",
			"thinkingQuoteOnlyPreview": "Vp9Pgq_thinkingQuoteOnlyPreview",
			"thinkingToggle": "Vp9Pgq_thinkingToggle",
			"timestampToggle": "Vp9Pgq_timestampToggle",
			"toolAmber": "Vp9Pgq_toolAmber",
			"toolCallNameTypeface": "Vp9Pgq_toolCallNameTypeface",
			"toolCallOnly": "Vp9Pgq_toolCallOnly",
			"toolCallPayload": "Vp9Pgq_toolCallPayload",
			"toolCatalog": "Vp9Pgq_toolCatalog",
			"toolCatalogChevron": "Vp9Pgq_toolCatalogChevron",
			"toolCatalogDefinition": "Vp9Pgq_toolCatalogDefinition",
			"toolCatalogDescription": "Vp9Pgq_toolCatalogDescription",
			"toolCatalogFullDescription": "Vp9Pgq_toolCatalogFullDescription",
			"toolCatalogIcon": "Vp9Pgq_toolCatalogIcon",
			"toolCatalogItem": "Vp9Pgq_toolCatalogItem",
			"toolCatalogName": "Vp9Pgq_toolCatalogName",
			"toolCatalogSummary": "Vp9Pgq_toolCatalogSummary",
			"toolCatalogTree": "Vp9Pgq_toolCatalogTree",
			"trajectory-table": "Vp9Pgq_trajectory-table",
			"turnLabel": "Vp9Pgq_turnLabel",
			"turnLabelActive": "Vp9Pgq_turnLabelActive",
			"turnLabelCompact": "Vp9Pgq_turnLabelCompact",
			"turnLabelFull": "Vp9Pgq_turnLabelFull",
			"turnRail": "Vp9Pgq_turnRail",
			"usageGroup": "Vp9Pgq_usageGroup",
			"usageHeading": "Vp9Pgq_usageHeading",
			"usagePanel": "Vp9Pgq_usagePanel",
			"user": "Vp9Pgq_user",
			"virtualSpacer": "Vp9Pgq_virtualSpacer",
			"visuallyHidden": "Vp9Pgq_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		const css$2 = ".fLcWKG_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.fLcWKG_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.fLcWKG_actions{flex:none;align-items:center;gap:2px;display:flex}.fLcWKG_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.fLcWKG_toggle:hover,.fLcWKG_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.fLcWKG_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.fLcWKG_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.fLcWKG_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.fLcWKG_control[hidden]{display:none}.fLcWKG_control:hover:not(:disabled),.fLcWKG_control[aria-checked=true],.fLcWKG_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.fLcWKG_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.fLcWKG_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.fLcWKG_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.fLcWKG_controlThumb{corner-shape:round;background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.fLcWKG_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.fLcWKG_controlTrack[data-on=true] .fLcWKG_controlThumb{transform:translate(10px)}.fLcWKG_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.fLcWKG_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.fLcWKG_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.fLcWKG_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.fLcWKG_search{border:.5px solid var(--dsw-alias-border-l4);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.fLcWKG_search:hover{border-color:var(--dsw-alias-label-caption)}.fLcWKG_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.fLcWKG_searchIcon{flex:none}.fLcWKG_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.fLcWKG_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.fLcWKG_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "fLcWKG_action",
			"actionIcon": "fLcWKG_actionIcon",
			"actions": "fLcWKG_actions",
			"control": "fLcWKG_control",
			"controlThumb": "fLcWKG_controlThumb",
			"controlTrack": "fLcWKG_controlTrack",
			"inner": "fLcWKG_inner",
			"root": "fLcWKG_root",
			"search": "fLcWKG_search",
			"searchIcon": "fLcWKG_searchIcon",
			"searchInput": "fLcWKG_searchInput",
			"toggle": "fLcWKG_toggle",
			"toggleIcon": "fLcWKG_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		const css$1 = ".dif82a_root{z-index:1;isolation:isolate;border-bottom:.5px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.dif82a_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.dif82a_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.dif82a_labels{border-right:.5px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.dif82a_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.dif82a_labels span:first-child{top:7px}.dif82a_labels span:nth-child(2){top:21px}.dif82a_labels span:nth-child(3){top:35px}.dif82a_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.dif82a_track[data-panning=true]{cursor:grabbing}.dif82a_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.dif82a_earlierHistory:hover{opacity:1}.dif82a_earlierHistory[aria-disabled=true]{cursor:default}.dif82a_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.dif82a_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.dif82a_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.dif82a_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.dif82a_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.dif82a_lanes[data-animate-viewport=true],.dif82a_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.dif82a_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:.5px;position:absolute}.dif82a_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.dif82a_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.dif82a_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.dif82a_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.dif82a_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.dif82a_span[data-timeline-span=tool],.dif82a_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.dif82a_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.dif82a_span[data-equal-duration=true]{width:8px;min-width:8px}.dif82a_span[data-selected=false]{opacity:.2}.dif82a_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.dif82a_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.dif82a_span[data-search-match=false]{opacity:.14}.dif82a_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.dif82a_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.dif82a_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.dif82a_selectionEdges:before,.dif82a_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.dif82a_selectionEdges:before{left:0}.dif82a_selectionEdges:after{right:0}.dif82a_selectionEdges[data-dragging=true]:before,.dif82a_selectionEdges[data-dragging=true]:after{width:2px}.dif82a_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "dif82a_earlierHistory",
			"empty": "dif82a_empty",
			"hoverLine": "dif82a_hoverLine",
			"labels": "dif82a_labels",
			"lanes": "dif82a_lanes",
			"plot": "dif82a_plot",
			"root": "dif82a_root",
			"selection": "dif82a_selection",
			"selectionEdges": "dif82a_selectionEdges",
			"span": "dif82a_span",
			"track": "dif82a_track",
			"turnBoundaries": "dif82a_turnBoundaries",
			"turnBoundary": "dif82a_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		const css = ".ld5PaW_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.ld5PaW_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
