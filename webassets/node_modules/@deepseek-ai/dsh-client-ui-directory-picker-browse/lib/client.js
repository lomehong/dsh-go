window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-directory-picker-browse\src\client\DirectoryBrowser.module.css.mjs
		const css = ".fq9kBa_dialog.fq9kBa_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.fq9kBa_editorScope{display:contents}.fq9kBa_header{border-bottom:.5px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.fq9kBa_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.fq9kBa_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.fq9kBa_crumbBar:has(.fq9kBa_crumbEditZone:enabled:hover),.fq9kBa_crumbBar:has(.fq9kBa_crumbEditZone:focus-visible),.fq9kBa_crumbBar:has(.fq9kBa_pathInput){border-color:var(--dsw-alias-border-l2)}.fq9kBa_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.fq9kBa_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.fq9kBa_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.fq9kBa_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.fq9kBa_crumb:hover{color:var(--dsw-alias-label-primary)}.fq9kBa_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.fq9kBa_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.fq9kBa_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.fq9kBa_crumbEditZone:enabled:hover .fq9kBa_crumbEditGlyph,.fq9kBa_crumbEditZone:focus-visible .fq9kBa_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.fq9kBa_crumbEditZone:disabled{cursor:default}.fq9kBa_crumbEditZone:disabled .fq9kBa_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.fq9kBa_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.fq9kBa_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.fq9kBa_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.fq9kBa_divider{background:var(--dsw-alias-border-l3);flex:none;width:.5px}.fq9kBa_rowSeat{flex:none;display:flex}.fq9kBa_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.fq9kBa_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.fq9kBa_rowSelected,.fq9kBa_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.fq9kBa_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.fq9kBa_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.fq9kBa_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.fq9kBa_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.fq9kBa_status,.fq9kBa_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.fq9kBa_status{color:var(--dsw-alias-label-secondary)}.fq9kBa_error{color:var(--dsw-alias-state-error-primary)}.fq9kBa_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.fq9kBa_footerBar{border-top:.5px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.fq9kBa_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.fq9kBa_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.fq9kBa_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.fq9kBa_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.fq9kBa_footerGap{flex:1 1 0}.fq9kBa_footerAction{min-width:72px}.fq9kBa_createDialog.fq9kBa_createDialog{gap:0;width:min(380px,100%);padding:0}.fq9kBa_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.fq9kBa_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.fq9kBa_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.fq9kBa_createInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.fq9kBa_createInput::placeholder{color:var(--dsw-alias-label-caption)}.fq9kBa_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "fq9kBa_column",
			"content": "fq9kBa_content",
			"createActions": "fq9kBa_createActions",
			"createBody": "fq9kBa_createBody",
			"createDialog": "fq9kBa_createDialog",
			"createIn": "fq9kBa_createIn",
			"createInput": "fq9kBa_createInput",
			"createTitle": "fq9kBa_createTitle",
			"crumb": "fq9kBa_crumb",
			"crumbBar": "fq9kBa_crumbBar",
			"crumbChevron": "fq9kBa_crumbChevron",
			"crumbEditGlyph": "fq9kBa_crumbEditGlyph",
			"crumbEditZone": "fq9kBa_crumbEditZone",
			"crumbSeat": "fq9kBa_crumbSeat",
			"crumbTrail": "fq9kBa_crumbTrail",
			"dialog": "fq9kBa_dialog",
			"divider": "fq9kBa_divider",
			"editorScope": "fq9kBa_editorScope",
			"error": "fq9kBa_error",
			"footerAction": "fq9kBa_footerAction",
			"footerBar": "fq9kBa_footerBar",
			"footerGap": "fq9kBa_footerGap",
			"header": "fq9kBa_header",
			"loadingFloat": "fq9kBa_loadingFloat",
			"millerRow": "fq9kBa_millerRow",
			"pathInput": "fq9kBa_pathInput",
			"row": "fq9kBa_row",
			"rowChevron": "fq9kBa_rowChevron",
			"rowIcon": "fq9kBa_rowIcon",
			"rowIconSelected": "fq9kBa_rowIconSelected",
			"rowName": "fq9kBa_rowName",
			"rowSeat": "fq9kBa_rowSeat",
			"rowSelected": "fq9kBa_rowSelected",
			"showHiddenToggle": "fq9kBa_showHiddenToggle",
			"showHiddenToggleActive": "fq9kBa_showHiddenToggleActive",
			"status": "fq9kBa_status",
			"title": "fq9kBa_title"
		};
		//#endregion
