window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".UfPxPW_dialog.UfPxPW_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.UfPxPW_editorScope{display:contents}.UfPxPW_header{border-bottom:.5px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.UfPxPW_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.UfPxPW_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.UfPxPW_crumbBar:has(.UfPxPW_crumbEditZone:enabled:hover),.UfPxPW_crumbBar:has(.UfPxPW_crumbEditZone:focus-visible),.UfPxPW_crumbBar:has(.UfPxPW_pathInput){border-color:var(--dsw-alias-border-l2)}.UfPxPW_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.UfPxPW_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.UfPxPW_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.UfPxPW_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.UfPxPW_crumb:hover{color:var(--dsw-alias-label-primary)}.UfPxPW_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.UfPxPW_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.UfPxPW_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.UfPxPW_crumbEditZone:enabled:hover .UfPxPW_crumbEditGlyph,.UfPxPW_crumbEditZone:focus-visible .UfPxPW_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.UfPxPW_crumbEditZone:disabled{cursor:default}.UfPxPW_crumbEditZone:disabled .UfPxPW_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.UfPxPW_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.UfPxPW_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.UfPxPW_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.UfPxPW_divider{background:var(--dsw-alias-border-l3);flex:none;width:.5px}.UfPxPW_rowSeat{flex:none;display:flex}.UfPxPW_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.UfPxPW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.UfPxPW_rowSelected,.UfPxPW_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.UfPxPW_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.UfPxPW_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.UfPxPW_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.UfPxPW_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.UfPxPW_status,.UfPxPW_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.UfPxPW_status{color:var(--dsw-alias-label-secondary)}.UfPxPW_error{color:var(--dsw-alias-state-error-primary)}.UfPxPW_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.UfPxPW_footerBar{border-top:.5px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.UfPxPW_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.UfPxPW_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.UfPxPW_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.UfPxPW_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.UfPxPW_footerGap{flex:1 1 0}.UfPxPW_footerAction{min-width:72px}.UfPxPW_createDialog.UfPxPW_createDialog{gap:0;width:min(380px,100%);padding:0}.UfPxPW_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.UfPxPW_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.UfPxPW_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.UfPxPW_createInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.UfPxPW_createInput::placeholder{color:var(--dsw-alias-label-caption)}.UfPxPW_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "UfPxPW_column",
			"content": "UfPxPW_content",
			"createActions": "UfPxPW_createActions",
			"createBody": "UfPxPW_createBody",
			"createDialog": "UfPxPW_createDialog",
			"createIn": "UfPxPW_createIn",
			"createInput": "UfPxPW_createInput",
			"createTitle": "UfPxPW_createTitle",
			"crumb": "UfPxPW_crumb",
			"crumbBar": "UfPxPW_crumbBar",
			"crumbChevron": "UfPxPW_crumbChevron",
			"crumbEditGlyph": "UfPxPW_crumbEditGlyph",
			"crumbEditZone": "UfPxPW_crumbEditZone",
			"crumbSeat": "UfPxPW_crumbSeat",
			"crumbTrail": "UfPxPW_crumbTrail",
			"dialog": "UfPxPW_dialog",
			"divider": "UfPxPW_divider",
			"editorScope": "UfPxPW_editorScope",
			"error": "UfPxPW_error",
			"footerAction": "UfPxPW_footerAction",
			"footerBar": "UfPxPW_footerBar",
			"footerGap": "UfPxPW_footerGap",
			"header": "UfPxPW_header",
			"loadingFloat": "UfPxPW_loadingFloat",
			"millerRow": "UfPxPW_millerRow",
			"pathInput": "UfPxPW_pathInput",
			"row": "UfPxPW_row",
			"rowChevron": "UfPxPW_rowChevron",
			"rowIcon": "UfPxPW_rowIcon",
			"rowIconSelected": "UfPxPW_rowIconSelected",
			"rowName": "UfPxPW_rowName",
			"rowSeat": "UfPxPW_rowSeat",
			"rowSelected": "UfPxPW_rowSelected",
			"showHiddenToggle": "UfPxPW_showHiddenToggle",
			"showHiddenToggleActive": "UfPxPW_showHiddenToggleActive",
			"status": "UfPxPW_status",
			"title": "UfPxPW_title"
		};
		//#endregion
