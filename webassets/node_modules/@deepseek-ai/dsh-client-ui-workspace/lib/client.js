window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-workspace\src\client\rows\Rows.module.css.mjs
		const css$2 = ".rQaEbW_projectRow,.rQaEbW_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.rQaEbW_projectRow:hover,.rQaEbW_sessionRow:hover,.rQaEbW_sessionRow.rQaEbW_selected{background:var(--dsw-alias-interactive-bg-hover)}.rQaEbW_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.rQaEbW_searchResultRow:hover,.rQaEbW_searchResultRow.rQaEbW_selected{background:var(--dsw-alias-interactive-bg-hover)}.rQaEbW_searchResultHeading{align-items:center;min-width:0;display:flex}.rQaEbW_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.rQaEbW_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.rQaEbW_searchResultWorkspace,.rQaEbW_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.rQaEbW_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.rQaEbW_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.rQaEbW_projectRow{box-sizing:border-box;align-items:center;height:34px}.rQaEbW_projectRow .rQaEbW_rowActions{height:20px}.rQaEbW_sessionRow{height:32px;animation:rQaEbW_row-in .15s var(--ds-ease-in-out);gap:0}.rQaEbW_sessionRow .rQaEbW_title{margin:0 6px 0 4px}.rQaEbW_flatSessionRowWithoutStatus .rQaEbW_title{margin-left:0}@keyframes rQaEbW_row-in{0%{opacity:0}}.rQaEbW_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.rQaEbW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.rQaEbW_folderActive{color:var(--dsw-alias-state-business-primary)}.rQaEbW_projectRow .rQaEbW_chevron{display:none}.rQaEbW_projectRow:hover .rQaEbW_chevron{display:inline-flex}.rQaEbW_projectRow:hover .rQaEbW_folder{display:none}.rQaEbW_arrow{transition:transform .15s var(--ds-ease-in-out)}.rQaEbW_arrowOpen{transform:rotate(90deg)}.rQaEbW_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.rQaEbW_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.rQaEbW_renameInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.rQaEbW_sessionRow .rQaEbW_title{flex:1}.rQaEbW_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.rQaEbW_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.rQaEbW_scheduleIndicator{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex}.rQaEbW_searchScheduleIndicator{margin-left:4px;margin-right:0}.rQaEbW_dot{flex:none}.rQaEbW_rowActions{flex:none;align-items:center;gap:12px;display:none}.rQaEbW_projectRow:hover .rQaEbW_rowActions,.rQaEbW_sessionRow:hover .rQaEbW_rowActions,.rQaEbW_projectRow.rQaEbW_menuOpen .rQaEbW_rowActions,.rQaEbW_sessionRow.rQaEbW_menuOpen .rQaEbW_rowActions{display:inline-flex}.rQaEbW_sessionRow:hover .rQaEbW_time,.rQaEbW_sessionRow.rQaEbW_menuOpen .rQaEbW_time{display:none}.rQaEbW_projectRow.rQaEbW_menuOpen,.rQaEbW_sessionRow.rQaEbW_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.rQaEbW_sessionRow.rQaEbW_dropBefore,.rQaEbW_sessionRow.rQaEbW_dropAfter{position:relative}.rQaEbW_sessionRow.rQaEbW_dropBefore:before,.rQaEbW_sessionRow.rQaEbW_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.rQaEbW_sessionRow.rQaEbW_dropBefore:before{top:-7px}.rQaEbW_sessionRow.rQaEbW_dropAfter:after{bottom:-7px}.rQaEbW_hoverContent{flex-direction:column;gap:8px;display:flex}.rQaEbW_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.rQaEbW_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.rQaEbW_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.rQaEbW_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.rQaEbW_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.rQaEbW_iconButton:hover{color:var(--dsw-alias-label-primary)}.rQaEbW_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.rQaEbW_sessionRow,.rQaEbW_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "rQaEbW_arrow",
			"arrowOpen": "rQaEbW_arrowOpen",
			"chevron": "rQaEbW_chevron",
			"dot": "rQaEbW_dot",
			"dropAfter": "rQaEbW_dropAfter",
			"dropBefore": "rQaEbW_dropBefore",
			"flatSessionRowWithoutStatus": "rQaEbW_flatSessionRowWithoutStatus",
			"folder": "rQaEbW_folder",
			"folderActive": "rQaEbW_folderActive",
			"hoverContent": "rQaEbW_hoverContent",
			"hoverPath": "rQaEbW_hoverPath",
			"hoverStatus": "rQaEbW_hoverStatus",
			"hoverTime": "rQaEbW_hoverTime",
			"hoverTitle": "rQaEbW_hoverTitle",
			"iconButton": "rQaEbW_iconButton",
			"menuOpen": "rQaEbW_menuOpen",
			"meta": "rQaEbW_meta",
			"projectRow": "rQaEbW_projectRow",
			"projectText": "rQaEbW_projectText",
			"renameInput": "rQaEbW_renameInput",
			"row-in": "rQaEbW_row-in",
			"rowActions": "rQaEbW_rowActions",
			"scheduleIndicator": "rQaEbW_scheduleIndicator",
			"searchResultHeading": "rQaEbW_searchResultHeading",
			"searchResultMeta": "rQaEbW_searchResultMeta",
			"searchResultRow": "rQaEbW_searchResultRow",
			"searchResultSnippet": "rQaEbW_searchResultSnippet",
			"searchResultTitle": "rQaEbW_searchResultTitle",
			"searchResultWorkspace": "rQaEbW_searchResultWorkspace",
			"searchScheduleIndicator": "rQaEbW_searchScheduleIndicator",
			"selected": "rQaEbW_selected",
			"sessionRow": "rQaEbW_sessionRow",
			"slot": "rQaEbW_slot",
			"time": "rQaEbW_time",
			"title": "rQaEbW_title",
			"visuallyHidden": "rQaEbW_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-workspace\src\client\WorkspacePicker.module.css.mjs
		const css$1 = "._7-43ua_modalAction{min-width:72px}._7-43ua_modalError,._7-43ua_menuStatus{margin-top:8px;font-size:12px;line-height:18px}._7-43ua_modalError{color:var(--dsw-alias-state-error-primary)}._7-43ua_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "_7-43ua_menuStatus",
			"modalAction": "_7-43ua_modalAction",
			"modalError": "_7-43ua_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-workspace\src\client\rows\WorkspaceBrowser.module.css.mjs
		const css = ".xG2x1G_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.xG2x1G_root.xG2x1G_rail{padding-right:0}.xG2x1G_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.xG2x1G_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.xG2x1G_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.xG2x1G_root:not(.xG2x1G_rail) .xG2x1G_sectionHeader{margin-top:2px;margin-right:-4px}.xG2x1G_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.xG2x1G_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.xG2x1G_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.xG2x1G_searchSlotExpanded{max-width:100%;padding-left:0}.xG2x1G_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.xG2x1G_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.xG2x1G_search{box-sizing:border-box;corner-shape:round;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.xG2x1G_searchExpanded{border:.5px solid var(--dsw-alias-border-l4);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.xG2x1G_searchButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.xG2x1G_searchExpanded .xG2x1G_searchButton{width:28px;height:30px}.xG2x1G_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.xG2x1G_searchExpanded .xG2x1G_searchButton:hover{background:0 0}.xG2x1G_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.xG2x1G_searchExpanded .xG2x1G_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.xG2x1G_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.xG2x1G_clearButton{corner-shape:round;cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.xG2x1G_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.xG2x1G_rail .xG2x1G_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.xG2x1G_rail .xG2x1G_headerActions{max-width:none}.xG2x1G_rail .xG2x1G_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.xG2x1G_rail .xG2x1G_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.xG2x1G_rail .xG2x1G_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.xG2x1G_rail .xG2x1G_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.xG2x1G_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.xG2x1G_rail .xG2x1G_listArea{margin-left:0;margin-right:0;padding-left:0}.xG2x1G_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.xG2x1G_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.xG2x1G_wide{animation:xG2x1G_wide-in .2s var(--ds-ease-in-out)}@keyframes xG2x1G_wide-in{0%{opacity:0}}.xG2x1G_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.xG2x1G_flatList>*+*,.xG2x1G_searchTree>[role=treeitem]+[role=treeitem],.xG2x1G_groupSection>*+*{margin-top:2px}.xG2x1G_searchStatus,.xG2x1G_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.xG2x1G_searchWarning{color:var(--dsw-alias-label-secondary)}.xG2x1G_groupSection{position:relative}.xG2x1G_groupSection+.xG2x1G_groupSection{margin-top:4px}.xG2x1G_listTopDropIndicator,.xG2x1G_workspaceDropBefore:before,.xG2x1G_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.xG2x1G_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.xG2x1G_listTopDropActive>.xG2x1G_workspaceDropBefore:first-child:before{display:none}.xG2x1G_workspaceDropBefore:before{top:-8px}.xG2x1G_workspaceDropAfter:after{bottom:-8px}.xG2x1G_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.xG2x1G_groupSection>.xG2x1G_sessionOverflowButton{margin-top:0}.xG2x1G_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.xG2x1G_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.xG2x1G_renameInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.xG2x1G_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.xG2x1G_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.xG2x1G_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.xG2x1G_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.xG2x1G_wide{animation:none}.xG2x1G_search,.xG2x1G_sectionLabel,.xG2x1G_searchSlot,.xG2x1G_searchInput,.xG2x1G_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "xG2x1G_clearButton",
			"deleteAction": "xG2x1G_deleteAction",
			"deleteStatus": "xG2x1G_deleteStatus",
			"empty": "xG2x1G_empty",
			"fade": "xG2x1G_fade",
			"flatList": "xG2x1G_flatList",
			"groupSection": "xG2x1G_groupSection",
			"headerActions": "xG2x1G_headerActions",
			"headerActionsHidden": "xG2x1G_headerActionsHidden",
			"iconButton": "xG2x1G_iconButton",
			"list": "xG2x1G_list",
			"listArea": "xG2x1G_listArea",
			"listTopDropActive": "xG2x1G_listTopDropActive",
			"listTopDropIndicator": "xG2x1G_listTopDropIndicator",
			"rail": "xG2x1G_rail",
			"renameError": "xG2x1G_renameError",
			"renameInput": "xG2x1G_renameInput",
			"root": "xG2x1G_root",
			"search": "xG2x1G_search",
			"searchButton": "xG2x1G_searchButton",
			"searchExpanded": "xG2x1G_searchExpanded",
			"searchInput": "xG2x1G_searchInput",
			"searchSlot": "xG2x1G_searchSlot",
			"searchSlotExpanded": "xG2x1G_searchSlotExpanded",
			"searchStatus": "xG2x1G_searchStatus",
			"searchTree": "xG2x1G_searchTree",
			"searchWarning": "xG2x1G_searchWarning",
			"sectionHeader": "xG2x1G_sectionHeader",
			"sectionLabel": "xG2x1G_sectionLabel",
			"sectionLabelHidden": "xG2x1G_sectionLabelHidden",
			"sessionOverflowButton": "xG2x1G_sessionOverflowButton",
			"treeBody": "xG2x1G_treeBody",
			"wide": "xG2x1G_wide",
			"wide-in": "xG2x1G_wide-in",
			"workspaceDropAfter": "xG2x1G_workspaceDropAfter",
			"workspaceDropBefore": "xG2x1G_workspaceDropBefore"
		};
		//#endregion
