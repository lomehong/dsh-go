window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$2 = ".j2QsEq_projectRow,.j2QsEq_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.j2QsEq_projectRow:hover,.j2QsEq_sessionRow:hover,.j2QsEq_sessionRow.j2QsEq_selected{background:var(--dsw-alias-interactive-bg-hover)}.j2QsEq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.j2QsEq_searchResultRow:hover,.j2QsEq_searchResultRow.j2QsEq_selected{background:var(--dsw-alias-interactive-bg-hover)}.j2QsEq_searchResultHeading{align-items:center;min-width:0;display:flex}.j2QsEq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.j2QsEq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.j2QsEq_searchResultWorkspace,.j2QsEq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.j2QsEq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.j2QsEq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.j2QsEq_projectRow{box-sizing:border-box;align-items:center;height:34px}.j2QsEq_projectRow .j2QsEq_rowActions{height:20px}.j2QsEq_sessionRow{height:32px;animation:j2QsEq_row-in .15s var(--ds-ease-in-out);gap:0}.j2QsEq_sessionRow .j2QsEq_title{margin:0 6px 0 4px}.j2QsEq_flatSessionRowWithoutStatus .j2QsEq_title{margin-left:0}@keyframes j2QsEq_row-in{0%{opacity:0}}.j2QsEq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.j2QsEq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.j2QsEq_folderActive{color:var(--dsw-alias-state-business-primary)}.j2QsEq_projectRow .j2QsEq_chevron{display:none}.j2QsEq_projectRow:hover .j2QsEq_chevron{display:inline-flex}.j2QsEq_projectRow:hover .j2QsEq_folder{display:none}.j2QsEq_arrow{transition:transform .15s var(--ds-ease-in-out)}.j2QsEq_arrowOpen{transform:rotate(90deg)}.j2QsEq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.j2QsEq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.j2QsEq_renameInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.j2QsEq_sessionRow .j2QsEq_title{flex:1}.j2QsEq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.j2QsEq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.j2QsEq_scheduleIndicator{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex}.j2QsEq_searchScheduleIndicator{margin-left:4px;margin-right:0}.j2QsEq_dot{flex:none}.j2QsEq_rowActions{flex:none;align-items:center;gap:12px;display:none}.j2QsEq_projectRow:hover .j2QsEq_rowActions,.j2QsEq_sessionRow:hover .j2QsEq_rowActions,.j2QsEq_projectRow.j2QsEq_menuOpen .j2QsEq_rowActions,.j2QsEq_sessionRow.j2QsEq_menuOpen .j2QsEq_rowActions{display:inline-flex}.j2QsEq_sessionRow:hover .j2QsEq_time,.j2QsEq_sessionRow.j2QsEq_menuOpen .j2QsEq_time{display:none}.j2QsEq_projectRow.j2QsEq_menuOpen,.j2QsEq_sessionRow.j2QsEq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.j2QsEq_sessionRow.j2QsEq_dropBefore,.j2QsEq_sessionRow.j2QsEq_dropAfter{position:relative}.j2QsEq_sessionRow.j2QsEq_dropBefore:before,.j2QsEq_sessionRow.j2QsEq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.j2QsEq_sessionRow.j2QsEq_dropBefore:before{top:-7px}.j2QsEq_sessionRow.j2QsEq_dropAfter:after{bottom:-7px}.j2QsEq_hoverContent{flex-direction:column;gap:8px;display:flex}.j2QsEq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.j2QsEq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.j2QsEq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.j2QsEq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.j2QsEq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.j2QsEq_iconButton:hover{color:var(--dsw-alias-label-primary)}.j2QsEq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.j2QsEq_sessionRow,.j2QsEq_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "j2QsEq_arrow",
			"arrowOpen": "j2QsEq_arrowOpen",
			"chevron": "j2QsEq_chevron",
			"dot": "j2QsEq_dot",
			"dropAfter": "j2QsEq_dropAfter",
			"dropBefore": "j2QsEq_dropBefore",
			"flatSessionRowWithoutStatus": "j2QsEq_flatSessionRowWithoutStatus",
			"folder": "j2QsEq_folder",
			"folderActive": "j2QsEq_folderActive",
			"hoverContent": "j2QsEq_hoverContent",
			"hoverPath": "j2QsEq_hoverPath",
			"hoverStatus": "j2QsEq_hoverStatus",
			"hoverTime": "j2QsEq_hoverTime",
			"hoverTitle": "j2QsEq_hoverTitle",
			"iconButton": "j2QsEq_iconButton",
			"menuOpen": "j2QsEq_menuOpen",
			"meta": "j2QsEq_meta",
			"projectRow": "j2QsEq_projectRow",
			"projectText": "j2QsEq_projectText",
			"renameInput": "j2QsEq_renameInput",
			"row-in": "j2QsEq_row-in",
			"rowActions": "j2QsEq_rowActions",
			"scheduleIndicator": "j2QsEq_scheduleIndicator",
			"searchResultHeading": "j2QsEq_searchResultHeading",
			"searchResultMeta": "j2QsEq_searchResultMeta",
			"searchResultRow": "j2QsEq_searchResultRow",
			"searchResultSnippet": "j2QsEq_searchResultSnippet",
			"searchResultTitle": "j2QsEq_searchResultTitle",
			"searchResultWorkspace": "j2QsEq_searchResultWorkspace",
			"searchScheduleIndicator": "j2QsEq_searchScheduleIndicator",
			"selected": "j2QsEq_selected",
			"sessionRow": "j2QsEq_sessionRow",
			"slot": "j2QsEq_slot",
			"time": "j2QsEq_time",
			"title": "j2QsEq_title",
			"visuallyHidden": "j2QsEq_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		const css$1 = ".bqOR3G_modalAction{min-width:72px}.bqOR3G_modalError,.bqOR3G_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.bqOR3G_modalError{color:var(--dsw-alias-state-error-primary)}.bqOR3G_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "bqOR3G_menuStatus",
			"modalAction": "bqOR3G_modalAction",
			"modalError": "bqOR3G_modalError"
		};
		//#endregion
		...
		*/
		...
		const css = ".LXC8la_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.LXC8la_root.LXC8la_rail{padding-right:0}.LXC8la_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.LXC8la_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.LXC8la_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.LXC8la_root:not(.LXC8la_rail) .LXC8la_sectionHeader{margin-top:2px;margin-right:-4px}.LXC8la_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.LXC8la_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.LXC8la_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.LXC8la_searchSlotExpanded{max-width:100%;padding-left:0}.LXC8la_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.LXC8la_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.LXC8la_search{box-sizing:border-box;corner-shape:round;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.LXC8la_searchExpanded{border:.5px solid var(--dsw-alias-border-l4);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.LXC8la_searchButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.LXC8la_searchExpanded .LXC8la_searchButton{width:28px;height:30px}.LXC8la_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.LXC8la_searchExpanded .LXC8la_searchButton:hover{background:0 0}.LXC8la_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.LXC8la_searchExpanded .LXC8la_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.LXC8la_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.LXC8la_clearButton{corner-shape:round;cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.LXC8la_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.LXC8la_rail .LXC8la_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.LXC8la_rail .LXC8la_headerActions{max-width:none}.LXC8la_rail .LXC8la_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.LXC8la_rail .LXC8la_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.LXC8la_rail .LXC8la_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.LXC8la_rail .LXC8la_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.LXC8la_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.LXC8la_rail .LXC8la_listArea{margin-left:0;margin-right:0;padding-left:0}.LXC8la_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.LXC8la_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.LXC8la_wide{animation:LXC8la_wide-in .2s var(--ds-ease-in-out)}@keyframes LXC8la_wide-in{0%{opacity:0}}.LXC8la_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.LXC8la_flatList>*+*,.LXC8la_searchTree>[role=treeitem]+[role=treeitem],.LXC8la_groupSection>*+*{margin-top:2px}.LXC8la_searchStatus,.LXC8la_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.LXC8la_searchWarning{color:var(--dsw-alias-label-secondary)}.LXC8la_groupSection{position:relative}.LXC8la_groupSection+.LXC8la_groupSection{margin-top:4px}.LXC8la_listTopDropIndicator,.LXC8la_workspaceDropBefore:before,.LXC8la_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.LXC8la_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.LXC8la_listTopDropActive>.LXC8la_workspaceDropBefore:first-child:before{display:none}.LXC8la_workspaceDropBefore:before{top:-8px}.LXC8la_workspaceDropAfter:after{bottom:-8px}.LXC8la_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.LXC8la_groupSection>.LXC8la_sessionOverflowButton{margin-top:0}.LXC8la_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.LXC8la_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.LXC8la_renameInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.LXC8la_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.LXC8la_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.LXC8la_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.LXC8la_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.LXC8la_wide{animation:none}.LXC8la_search,.LXC8la_sectionLabel,.LXC8la_searchSlot,.LXC8la_searchInput,.LXC8la_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "LXC8la_clearButton",
			"deleteAction": "LXC8la_deleteAction",
			"deleteStatus": "LXC8la_deleteStatus",
			"empty": "LXC8la_empty",
			"fade": "LXC8la_fade",
			"flatList": "LXC8la_flatList",
			"groupSection": "LXC8la_groupSection",
			"headerActions": "LXC8la_headerActions",
			"headerActionsHidden": "LXC8la_headerActionsHidden",
			"iconButton": "LXC8la_iconButton",
			"list": "LXC8la_list",
			"listArea": "LXC8la_listArea",
			"listTopDropActive": "LXC8la_listTopDropActive",
			"listTopDropIndicator": "LXC8la_listTopDropIndicator",
			"rail": "LXC8la_rail",
			"renameError": "LXC8la_renameError",
			"renameInput": "LXC8la_renameInput",
			"root": "LXC8la_root",
			"search": "LXC8la_search",
			"searchButton": "LXC8la_searchButton",
			"searchExpanded": "LXC8la_searchExpanded",
			"searchInput": "LXC8la_searchInput",
			"searchSlot": "LXC8la_searchSlot",
			"searchSlotExpanded": "LXC8la_searchSlotExpanded",
			"searchStatus": "LXC8la_searchStatus",
			"searchTree": "LXC8la_searchTree",
			"searchWarning": "LXC8la_searchWarning",
			"sectionHeader": "LXC8la_sectionHeader",
			"sectionLabel": "LXC8la_sectionLabel",
			"sectionLabelHidden": "LXC8la_sectionLabelHidden",
			"sessionOverflowButton": "LXC8la_sessionOverflowButton",
			"treeBody": "LXC8la_treeBody",
			"wide": "LXC8la_wide",
			"wide-in": "LXC8la_wide-in",
			"workspaceDropAfter": "LXC8la_workspaceDropAfter",
			"workspaceDropBefore": "LXC8la_workspaceDropBefore"
		};
		//#endregion
