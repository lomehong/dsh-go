window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-subagent\src\client\SubagentHeaderLineage.module.css.mjs
		const css$1 = ".RkyB2G_root{align-items:center;gap:10px;min-width:0;display:inline-flex;position:relative}.RkyB2G_switcherRoot{min-width:0;margin-left:6px}.RkyB2G_trigger,.RkyB2G_switcherTrigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.RkyB2G_trigger{gap:4px}.RkyB2G_switcherTrigger{min-width:0;max-width:244px;color:var(--dsw-alias-label-primary);gap:4px;font-weight:500}.RkyB2G_ancestorSwitcherTrigger{color:var(--dsw-alias-label-tertiary);font-weight:400}.RkyB2G_switcherTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.RkyB2G_switcherTrigger svg{flex:none}.RkyB2G_separator{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.RkyB2G_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.RkyB2G_trigger:hover,.RkyB2G_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.RkyB2G_switcherTrigger:hover,.RkyB2G_switcherTrigger:focus-visible{color:var(--dsw-alias-label-primary)}.RkyB2G_ancestorSwitcherTrigger:hover,.RkyB2G_ancestorSwitcherTrigger:focus-visible{color:var(--dsw-alias-label-tertiary)}.RkyB2G_trigger svg,.RkyB2G_switcherTrigger svg{transition:transform .12s}.RkyB2G_triggerOpen{transform:rotate(180deg)}.RkyB2G_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border-radius:20px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:auto}.RkyB2G_node{min-width:0;position:relative}.RkyB2G_menu>.RkyB2G_node{margin-left:-3px}.RkyB2G_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.RkyB2G_row:hover>.RkyB2G_clickarea,.RkyB2G_row:focus-visible>.RkyB2G_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.RkyB2G_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.RkyB2G_row>[data-state],.RkyB2G_clickarea>[data-state]{margin-top:4px}.RkyB2G_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.RkyB2G_disabled:hover{background:0 0}.RkyB2G_loadingRow{cursor:default}.RkyB2G_disclosure,.RkyB2G_disclosureSpace{flex:none;width:14px;height:18px}.RkyB2G_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.RkyB2G_disclosure:hover{color:var(--dsw-alias-label-primary)}.RkyB2G_disclosureOpen{transform:rotate(90deg)}.RkyB2G_content{flex-direction:column;flex:1;min-width:0;display:flex}.RkyB2G_label,.RkyB2G_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.RkyB2G_label{color:inherit;font-weight:400}.RkyB2G_currentLabel{font-weight:600}.RkyB2G_summary,.RkyB2G_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.RkyB2G_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.RkyB2G_metricToken{grid-row:1;line-height:18px}.RkyB2G_metricDuration{grid-row:2}.RkyB2G_children{margin-left:18px;padding-left:4px;position:relative}.RkyB2G_children:before,.RkyB2G_children>.RkyB2G_node:before{content:\"\";border-left:.5px solid var(--dsw-alias-border-l2);position:absolute;left:0}.RkyB2G_children:before{height:26px;top:-26px}.RkyB2G_children[aria-busy=true]:before{content:none}.RkyB2G_children>.RkyB2G_node:before{top:0;bottom:0;left:-4px}.RkyB2G_children>.RkyB2G_node:last-child:before{height:17px;bottom:auto}.RkyB2G_children>.RkyB2G_node>.RkyB2G_row:before{content:\"\";border-top:.5px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.RkyB2G_notice,.RkyB2G_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.RkyB2G_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.RkyB2G_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.RkyB2G_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentHeaderLineage_module_css_default = {
			"activitySlot": "RkyB2G_activitySlot",
			"ancestorSwitcherTrigger": "RkyB2G_ancestorSwitcherTrigger",
			"children": "RkyB2G_children",
			"clickarea": "RkyB2G_clickarea",
			"content": "RkyB2G_content",
			"currentLabel": "RkyB2G_currentLabel",
			"disabled": "RkyB2G_disabled",
			"disclosure": "RkyB2G_disclosure",
			"disclosureOpen": "RkyB2G_disclosureOpen",
			"disclosureSpace": "RkyB2G_disclosureSpace",
			"error": "RkyB2G_error",
			"label": "RkyB2G_label",
			"loadingRow": "RkyB2G_loadingRow",
			"menu": "RkyB2G_menu",
			"metricDuration": "RkyB2G_metricDuration",
			"metricToken": "RkyB2G_metricToken",
			"metrics": "RkyB2G_metrics",
			"node": "RkyB2G_node",
			"notice": "RkyB2G_notice",
			"refresh": "RkyB2G_refresh",
			"root": "RkyB2G_root",
			"row": "RkyB2G_row",
			"separator": "RkyB2G_separator",
			"summary": "RkyB2G_summary",
			"switcherRoot": "RkyB2G_switcherRoot",
			"switcherTitle": "RkyB2G_switcherTitle",
			"switcherTrigger": "RkyB2G_switcherTrigger",
			"trigger": "RkyB2G_trigger",
			"triggerOpen": "RkyB2G_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		function CatalogLoadingRows({ parentSessionId, summaries, level, t }) {
			...
			return children.map((summary) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: SubagentHeaderLineage_module_css_default.disclosureSpace }),
				...
				catalog.entries.map((entry) => {
					if (entry.kind === "diagnostic") {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								title: reason,
								children: [
									reserveDisclosure && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: SubagentHeaderLineage_module_css_default.disclosureSpace }),
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							onClick: open,
							onKeyDown: handleKey,
							children: [knownLeaf ? reserveDisclosure && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: SubagentHeaderLineage_module_css_default.disclosureSpace }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								tabIndex: -1,
		...
		function CatalogDropdown({ rootSessionId, currentSessionId, displayTitle, openTitle, variant, separator = false, useSessions, openChild, refresh, setCatalogOpen, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					separator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [variant === "switcher" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: SubagentHeaderLineage_module_css_default.switcherTitle,
							children: switcherDisplayTitle
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [descendants.runningCount > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						})] }), variant === "switcher" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SubagentSwitcherIcon, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: open ? SubagentHeaderLineage_module_css_default.triggerOpen : void 0 })]
					}),
		...
		*/
		function SubagentHeaderLineage({ lineageSessionId, displayTitle, openTitle, useSessions, openChild, refresh, setCatalogOpen, t }) {
			...
			if (parentId === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CatalogDropdown, {
				rootSessionId: lineageSessionId,
				variant: "count",
				separator: true,
				...shared
			}, lineageSessionId);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CatalogDropdown, {
				...
				...shared
			}, lineageSessionId), openTitle === void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CatalogDropdown, {
				rootSessionId: lineageSessionId,
				variant: "count",
				...shared
			}, lineageSessionId)] });
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-subagent\src\client\SubagentReadOnlyComposer.module.css.mjs
		const css = ".l5oVaa_frame{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.l5oVaa_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "l5oVaa_frame" };
		//#endregion
