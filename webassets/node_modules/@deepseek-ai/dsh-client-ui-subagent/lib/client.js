window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".CfCmDa_root{align-items:center;gap:10px;min-width:0;display:inline-flex;position:relative}.CfCmDa_switcherRoot{min-width:0;margin-left:6px}.CfCmDa_trigger,.CfCmDa_switcherTrigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.CfCmDa_trigger{gap:4px}.CfCmDa_switcherTrigger{min-width:0;max-width:244px;color:var(--dsw-alias-label-primary);gap:4px;font-weight:500}.CfCmDa_ancestorSwitcherTrigger{color:var(--dsw-alias-label-tertiary);font-weight:400}.CfCmDa_switcherTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.CfCmDa_switcherTrigger svg{flex:none}.CfCmDa_separator{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.CfCmDa_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.CfCmDa_trigger:hover,.CfCmDa_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.CfCmDa_switcherTrigger:hover,.CfCmDa_switcherTrigger:focus-visible{color:var(--dsw-alias-label-primary)}.CfCmDa_ancestorSwitcherTrigger:hover,.CfCmDa_ancestorSwitcherTrigger:focus-visible{color:var(--dsw-alias-label-tertiary)}.CfCmDa_trigger svg,.CfCmDa_switcherTrigger svg{transition:transform .12s}.CfCmDa_triggerOpen{transform:rotate(180deg)}.CfCmDa_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border-radius:20px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:auto}.CfCmDa_node{min-width:0;position:relative}.CfCmDa_menu>.CfCmDa_node{margin-left:-3px}.CfCmDa_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.CfCmDa_row:hover>.CfCmDa_clickarea,.CfCmDa_row:focus-visible>.CfCmDa_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.CfCmDa_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.CfCmDa_row>[data-state],.CfCmDa_clickarea>[data-state]{margin-top:4px}.CfCmDa_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.CfCmDa_disabled:hover{background:0 0}.CfCmDa_loadingRow{cursor:default}.CfCmDa_disclosure,.CfCmDa_disclosureSpace{flex:none;width:14px;height:18px}.CfCmDa_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.CfCmDa_disclosure:hover{color:var(--dsw-alias-label-primary)}.CfCmDa_disclosureOpen{transform:rotate(90deg)}.CfCmDa_content{flex-direction:column;flex:1;min-width:0;display:flex}.CfCmDa_label,.CfCmDa_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.CfCmDa_label{color:inherit;font-weight:400}.CfCmDa_currentLabel{font-weight:600}.CfCmDa_summary,.CfCmDa_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.CfCmDa_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.CfCmDa_metricToken{grid-row:1;line-height:18px}.CfCmDa_metricDuration{grid-row:2}.CfCmDa_children{margin-left:18px;padding-left:4px;position:relative}.CfCmDa_children:before,.CfCmDa_children>.CfCmDa_node:before{content:\"\";border-left:.5px solid var(--dsw-alias-border-l2);position:absolute;left:0}.CfCmDa_children:before{height:26px;top:-26px}.CfCmDa_children[aria-busy=true]:before{content:none}.CfCmDa_children>.CfCmDa_node:before{top:0;bottom:0;left:-4px}.CfCmDa_children>.CfCmDa_node:last-child:before{height:17px;bottom:auto}.CfCmDa_children>.CfCmDa_node>.CfCmDa_row:before{content:\"\";border-top:.5px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.CfCmDa_notice,.CfCmDa_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.CfCmDa_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.CfCmDa_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.CfCmDa_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentHeaderLineage_module_css_default = {
			"activitySlot": "CfCmDa_activitySlot",
			"ancestorSwitcherTrigger": "CfCmDa_ancestorSwitcherTrigger",
			"children": "CfCmDa_children",
			"clickarea": "CfCmDa_clickarea",
			"content": "CfCmDa_content",
			"currentLabel": "CfCmDa_currentLabel",
			"disabled": "CfCmDa_disabled",
			"disclosure": "CfCmDa_disclosure",
			"disclosureOpen": "CfCmDa_disclosureOpen",
			"disclosureSpace": "CfCmDa_disclosureSpace",
			"error": "CfCmDa_error",
			"label": "CfCmDa_label",
			"loadingRow": "CfCmDa_loadingRow",
			"menu": "CfCmDa_menu",
			"metricDuration": "CfCmDa_metricDuration",
			"metricToken": "CfCmDa_metricToken",
			"metrics": "CfCmDa_metrics",
			"node": "CfCmDa_node",
			"notice": "CfCmDa_notice",
			"refresh": "CfCmDa_refresh",
			"root": "CfCmDa_root",
			"row": "CfCmDa_row",
			"separator": "CfCmDa_separator",
			"summary": "CfCmDa_summary",
			"switcherRoot": "CfCmDa_switcherRoot",
			"switcherTitle": "CfCmDa_switcherTitle",
			"switcherTrigger": "CfCmDa_switcherTrigger",
			"trigger": "CfCmDa_trigger",
			"triggerOpen": "CfCmDa_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "uB-pqq_frame" };
		//#endregion
