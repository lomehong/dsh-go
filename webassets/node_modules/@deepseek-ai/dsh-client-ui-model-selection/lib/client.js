window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-model-selection\src\client\ModelSelect.module.css.mjs
		const css = ".Y6O-zG_root{min-width:0;position:relative}.Y6O-zG_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.Y6O-zG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Y6O-zG_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.Y6O-zG_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Y6O-zG_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Y6O-zG_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.Y6O-zG_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.Y6O-zG_chevronOpen{transform:rotate(180deg)}.Y6O-zG_menu{z-index:20;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.Y6O-zG_status,.Y6O-zG_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.Y6O-zG_error,.Y6O-zG_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.Y6O-zG_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.Y6O-zG_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.Y6O-zG_groups{min-height:0;overflow-y:auto}.Y6O-zG_group+.Y6O-zG_group{margin-top:4px}.Y6O-zG_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.Y6O-zG_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.Y6O-zG_option:hover:not(:disabled),.Y6O-zG_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.Y6O-zG_selected{background:0 0}.Y6O-zG_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Y6O-zG_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Y6O-zG_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.Y6O-zG_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.Y6O-zG_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.Y6O-zG_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.Y6O-zG_cellLabel{white-space:nowrap;flex:none}.Y6O-zG_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.Y6O-zG_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "Y6O-zG_cell",
			"cellChevron": "Y6O-zG_cellChevron",
			"cellLabel": "Y6O-zG_cellLabel",
			"cellValue": "Y6O-zG_cellValue",
			"check": "Y6O-zG_check",
			"chevron": "Y6O-zG_chevron",
			"chevronOpen": "Y6O-zG_chevronOpen",
			"empty": "Y6O-zG_empty",
			"error": "Y6O-zG_error",
			"group": "Y6O-zG_group",
			"groupTitle": "Y6O-zG_groupTitle",
			"groups": "Y6O-zG_groups",
			"menu": "Y6O-zG_menu",
			"modelName": "Y6O-zG_modelName",
			"option": "Y6O-zG_option",
			"optionCopy": "Y6O-zG_optionCopy",
			"retry": "Y6O-zG_retry",
			"root": "Y6O-zG_root",
			"selected": "Y6O-zG_selected",
			"status": "Y6O-zG_status",
			"trigger": "Y6O-zG_trigger",
			"triggerEffort": "Y6O-zG_triggerEffort",
			"triggerLabel": "Y6O-zG_triggerLabel",
			"warning": "Y6O-zG_warning"
		};
		//#endregion
