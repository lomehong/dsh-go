window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".vWv73W_root{min-width:0;position:relative}.vWv73W_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.vWv73W_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.vWv73W_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.vWv73W_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.vWv73W_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.vWv73W_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.vWv73W_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.vWv73W_chevronOpen{transform:rotate(180deg)}.vWv73W_menu{z-index:20;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.vWv73W_status,.vWv73W_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.vWv73W_error,.vWv73W_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.vWv73W_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.vWv73W_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.vWv73W_groups{min-height:0;overflow-y:auto}.vWv73W_group+.vWv73W_group{margin-top:4px}.vWv73W_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.vWv73W_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.vWv73W_option:hover:not(:disabled),.vWv73W_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.vWv73W_selected{background:0 0}.vWv73W_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.vWv73W_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.vWv73W_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.vWv73W_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.vWv73W_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.vWv73W_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.vWv73W_cellLabel{white-space:nowrap;flex:none}.vWv73W_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.vWv73W_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "vWv73W_cell",
			"cellChevron": "vWv73W_cellChevron",
			"cellLabel": "vWv73W_cellLabel",
			"cellValue": "vWv73W_cellValue",
			"check": "vWv73W_check",
			"chevron": "vWv73W_chevron",
			"chevronOpen": "vWv73W_chevronOpen",
			"empty": "vWv73W_empty",
			"error": "vWv73W_error",
			"group": "vWv73W_group",
			"groupTitle": "vWv73W_groupTitle",
			"groups": "vWv73W_groups",
			"menu": "vWv73W_menu",
			"modelName": "vWv73W_modelName",
			"option": "vWv73W_option",
			"optionCopy": "vWv73W_optionCopy",
			"retry": "vWv73W_retry",
			"root": "vWv73W_root",
			"selected": "vWv73W_selected",
			"status": "vWv73W_status",
			"trigger": "vWv73W_trigger",
			"triggerEffort": "vWv73W_triggerEffort",
			"triggerLabel": "vWv73W_triggerLabel",
			"warning": "vWv73W_warning"
		};
		//#endregion
