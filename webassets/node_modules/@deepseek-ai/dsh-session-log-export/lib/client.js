window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\session-query\session-log-export\src\client\HeaderAction.module.css.mjs
		const css = ".psgVSG_sessionLogButton{border:.5px solid var(--dsw-alias-border-l4);min-width:111px;height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.psgVSG_sessionLogButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.psgVSG_sessionLogButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.psgVSG_sessionLogButton span,.psgVSG_sessionLogButton svg{flex:none}.psgVSG_sessionLogButton span{white-space:nowrap}";
		...
		var HeaderAction_module_css_default = { "sessionLogButton": "psgVSG_sessionLogButton" };
		//#endregion
		...
		*/
		function SessionLogDownloadHeaderAction(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("header.action") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDownloadOutline16, { size: 12 })]
