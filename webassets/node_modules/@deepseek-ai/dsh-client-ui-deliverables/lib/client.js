window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-deliverables\src\client\ProducedFiles.module.css.mjs
		const css = ".nOducG_root{grid-template-columns:max-content minmax(0,1fr);align-items:start;column-gap:8px;margin-top:16px;font-size:13px;line-height:22px;display:grid}.nOducG_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}.nOducG_lane{--produced-file-gap:8px;grid-area:1/2;row-gap:6px;min-width:0;display:grid;container-type:inline-size}.nOducG_row{align-items:center;gap:var(--produced-file-gap);flex-wrap:nowrap;min-width:0;display:flex;overflow:hidden}.nOducG_file{box-sizing:border-box;min-width:0;color:var(--dsw-alias-link);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;flex:0 auto;align-items:center;gap:5px;margin:0;padding:0;font-weight:500;text-decoration:none;display:inline-flex}.nOducG_fileIcon{flex:none;width:1.1em;height:1.1em;position:relative;top:1.2px}.nOducG_fileName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.nOducG_file:hover,.nOducG_file:focus-visible{text-underline-offset:3px;text-decoration:underline dotted}.nOducG_file:focus-visible,.nOducG_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-border-l3);outline:none}.nOducG_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;display:none}.nOducG_more[data-shown=\"6\"]{display:inline}.nOducG_showFolder{display:none}.nOducG_lane:has(.nOducG_more[data-shown=\"6\"])>.nOducG_showFolder{display:flex}@container (width<=687px){.nOducG_file:nth-of-type(6),.nOducG_more[data-shown=\"6\"]{display:none}.nOducG_more[data-shown=\"5\"]{display:inline}.nOducG_showFolder{display:none}.nOducG_lane:has(.nOducG_more[data-shown=\"5\"])>.nOducG_showFolder{display:flex}}@container (width<=583px){.nOducG_file:nth-of-type(5),.nOducG_more[data-shown=\"5\"]{display:none}.nOducG_more[data-shown=\"4\"]{display:inline}.nOducG_showFolder{display:none}.nOducG_lane:has(.nOducG_more[data-shown=\"4\"])>.nOducG_showFolder{display:flex}}@container (width<=479px){.nOducG_file:nth-of-type(4),.nOducG_more[data-shown=\"4\"]{display:none}.nOducG_more[data-shown=\"3\"]{display:inline}.nOducG_showFolder{display:none}.nOducG_lane:has(.nOducG_more[data-shown=\"3\"])>.nOducG_showFolder{display:flex}}@container (width<=375px){.nOducG_file:nth-of-type(3),.nOducG_more[data-shown=\"3\"]{display:none}.nOducG_more[data-shown=\"2\"]{display:inline}.nOducG_showFolder{display:none}.nOducG_lane:has(.nOducG_more[data-shown=\"2\"])>.nOducG_showFolder{display:flex}}@container (width<=271px){.nOducG_file:nth-of-type(2),.nOducG_more[data-shown=\"2\"]{display:none}.nOducG_more[data-shown=\"1\"]{display:inline}.nOducG_showFolder{display:none}.nOducG_lane:has(.nOducG_more[data-shown=\"1\"])>.nOducG_showFolder{display:flex}}.nOducG_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;justify-self:start;align-items:center;gap:5px;margin:0;padding:0 2px;line-height:20px}.nOducG_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}";
		...
		var ProducedFiles_module_css_default = {
			"file": "nOducG_file",
			"fileIcon": "nOducG_fileIcon",
			"fileName": "nOducG_fileName",
			"label": "nOducG_label",
			"lane": "nOducG_lane",
			"more": "nOducG_more",
			"root": "nOducG_root",
			"row": "nOducG_row",
			"showFolder": "nOducG_showFolder"
		};
		//#endregion
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [shown.map((path) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
					...
					}), paths.length > 1 && canOpenPath && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						type: "button",
