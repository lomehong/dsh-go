...
- insert:
    ...
    # The session-query engine itself (Go catalog @deepseek-ai/dsh-session-query).
    # The sqlite row above is the optional search backend only; without this
    # row the engine (and therefore session/list's live corpus) never mounts.
    - id: session-query
