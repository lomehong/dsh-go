window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\MessageItem.module.css.mjs
		const css$15 = ".AqXkJG_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.AqXkJG_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.AqXkJG_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.AqXkJG_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.AqXkJG_contextRow,.AqXkJG_compactionRow{padding:2px 0}.AqXkJG_compactionButton{width:100%;height:calc(24px + var(--dsh-content-font-delta,0px));min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.AqXkJG_compactionButton:not(:disabled){cursor:pointer}.AqXkJG_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.AqXkJG_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.AqXkJG_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.AqXkJG_compactionContextIcon,.AqXkJG_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.AqXkJG_compactionDisclosureIcon,.AqXkJG_compactionButton:not(:disabled):hover .AqXkJG_compactionContextIcon,.AqXkJG_compactionButton:not(:disabled):focus-visible .AqXkJG_compactionContextIcon{opacity:0}.AqXkJG_compactionButton:not(:disabled):hover .AqXkJG_compactionDisclosureIcon,.AqXkJG_compactionButton:not(:disabled):focus-visible .AqXkJG_compactionDisclosureIcon{opacity:1}.AqXkJG_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.AqXkJG_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.AqXkJG_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.AqXkJG_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.AqXkJG_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.AqXkJG_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.AqXkJG_retrySummary::-webkit-details-marker{display:none}.AqXkJG_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.AqXkJG_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.AqXkJG_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.AqXkJG_retryText{color:inherit}.AqXkJG_retryRow[data-active] .AqXkJG_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite AqXkJG_retry-shimmer}.AqXkJG_retryRow[open] .AqXkJG_retrySummary:after{transform:rotate(45deg)}.AqXkJG_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.AqXkJG_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.AqXkJG_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.AqXkJG_turnErrorDot{margin-top:5px}.AqXkJG_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.AqXkJG_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.AqXkJG_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.AqXkJG_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.AqXkJG_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes AqXkJG_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.AqXkJG_retryRow[data-active] .AqXkJG_retryText{color:inherit;background:0 0;animation:none}}.AqXkJG_attachmentRow{flex-wrap:wrap;justify-content:flex-end;gap:8px;max-width:100%;display:flex}.AqXkJG_fileCard{border:.5px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-specific-input-major,transparent);box-sizing:border-box;border-radius:16px;flex:0 0 240px;align-items:center;gap:10px;width:240px;min-height:64px;padding:8px 12px;display:inline-flex}.AqXkJG_fileIcon{flex:none;width:24px;height:28px}.AqXkJG_fileContent{flex-direction:column;flex:1;min-width:0;display:flex}.AqXkJG_fileName{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.AqXkJG_fileMeta{white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-tertiary,#00000073);font-size:12px;line-height:15px;overflow:hidden}";
		...
		var MessageItem_module_css_default = {
			"attachmentRow": "AqXkJG_attachmentRow",
			"bubble": "AqXkJG_bubble",
			"compactionBody": "AqXkJG_compactionBody",
			"compactionButton": "AqXkJG_compactionButton",
			"compactionContextIcon": "AqXkJG_compactionContextIcon",
			"compactionDisclosureIcon": "AqXkJG_compactionDisclosureIcon",
			"compactionLeading": "AqXkJG_compactionLeading",
			"compactionRow": "AqXkJG_compactionRow",
			"compactionSep": "AqXkJG_compactionSep",
			"compactionSummary": "AqXkJG_compactionSummary",
			"compactionTitle": "AqXkJG_compactionTitle",
			"contextRow": "AqXkJG_contextRow",
			"fileCard": "AqXkJG_fileCard",
			"fileContent": "AqXkJG_fileContent",
			"fileIcon": "AqXkJG_fileIcon",
			"fileMeta": "AqXkJG_fileMeta",
			"fileName": "AqXkJG_fileName",
			"maxTokensTitle": "AqXkJG_maxTokensTitle",
			"referenceSummary": "AqXkJG_referenceSummary",
			"retry-shimmer": "AqXkJG_retry-shimmer",
			"retryDetailLabel": "AqXkJG_retryDetailLabel",
			"retryDetails": "AqXkJG_retryDetails",
			"retryRow": "AqXkJG_retryRow",
			"retrySummary": "AqXkJG_retrySummary",
			"retryText": "AqXkJG_retryText",
			"turnErrorCode": "AqXkJG_turnErrorCode",
			"turnErrorCopy": "AqXkJG_turnErrorCopy",
			"turnErrorDot": "AqXkJG_turnErrorDot",
			"turnErrorMessage": "AqXkJG_turnErrorMessage",
			"turnErrorRow": "AqXkJG_turnErrorRow",
			"turnErrorTitle": "AqXkJG_turnErrorTitle",
			"userRow": "AqXkJG_userRow",
			"userStack": "AqXkJG_userStack"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\ContextBody.module.css.mjs
		const css$14 = ".bajRzW_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.bajRzW_fields{border-top:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.bajRzW_field{gap:8px;min-width:0;display:flex}.bajRzW_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.bajRzW_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.bajRzW_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.bajRzW_file{align-items:baseline;gap:6px;min-width:0;display:flex}.bajRzW_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.bajRzW_fileAction{color:var(--dsw-alias-label-caption)}.bajRzW_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.bajRzW_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.bajRzW_entry{gap:8px;min-width:0;display:flex}.bajRzW_entryName{color:var(--dsw-alias-label-secondary);flex:none}.bajRzW_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.bajRzW_sections{flex-direction:column;gap:8px;margin:0;display:flex}.bajRzW_section{flex-direction:column;gap:2px;min-width:0;display:flex}.bajRzW_sectionName{color:var(--dsw-alias-label-caption)}.bajRzW_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.bajRzW_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.bajRzW_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.bajRzW_recall{gap:8px;min-width:0;display:flex}.bajRzW_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.bajRzW_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "bajRzW_catalogNotice",
			"entries": "bajRzW_entries",
			"entry": "bajRzW_entry",
			"entryDescription": "bajRzW_entryDescription",
			"entryName": "bajRzW_entryName",
			"field": "bajRzW_field",
			"fieldKey": "bajRzW_fieldKey",
			"fieldValue": "bajRzW_fieldValue",
			"fields": "bajRzW_fields",
			"file": "bajRzW_file",
			"fileAction": "bajRzW_fileAction",
			"filePath": "bajRzW_filePath",
			"files": "bajRzW_files",
			"recall": "bajRzW_recall",
			"recallCounts": "bajRzW_recallCounts",
			"recallLabel": "bajRzW_recallLabel",
			"recalls": "bajRzW_recalls",
			"relaySender": "bajRzW_relaySender",
			"section": "bajRzW_section",
			"sectionName": "bajRzW_sectionName",
			"sectionText": "bajRzW_sectionText",
			"sections": "bajRzW_sections",
			"text": "bajRzW_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\ContextInjectionRow.module.css.mjs
		const css$13 = ".bF1HKW_root{min-width:0}.bF1HKW_root[data-open]{padding-bottom:4px}.bF1HKW_chevron{color:var(--dsw-alias-label-secondary)}.bF1HKW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.bF1HKW_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.bF1HKW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.bF1HKW_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "bF1HKW_body",
			"chevron": "bF1HKW_chevron",
			"root": "bF1HKW_root",
			"sep": "bF1HKW_sep",
			"source": "bF1HKW_source",
			"summary": "bF1HKW_summary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\MessageIconActions.module.css.mjs
		const css$12 = ".aWOlwq_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:8px;display:flex}.aWOlwq_timeStart{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}.aWOlwq_timeEnd{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap}@media (hover:hover){[data-actions-reveal=hover] .aWOlwq_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])) .aWOlwq_actions{opacity:0;transition:opacity 80ms}[data-actions-reveal=hover]:hover .aWOlwq_actions,[data-actions-reveal=hover]:focus-within .aWOlwq_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):hover .aWOlwq_actions,:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering]):has(~:is([data-chat-flow-kind=user],[data-chat-flow-kind=steering])):focus-within .aWOlwq_actions{opacity:1}}.aWOlwq_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.aWOlwq_action svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px))}.aWOlwq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.aWOlwq_action[data-unavailable]{cursor:default;opacity:.4}.aWOlwq_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.aWOlwq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"action": "aWOlwq_action",
			"actions": "aWOlwq_actions",
			"timeEnd": "aWOlwq_timeEnd",
			"timeStart": "aWOlwq_timeStart",
			"visuallyHidden": "aWOlwq_visuallyHidden"
		};
		//#endregion
					...
					children: [
						attachments.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: attachments.map((attachment, index) => attachment.type === "image" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: renderMessageImages({
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.DocumentFileIcon, { className: MessageItem_module_css_default.fileIcon }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\ChatView.module.css.mjs
		const css$11 = ".ToU8hG_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}.ToU8hG_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] .ToU8hG_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] .ToU8hG_scroll{flex:none;min-height:auto;overflow:visible}.ToU8hG_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}.ToU8hG_column>:not([hidden]):not(.ToU8hG_flowItem:empty)~:not([hidden]):not(.ToU8hG_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}.ToU8hG_flowItem{min-width:0}.ToU8hG_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}.ToU8hG_flowItem:empty{display:none}.ToU8hG_callRow{border-radius:6px}.ToU8hG_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite ToU8hG_dsh-turn-status-shimmer;display:inline-flex}.ToU8hG_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes ToU8hG_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){.ToU8hG_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}.ToU8hG_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.ToU8hG_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.ToU8hG_older{justify-content:center;display:flex}.ToU8hG_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}.ToU8hG_older button:disabled{cursor:default;opacity:.6}.ToU8hG_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] .ToU8hG_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}.ToU8hG_toBottom{--dsw-elevation-stroke-color:var(--dsw-alias-border-l3);corner-shape:round;width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-elevation-panel);cursor:pointer;pointer-events:auto;border:0;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}.ToU8hG_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}.ToU8hG_modalAction{min-width:72px}";
		...
		var ChatView_module_css_default = {
			"callRow": "ToU8hG_callRow",
			"column": "ToU8hG_column",
			"dsh-turn-status-shimmer": "ToU8hG_dsh-turn-status-shimmer",
			"flowItem": "ToU8hG_flowItem",
			"hint": "ToU8hG_hint",
			"modalAction": "ToU8hG_modalAction",
			"older": "ToU8hG_older",
			"openError": "ToU8hG_openError",
			"root": "ToU8hG_root",
			"scroll": "ToU8hG_scroll",
			"toBottom": "ToU8hG_toBottom",
			"toBottomSlot": "ToU8hG_toBottomSlot",
			"turnStatus": "ToU8hG_turnStatus",
			"turnStatusClock": "ToU8hG_turnStatusClock"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\TurnNavigator.module.css.mjs
		const css$10 = "._8Osf5a_slot{z-index:7;pointer-events:none;height:0;position:sticky;top:0}._8Osf5a_frame{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:100px;top:calc(var(--turn-rail-band) / 2);right:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}._8Osf5a_scroller{overscroll-behavior:contain;scrollbar-width:none;position:absolute;inset:0;overflow-y:auto}._8Osf5a_scroller::-webkit-scrollbar{display:none}._8Osf5a_fadeTop{mask-image:linear-gradient(#0000 0,#000 24px 100%)}._8Osf5a_fadeBottom{mask-image:linear-gradient(#000 0 calc(100% - 24px),#0000 100%)}._8Osf5a_fadeTop._8Osf5a_fadeBottom{mask-image:linear-gradient(#0000 0,#000 24px calc(100% - 24px),#0000 100%)}._8Osf5a_marks{height:var(--turn-natural-height);position:relative}._8Osf5a_markPosition{top:calc(var(--turn-natural-position) + var(--turn-rail-inset));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out _8Osf5a_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}._8Osf5a_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 0 0 auto}._8Osf5a_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;right:0;transform:translateY(-50%)}._8Osf5a_markUnloaded:before{opacity:.6;width:8px}._8Osf5a_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}._8Osf5a_markBusy:before{animation:1s ease-in-out infinite _8Osf5a_dsh-turn-mark-busy}._8Osf5a_markActive:before{background:var(--dsw-alias-label-primary);width:20px}._8Osf5a_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}._8Osf5a_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._8Osf5a_preview{top:clamp(0px, calc(var(--turn-natural-position) + var(--turn-rail-inset) - var(--turn-scroll-top,0px) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-elevation-panel);pointer-events:none;border:0;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out _8Osf5a_dsh-turn-preview-enter;position:absolute;right:calc(100% + 10px);overflow:hidden}._8Osf5a_previewPrompt,._8Osf5a_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._8Osf5a_previewPrompt{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:1}._8Osf5a_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:3;margin-top:4px}@keyframes _8Osf5a_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes _8Osf5a_dsh-turn-preview-enter{0%{opacity:0;transform:translate(4px)}to{opacity:1;transform:translate(0)}}@keyframes _8Osf5a_dsh-turn-mark-busy{0%,to{opacity:1}50%{opacity:.35}}@container (width<=900px){._8Osf5a_slot{display:none}}@media (prefers-reduced-motion:reduce){._8Osf5a_frame,._8Osf5a_scroller,._8Osf5a_markPosition,._8Osf5a_mark:before,._8Osf5a_markBusy:before,._8Osf5a_preview{scroll-behavior:auto;transition:none;animation:none}}";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-busy": "_8Osf5a_dsh-turn-mark-busy",
			"dsh-turn-mark-enter": "_8Osf5a_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "_8Osf5a_dsh-turn-preview-enter",
			"fadeBottom": "_8Osf5a_fadeBottom",
			"fadeTop": "_8Osf5a_fadeTop",
			"frame": "_8Osf5a_frame",
			"mark": "_8Osf5a_mark",
			"markActive": "_8Osf5a_markActive",
			"markBusy": "_8Osf5a_markBusy",
			"markPosition": "_8Osf5a_markPosition",
			"markPreview": "_8Osf5a_markPreview",
			"markUnloaded": "_8Osf5a_markUnloaded",
			"marks": "_8Osf5a_marks",
			"preview": "_8Osf5a_preview",
			"previewPrompt": "_8Osf5a_previewPrompt",
			"previewResponse": "_8Osf5a_previewResponse",
			"scroller": "_8Osf5a_scroller",
			"slot": "_8Osf5a_slot"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\accessibility.module.css.mjs
		const css$9 = ".-PqdAW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var accessibility_module_css_default = { "visuallyHidden": "-PqdAW_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\ReasoningRow.module.css.mjs
		const css$8 = "._81ohtq_root{flex-direction:column;display:flex}._81ohtq_root:not([data-expanded]){contain:size layout;height:calc(24px + var(--dsh-content-font-delta,0px))}._81ohtq_row{position:relative;overflow:hidden}._81ohtq_root[data-state=running] ._81ohtq_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _81ohtq_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes _81ohtq_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}._81ohtq_leading{flex-shrink:0}._81ohtq_chevron{color:var(--dsw-alias-label-secondary)}._81ohtq_title{font-weight:400}._81ohtq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._81ohtq_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:nowrap;flex:auto;overflow:hidden}._81ohtq_summaryText{text-overflow:ellipsis;display:block;overflow:hidden}._81ohtq_summary[data-follow-end]{justify-content:flex-end;display:flex}._81ohtq_summary[data-follow-end] ._81ohtq_summaryText{text-align:start;text-overflow:clip;flex:none;width:max-content;min-width:100%;overflow:visible}._81ohtq_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:pre-wrap;word-break:break-word}@media (prefers-reduced-motion:reduce){._81ohtq_root[data-state=running] ._81ohtq_row:after{animation:none}}";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "_81ohtq_chevron",
			"dsh-reasoning-row-sweep": "_81ohtq_dsh-reasoning-row-sweep",
			"leading": "_81ohtq_leading",
			"root": "_81ohtq_root",
			"row": "_81ohtq_row",
			"separator": "_81ohtq_separator",
			"summary": "_81ohtq_summary",
			"summaryText": "_81ohtq_summaryText",
			"thinkBody": "_81ohtq_thinkBody",
			"title": "_81ohtq_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\AssistantMarkdown.module.css.mjs
		const css$7 = ".dXq2Va_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.dXq2Va_body{flex-direction:column;gap:16px;display:flex}.dXq2Va_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.dXq2Va_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.dXq2Va_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.dXq2Va_actions{margin-top:16px;margin-left:-6px}";
		...
		var AssistantMarkdown_module_css_default = {
			"actions": "dXq2Va_actions",
			"body": "dXq2Va_body",
			"root": "dXq2Va_root",
			"stopped": "dXq2Va_stopped"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\GenericCommandCard.module.css.mjs
		const css$6 = ".OQb0Za_root{flex-direction:column;display:flex}.OQb0Za_row{position:relative;overflow:hidden}.OQb0Za_root[data-state=running] .OQb0Za_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite OQb0Za_dsh-command-row-sweep;position:absolute;left:0}@keyframes OQb0Za_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}.OQb0Za_leading{flex-shrink:0}.OQb0Za_chevron{color:var(--dsw-alias-label-secondary)}.OQb0Za_title{font-weight:400}.OQb0Za_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.OQb0Za_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.OQb0Za_summary[data-error],.OQb0Za_body[data-error]{color:var(--dsw-alias-state-error-primary)}.OQb0Za_body{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){.OQb0Za_root[data-state=running] .OQb0Za_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"body": "OQb0Za_body",
			"chevron": "OQb0Za_chevron",
			"dsh-command-row-sweep": "OQb0Za_dsh-command-row-sweep",
			"leading": "OQb0Za_leading",
			"root": "OQb0Za_root",
			"row": "OQb0Za_row",
			"separator": "OQb0Za_separator",
			"summary": "OQb0Za_summary",
			"title": "OQb0Za_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\TurnProcessNodeView.module.css.mjs
		const css$5 = ".ynIxaa_root{box-sizing:border-box;border:none;border-bottom:.5px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}.ynIxaa_root:not([data-open]){margin-bottom:8px}.ynIxaa_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}.ynIxaa_root[data-open] .ynIxaa_chevron{transform:rotate(0)}.ynIxaa_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){.ynIxaa_chevron{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\TurnUsagePanel.module.css.mjs
		const css$4 = ".AwMVAq_root{min-width:0;display:inline-flex}.AwMVAq_root+.AwMVAq_root{margin-left:-6px}.AwMVAq_trigger{min-width:0;height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:28px;align-items:center;gap:4px;padding:6px 8px;display:inline-flex}.AwMVAq_label{text-overflow:ellipsis;min-width:0;overflow:hidden}.AwMVAq_trigger svg{width:calc(15px + var(--dsh-content-font-delta,0px));height:calc(15px + var(--dsh-content-font-delta,0px));flex:none}.AwMVAq_trigger:hover,.AwMVAq_trigger[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}@media (width<=480px){.AwMVAq_trigger{width:calc(28px + var(--dsh-content-font-delta,0px));justify-content:center;padding:6px}.AwMVAq_trigger .AwMVAq_label{display:none}.AwMVAq_root+.AwMVAq_root{margin-left:0}}.AwMVAq_panel{z-index:1100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(300px,100vw - 24px);max-width:min(440px,100vw - 24px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-secondary);cursor:default;border:0;border-radius:12px;padding:16px;font-size:12px;line-height:18px;position:fixed}.AwMVAq_title{color:var(--dsw-alias-label-primary);justify-content:space-between;gap:16px;margin-bottom:8px;font-weight:500;display:flex}.AwMVAq_titleRule{border-top:.5px solid var(--dsw-alias-border-l2);margin-bottom:10px}.AwMVAq_titleValue{font-variant-numeric:tabular-nums}.AwMVAq_titleLabel{align-items:center;gap:6px;min-width:0;display:inline-flex}.AwMVAq_titleLabel svg{flex:none;width:14px;height:14px}.AwMVAq_details{color:var(--dsw-alias-label-tertiary);grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;margin:0;display:grid}.AwMVAq_details dt,.AwMVAq_details dd{min-width:0;margin:0}.AwMVAq_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}.AwMVAq_details .AwMVAq_route{overflow-wrap:anywhere}.AwMVAq_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}";
		...
		var TurnUsagePanel_module_css_default = {
			"details": "AwMVAq_details",
			"label": "AwMVAq_label",
			"panel": "AwMVAq_panel",
			"reasoning": "AwMVAq_reasoning",
			"root": "AwMVAq_root",
			"route": "AwMVAq_route",
			"title": "AwMVAq_title",
			"titleLabel": "AwMVAq_titleLabel",
			"titleRule": "AwMVAq_titleRule",
			"titleValue": "AwMVAq_titleValue",
			"trigger": "AwMVAq_trigger"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\chat\TurnTailNodeView.module.css.mjs
		const css$3 = ".ut8kha_root{flex-direction:column;gap:16px;display:flex}.ut8kha_actions{margin-left:-6px}";
		...
		*/
		...
		const StatsLine = (0, react.memo)(function StatsLine({ useChat, useProjection, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StatsLineContent, {
				groups,
				line
			});
		});
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\details\DetailsPanel.module.css.mjs
		const css$1 = ".FMEAZq_root{border-left:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex-direction:column;min-width:0;height:100%;display:flex}.FMEAZq_header{border-bottom:.5px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:8px;padding:14px 12px 12px;display:flex}.FMEAZq_title{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.FMEAZq_close{corner-shape:round;width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;display:grid}.FMEAZq_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.FMEAZq_body{flex:1;min-height:0;padding:12px 16px;overflow-y:auto}.FMEAZq_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}.FMEAZq_section{margin-bottom:16px}.FMEAZq_sectionLabel{color:var(--dsw-alias-label-secondary);margin-bottom:6px;font-size:12px;font-weight:500;line-height:18px}.FMEAZq_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.FMEAZq_code[data-error]{color:var(--dsw-alias-state-error-primary)}";
		...
		var DetailsPanel_module_css_default = {
			...
			"code": "FMEAZq_code",
			"empty": "FMEAZq_empty",
			"header": "FMEAZq_header",
			"root": "FMEAZq_root",
			"section": "FMEAZq_section",
			"sectionLabel": "FMEAZq_sectionLabel",
			"title": "FMEAZq_title"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-chat\src\client\settings\TranscriptViewRow.module.css.mjs
		const css = ".-U6o3q_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.-U6o3q_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.-U6o3q_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.-U6o3q_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.-U6o3q_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.-U6o3q_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.-U6o3q_chevron{flex:none}";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "-U6o3q_chevron",
			"desc": "-U6o3q_desc",
			"row": "-U6o3q_row",
			"rowText": "-U6o3q_rowText",
			"selector": "-U6o3q_selector",
			"title": "-U6o3q_title"
		};
		//#endregion
