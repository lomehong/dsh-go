window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\client\AppearanceRow.module.css.mjs
		const css$1 = ".txXgaW_group{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.txXgaW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.txXgaW_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.txXgaW_themeCube{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.txXgaW_themeCube:hover:not(.txXgaW_selected){background:var(--dsw-alias-interactive-bg-hover)}.txXgaW_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "txXgaW_cubeRow",
			"group": "txXgaW_group",
			"selected": "txXgaW_selected",
			"themeCube": "txXgaW_themeCube",
			"title": "txXgaW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\client\FontSizeRow.module.css.mjs
		const css = ".LaPe1q_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.LaPe1q_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.LaPe1q_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.LaPe1q_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.LaPe1q_control{align-items:center;gap:8px;display:inline-flex}.LaPe1q_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}.LaPe1q_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.LaPe1q_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.LaPe1q_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}.LaPe1q_stepper:hover .LaPe1q_arrows,.LaPe1q_stepper:focus-within .LaPe1q_arrows{opacity:1}.LaPe1q_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}.LaPe1q_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.LaPe1q_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "LaPe1q_arrow",
			"arrows": "LaPe1q_arrows",
			"control": "LaPe1q_control",
			"desc": "LaPe1q_desc",
			"row": "LaPe1q_row",
			"rowText": "LaPe1q_rowText",
			"stepper": "LaPe1q_stepper",
			"title": "LaPe1q_title",
			"unit": "LaPe1q_unit",
			"value": "LaPe1q_value"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\styles\base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\styles\corner-shape.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\styles\design-platform.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\styles\scrollbar.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\styles\gradient-shadow-text.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-theme\src\styles\shiki.css.mjs
