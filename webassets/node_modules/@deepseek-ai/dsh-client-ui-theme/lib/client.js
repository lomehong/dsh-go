window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".rzCgKW_group{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.rzCgKW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.rzCgKW_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.rzCgKW_themeCube{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.rzCgKW_themeCube:hover:not(.rzCgKW_selected){background:var(--dsw-alias-interactive-bg-hover)}.rzCgKW_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "rzCgKW_cubeRow",
			"group": "rzCgKW_group",
			"selected": "rzCgKW_selected",
			"themeCube": "rzCgKW_themeCube",
			"title": "rzCgKW_title"
		};
		//#endregion
		...
		*/
		...
		const css = "._0kZ9wa_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._0kZ9wa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._0kZ9wa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._0kZ9wa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._0kZ9wa_control{align-items:center;gap:8px;display:inline-flex}._0kZ9wa_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}._0kZ9wa_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}._0kZ9wa_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}._0kZ9wa_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}._0kZ9wa_stepper:hover ._0kZ9wa_arrows,._0kZ9wa_stepper:focus-within ._0kZ9wa_arrows{opacity:1}._0kZ9wa_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}._0kZ9wa_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}._0kZ9wa_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "_0kZ9wa_arrow",
			"arrows": "_0kZ9wa_arrows",
			"control": "_0kZ9wa_control",
			"desc": "_0kZ9wa_desc",
			"row": "_0kZ9wa_row",
			"rowText": "_0kZ9wa_rowText",
			"stepper": "_0kZ9wa_stepper",
			"title": "_0kZ9wa_title",
			"unit": "_0kZ9wa_unit",
			"value": "_0kZ9wa_value"
		};
