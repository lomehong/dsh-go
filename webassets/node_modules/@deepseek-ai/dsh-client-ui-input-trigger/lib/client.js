window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-input-trigger\src\client\MenuView.module.css.mjs
		const css = ".xh7kYG_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.xh7kYG_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.xh7kYG_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.xh7kYG_item.xh7kYG_active{background:var(--dsw-alias-interactive-bg-hover)}.xh7kYG_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.xh7kYG_sectionTitle:not(:first-child){margin-top:4px}.xh7kYG_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.xh7kYG_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.xh7kYG_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.xh7kYG_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.xh7kYG_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.xh7kYG_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.xh7kYG_item.xh7kYG_active .xh7kYG_drillHintText,.xh7kYG_item.xh7kYG_active .xh7kYG_drillHint{display:inline-flex}.xh7kYG_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.xh7kYG_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xh7kYG_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.xh7kYG_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.xh7kYG_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite xh7kYG_dsh-menu-skeleton}@keyframes xh7kYG_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.xh7kYG_crumbs{border-bottom:.5px solid var(--dsw-alias-border-l1);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 4px 6px;display:flex}.xh7kYG_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.xh7kYG_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xh7kYG_crumbCurrent,.xh7kYG_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.xh7kYG_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		...
		var MenuView_module_css_default = {
			"active": "xh7kYG_active",
			"crumb": "xh7kYG_crumb",
			"crumbCurrent": "xh7kYG_crumbCurrent",
			"crumbSeparator": "xh7kYG_crumbSeparator",
			"crumbs": "xh7kYG_crumbs",
			"drill": "xh7kYG_drill",
			"drillHint": "xh7kYG_drillHint",
			"drillHintText": "xh7kYG_drillHintText",
			"dsh-menu-skeleton": "xh7kYG_dsh-menu-skeleton",
			"groupTitle": "xh7kYG_groupTitle",
			"item": "xh7kYG_item",
			"itemDescription": "xh7kYG_itemDescription",
			"itemIcon": "xh7kYG_itemIcon",
			"itemName": "xh7kYG_itemName",
			"menu": "xh7kYG_menu",
			"sectionTitle": "xh7kYG_sectionTitle",
			"skeletonBar": "xh7kYG_skeletonBar",
			"skeletonRow": "xh7kYG_skeletonRow",
			"trailing": "xh7kYG_trailing",
			"viewport": "xh7kYG_viewport"
		};
		//#endregion
