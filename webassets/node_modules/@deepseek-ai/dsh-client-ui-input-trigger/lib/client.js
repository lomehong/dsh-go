window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".coY4mW_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.coY4mW_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.coY4mW_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.coY4mW_item.coY4mW_active{background:var(--dsw-alias-interactive-bg-hover)}.coY4mW_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.coY4mW_sectionTitle:not(:first-child){margin-top:4px}.coY4mW_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.coY4mW_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.coY4mW_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.coY4mW_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.coY4mW_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.coY4mW_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.coY4mW_item.coY4mW_active .coY4mW_drillHintText,.coY4mW_item.coY4mW_active .coY4mW_drillHint{display:inline-flex}.coY4mW_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.coY4mW_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.coY4mW_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.coY4mW_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.coY4mW_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite coY4mW_dsh-menu-skeleton}@keyframes coY4mW_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.coY4mW_crumbs{border-bottom:.5px solid var(--dsw-alias-border-l1);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 4px 6px;display:flex}.coY4mW_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.coY4mW_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.coY4mW_crumbCurrent,.coY4mW_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.coY4mW_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		...
		var MenuView_module_css_default = {
			"active": "coY4mW_active",
			"crumb": "coY4mW_crumb",
			"crumbCurrent": "coY4mW_crumbCurrent",
			"crumbSeparator": "coY4mW_crumbSeparator",
			"crumbs": "coY4mW_crumbs",
			"drill": "coY4mW_drill",
			"drillHint": "coY4mW_drillHint",
			"drillHintText": "coY4mW_drillHintText",
			"dsh-menu-skeleton": "coY4mW_dsh-menu-skeleton",
			"groupTitle": "coY4mW_groupTitle",
			"item": "coY4mW_item",
			"itemDescription": "coY4mW_itemDescription",
			"itemIcon": "coY4mW_itemIcon",
			"itemName": "coY4mW_itemName",
			"menu": "coY4mW_menu",
			"sectionTitle": "coY4mW_sectionTitle",
			"skeletonBar": "coY4mW_skeletonBar",
			"skeletonRow": "coY4mW_skeletonRow",
			"trailing": "coY4mW_trailing",
			"viewport": "coY4mW_viewport"
		};
		//#endregion
