window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".HvviKq_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.HvviKq_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.HvviKq_frame{transition:none}}.HvviKq_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.HvviKq_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.HvviKq_detailsCol{border-left:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.HvviKq_frame[data-details-collapsed] .HvviKq_detailsCol{border-left:none}.HvviKq_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.HvviKq_frame[data-dragging] .HvviKq_handle{transition:none}@media (prefers-reduced-motion:reduce){.HvviKq_handle{transition:none}}.HvviKq_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.HvviKq_detailsCol:hover~.HvviKq_handle[data-side=details]:after,.HvviKq_handle[data-side=details]:hover:after,.HvviKq_handle[data-side=details][data-dragging=true]:after{opacity:1}.HvviKq_handle[data-side=details]:hover:after,.HvviKq_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.HvviKq_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.HvviKq_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "HvviKq_centerCol",
			"detailsCol": "HvviKq_detailsCol",
			"frame": "HvviKq_frame",
			"handle": "HvviKq_handle",
			"overlayLayer": "HvviKq_overlayLayer",
			"sidebarCol": "HvviKq_sidebarCol"
		};
		//#endregion
