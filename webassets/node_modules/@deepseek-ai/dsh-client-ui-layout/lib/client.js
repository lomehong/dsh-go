window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-layout\src\client\AppFrame.module.css.mjs
		const css = ".F82NMa_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.F82NMa_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.F82NMa_frame{transition:none}}.F82NMa_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.F82NMa_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.F82NMa_detailsCol{border-left:.5px solid var(--dsw-alias-border-l3);min-width:0;overflow:hidden}.F82NMa_frame[data-details-collapsed] .F82NMa_detailsCol{border-left:none}.F82NMa_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.F82NMa_frame[data-dragging] .F82NMa_handle{transition:none}@media (prefers-reduced-motion:reduce){.F82NMa_handle{transition:none}}.F82NMa_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:.5px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.F82NMa_detailsCol:hover~.F82NMa_handle[data-side=details]:after,.F82NMa_handle[data-side=details]:hover:after,.F82NMa_handle[data-side=details][data-dragging=true]:after{opacity:1}.F82NMa_handle[data-side=details]:hover:after,.F82NMa_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.F82NMa_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.F82NMa_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "F82NMa_centerCol",
			"detailsCol": "F82NMa_detailsCol",
			"frame": "F82NMa_frame",
			"handle": "F82NMa_handle",
			"overlayLayer": "F82NMa_overlayLayer",
			"sidebarCol": "F82NMa_sidebarCol"
		};
		//#endregion
		...
		function AppFrame({ useStore, useSessions, actions, renderSlot, SessionProvider, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CenterColumn, { children: renderSlot("conversation", {}) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DetailsColumn, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionProvider, { children: renderSlot("details", {}) }) })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
