window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".IG7hQq_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.IG7hQq_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.IG7hQq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.IG7hQq_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.IG7hQq_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.IG7hQq_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "IG7hQq_chevron",
			"row": "IG7hQq_row",
			"rowText": "IG7hQq_rowText",
			"selector": "IG7hQq_selector",
			"title": "IG7hQq_title"
		};
		//#endregion
