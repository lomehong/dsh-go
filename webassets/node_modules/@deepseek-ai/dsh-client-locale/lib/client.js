window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\locale\src\client\LanguageRow.module.css.mjs
		const css = ".oMmiTq_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.oMmiTq_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.oMmiTq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.oMmiTq_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.oMmiTq_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.oMmiTq_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "oMmiTq_chevron",
			"row": "oMmiTq_row",
			"rowText": "oMmiTq_rowText",
			"selector": "oMmiTq_selector",
			"title": "oMmiTq_title"
		};
		//#endregion
