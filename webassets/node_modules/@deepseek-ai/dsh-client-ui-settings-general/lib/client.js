window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-settings-general\src\client\SettingsRoot.module.css.mjs
		const css$3 = "._9WT5Fa_triggerRow{flex:none;align-items:center;gap:8px;width:calc(100% + 4px);margin:4px -2px;display:flex}._9WT5Fa_triggerRow._9WT5Fa_railRow{width:36px;margin:8px 0 10px}._9WT5Fa_trigger{box-sizing:border-box;cursor:pointer;width:auto;min-width:0;height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:1;align-items:center;gap:8px;margin:0;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}._9WT5Fa_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._9WT5Fa_trigger._9WT5Fa_rail{corner-shape:round;border-radius:50%;flex:none;justify-content:center;gap:0;width:36px;height:36px;margin:0;padding:0}._9WT5Fa_triggerLabel{white-space:nowrap;overflow:hidden}._9WT5Fa_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._9WT5Fa_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}._9WT5Fa_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:32px;display:flex;position:relative;overflow:hidden}._9WT5Fa_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}._9WT5Fa_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}._9WT5Fa_navList{flex-direction:column;gap:4px;display:flex}._9WT5Fa_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}._9WT5Fa_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}._9WT5Fa_navCell._9WT5Fa_active{background:var(--dsw-specific-sidebar-nav-item-active)}._9WT5Fa_navIcon{flex:none}._9WT5Fa_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._9WT5Fa_content{flex-direction:column;flex:1;min-width:0;display:flex}._9WT5Fa_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}._9WT5Fa_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}._9WT5Fa_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}._9WT5Fa_close:hover{background:var(--dsw-alias-interactive-bg-hover)}._9WT5Fa_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}._9WT5Fa_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"actions": "_9WT5Fa_actions",
			"active": "_9WT5Fa_active",
			"close": "_9WT5Fa_close",
			"content": "_9WT5Fa_content",
			"header": "_9WT5Fa_header",
			"hiddenLabel": "_9WT5Fa_hiddenLabel",
			"mask": "_9WT5Fa_mask",
			"nav": "_9WT5Fa_nav",
			"navCell": "_9WT5Fa_navCell",
			"navIcon": "_9WT5Fa_navIcon",
			"navLabel": "_9WT5Fa_navLabel",
			"navList": "_9WT5Fa_navList",
			"navTitle": "_9WT5Fa_navTitle",
			"options": "_9WT5Fa_options",
			"overlay": "_9WT5Fa_overlay",
			"panel": "_9WT5Fa_panel",
			"rail": "_9WT5Fa_rail",
			"railRow": "_9WT5Fa_railRow",
			"trigger": "_9WT5Fa_trigger",
			"triggerLabel": "_9WT5Fa_triggerLabel",
			"triggerRow": "_9WT5Fa_triggerRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-settings-general\src\client\chrome.module.css.mjs
		const css$2 = ".dst2aG_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "dst2aG_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-settings-general\src\client\GeneralSection.module.css.mjs
		const css$1 = ".aVp-ca_section{flex-direction:column;width:100%;display:flex}.aVp-ca_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "aVp-ca_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-settings-general\src\client\SettingsDocumentAction.module.css.mjs
		const css = ".X7WaZa_action{align-items:center;gap:8px;min-width:0;display:flex}.X7WaZa_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
