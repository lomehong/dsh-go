window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$3 = ".cxOG4W_triggerRow{flex:none;align-items:center;gap:8px;width:calc(100% + 4px);margin:4px -2px;display:flex}.cxOG4W_triggerRow.cxOG4W_railRow{width:36px;margin:8px 0 10px}.cxOG4W_trigger{box-sizing:border-box;cursor:pointer;width:auto;min-width:0;height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:1;align-items:center;gap:8px;margin:0;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.cxOG4W_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.cxOG4W_trigger.cxOG4W_rail{corner-shape:round;border-radius:50%;flex:none;justify-content:center;gap:0;width:36px;height:36px;margin:0;padding:0}.cxOG4W_triggerLabel{white-space:nowrap;overflow:hidden}.cxOG4W_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.cxOG4W_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.cxOG4W_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:32px;display:flex;position:relative;overflow:hidden}.cxOG4W_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.cxOG4W_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.cxOG4W_navList{flex-direction:column;gap:4px;display:flex}.cxOG4W_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.cxOG4W_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.cxOG4W_navCell.cxOG4W_active{background:var(--dsw-specific-sidebar-nav-item-active)}.cxOG4W_navIcon{flex:none}.cxOG4W_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.cxOG4W_content{flex-direction:column;flex:1;min-width:0;display:flex}.cxOG4W_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.cxOG4W_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.cxOG4W_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.cxOG4W_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.cxOG4W_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.cxOG4W_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"actions": "cxOG4W_actions",
			"active": "cxOG4W_active",
			"close": "cxOG4W_close",
			"content": "cxOG4W_content",
			"header": "cxOG4W_header",
			"hiddenLabel": "cxOG4W_hiddenLabel",
			"mask": "cxOG4W_mask",
			"nav": "cxOG4W_nav",
			"navCell": "cxOG4W_navCell",
			"navIcon": "cxOG4W_navIcon",
			"navLabel": "cxOG4W_navLabel",
			"navList": "cxOG4W_navList",
			"navTitle": "cxOG4W_navTitle",
			"options": "cxOG4W_options",
			"overlay": "cxOG4W_overlay",
			"panel": "cxOG4W_panel",
			"rail": "cxOG4W_rail",
			"railRow": "cxOG4W_railRow",
			"trigger": "cxOG4W_trigger",
			"triggerLabel": "cxOG4W_triggerLabel",
			"triggerRow": "cxOG4W_triggerRow"
		};
		//#endregion
		...
		*/
		...
		const css$2 = ".AKIzGG_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "AKIzGG_triggerLabel" };
		//#endregion
		...
		*/
		...
		const css$1 = ".DI1Mhq_section{flex-direction:column;width:100%;display:flex}.DI1Mhq_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "DI1Mhq_section" };
		//#endregion
		...
		*/
		...
		const css = ".dhZmtG_action{align-items:center;gap:8px;min-width:0;display:flex}.dhZmtG_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
