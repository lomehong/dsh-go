window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-user-questions\src\client\PlanReviewPanel.module.css.mjs
		const css$1 = ".f7iJia_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.f7iJia_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.f7iJia_card,.f7iJia_card *{box-sizing:border-box}.f7iJia_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.f7iJia_dot{corner-shape:round;background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.f7iJia_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.f7iJia_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.f7iJia_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.f7iJia_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.f7iJia_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.f7iJia_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.f7iJia_card{border-radius:16px}.f7iJia_body{padding:10px 12px 4px}.f7iJia_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "f7iJia_actions",
			"body": "f7iJia_body",
			"card": "f7iJia_card",
			"discuss": "f7iJia_discuss",
			"dot": "f7iJia_dot",
			"feedback": "f7iJia_feedback",
			"footer": "f7iJia_footer",
			"frame": "f7iJia_frame",
			"strip": "f7iJia_strip"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-user-questions\src\client\QuestionComposer.module.css.mjs
		const css = ".EtCaVW_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.EtCaVW_card{width:100%;max-width:var(--dsh-chat-content-width);--dsw-elevation-stroke-color:var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.EtCaVW_card,.EtCaVW_card *{box-sizing:border-box}.EtCaVW_cardMinimized{max-height:none}.EtCaVW_cardMinimized .EtCaVW_header{padding-bottom:14px}.EtCaVW_headerActions{flex-shrink:0;align-items:center;gap:4px;display:flex}.EtCaVW_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.EtCaVW_headingBlock{min-width:0}.EtCaVW_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.EtCaVW_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.EtCaVW_detail{margin:0 2px 8px}.EtCaVW_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.EtCaVW_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.EtCaVW_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.EtCaVW_iconButton{corner-shape:round;width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.EtCaVW_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.EtCaVW_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.EtCaVW_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.EtCaVW_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.EtCaVW_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.EtCaVW_option:hover:not(:disabled),.EtCaVW_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.EtCaVW_optionSelected{border-color:var(--dsw-alias-border-l2)}.EtCaVW_option:disabled{cursor:default}.EtCaVW_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.EtCaVW_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.EtCaVW_checkbox:before{content:\"\";border:.5px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.EtCaVW_checkbox>svg{grid-area:1/1}.EtCaVW_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.EtCaVW_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.EtCaVW_optionCopy{flex:1;min-width:0}.EtCaVW_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.EtCaVW_optionLabel{font-size:14px;font-weight:500;line-height:24px}.EtCaVW_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.EtCaVW_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.EtCaVW_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.EtCaVW_customRow:hover,.EtCaVW_customRow:focus-within,.EtCaVW_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.EtCaVW_customRow:focus-within,.EtCaVW_customRowActive{border-color:var(--dsw-alias-border-l2)}.EtCaVW_field{--dsh-answer-field-padding:0;min-width:0;display:grid}.EtCaVW_field>*{min-width:0;padding:var(--dsh-answer-field-padding);font:inherit;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;grid-area:1/1;font-size:14px;line-height:24px}.EtCaVW_fieldMirror{box-sizing:content-box;visibility:hidden;max-height:144px;overflow:hidden}.EtCaVW_fieldInput{resize:none;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);background:0 0;border:none;outline:none;overflow-y:auto}.EtCaVW_fieldInput::placeholder{color:var(--dsw-alias-label-caption)}.EtCaVW_customInline{flex:1}.EtCaVW_customBlock{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-module-platform);--dsh-answer-field-padding:8px 12px;border-radius:10px;flex-shrink:0;min-height:64px;margin:0 12px}.EtCaVW_customBlock:focus-within{border-color:var(--dsw-alias-state-business-primary)}.EtCaVW_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.EtCaVW_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.EtCaVW_card{border-radius:16px}.EtCaVW_header{padding:10px 12px 0 18px}.EtCaVW_options{padding:4px 8px}.EtCaVW_title{font-size:15px;line-height:21px}.EtCaVW_option,.EtCaVW_customRow{padding:8px 6px}.EtCaVW_footer{align-items:flex-end;padding:0 10px}.EtCaVW_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.EtCaVW_option,.EtCaVW_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			...
			"body": "EtCaVW_body",
			"card": "EtCaVW_card",
			"cardMinimized": "EtCaVW_cardMinimized",
			"checkbox": "EtCaVW_checkbox",
			"checkboxChecked": "EtCaVW_checkboxChecked",
			"customBlock": "EtCaVW_customBlock",
			"customInline": "EtCaVW_customInline",
			"customRow": "EtCaVW_customRow",
			"customRowActive": "EtCaVW_customRowActive",
			"description": "EtCaVW_description",
			"detail": "EtCaVW_detail",
			"eyebrow": "EtCaVW_eyebrow",
			"feedback": "EtCaVW_feedback",
			"field": "EtCaVW_field",
			"fieldInput": "EtCaVW_fieldInput",
			"fieldMirror": "EtCaVW_fieldMirror",
			"footer": "EtCaVW_footer",
			"footerActions": "EtCaVW_footerActions",
			"frame": "EtCaVW_frame",
			"header": "EtCaVW_header",
			"headerActions": "EtCaVW_headerActions",
			"headingBlock": "EtCaVW_headingBlock",
			"iconButton": "EtCaVW_iconButton",
			"number": "EtCaVW_number",
			"option": "EtCaVW_option",
			"optionCopy": "EtCaVW_optionCopy",
			"optionLabel": "EtCaVW_optionLabel",
			"optionLine": "EtCaVW_optionLine",
			"optionSelected": "EtCaVW_optionSelected",
			"options": "EtCaVW_options",
			"pager": "EtCaVW_pager",
			"progress": "EtCaVW_progress",
			"title": "EtCaVW_title"
		};
		//#endregion
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: minimized ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronUpOutline14, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, {})
