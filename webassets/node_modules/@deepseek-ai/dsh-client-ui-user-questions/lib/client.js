window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = ".DJcoxG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.DJcoxG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.DJcoxG_card,.DJcoxG_card *{box-sizing:border-box}.DJcoxG_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.DJcoxG_dot{corner-shape:round;background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.DJcoxG_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.DJcoxG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.DJcoxG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.DJcoxG_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.DJcoxG_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.DJcoxG_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.DJcoxG_card{border-radius:16px}.DJcoxG_body{padding:10px 12px 4px}.DJcoxG_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "DJcoxG_actions",
			"body": "DJcoxG_body",
			"card": "DJcoxG_card",
			"discuss": "DJcoxG_discuss",
			"dot": "DJcoxG_dot",
			"feedback": "DJcoxG_feedback",
			"footer": "DJcoxG_footer",
			"frame": "DJcoxG_frame",
			"strip": "DJcoxG_strip"
		};
		//#endregion
		...
		*/
		...
		const css = ".J23HWq_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.J23HWq_card{width:100%;max-width:var(--dsh-chat-content-width);--dsw-elevation-stroke-color:var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:0;border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.J23HWq_card,.J23HWq_card *{box-sizing:border-box}.J23HWq_cardMinimized{max-height:none}.J23HWq_cardMinimized .J23HWq_header{padding-bottom:14px}.J23HWq_headerActions{flex-shrink:0;align-items:center;gap:4px;display:flex}.J23HWq_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.J23HWq_headingBlock{min-width:0}.J23HWq_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.J23HWq_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.J23HWq_detail{margin:0 2px 8px}.J23HWq_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.J23HWq_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.J23HWq_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.J23HWq_iconButton{corner-shape:round;width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.J23HWq_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.J23HWq_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.J23HWq_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.J23HWq_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.J23HWq_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.J23HWq_option:hover:not(:disabled),.J23HWq_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.J23HWq_optionSelected{border-color:var(--dsw-alias-border-l2)}.J23HWq_option:disabled{cursor:default}.J23HWq_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.J23HWq_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.J23HWq_checkbox:before{content:\"\";border:.5px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.J23HWq_checkbox>svg{grid-area:1/1}.J23HWq_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.J23HWq_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.J23HWq_optionCopy{flex:1;min-width:0}.J23HWq_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.J23HWq_optionLabel{font-size:14px;font-weight:500;line-height:24px}.J23HWq_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.J23HWq_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.J23HWq_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.J23HWq_customRow:hover,.J23HWq_customRow:focus-within,.J23HWq_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.J23HWq_customRow:focus-within,.J23HWq_customRowActive{border-color:var(--dsw-alias-border-l2)}.J23HWq_field{--dsh-answer-field-padding:0;min-width:0;display:grid}.J23HWq_field>*{min-width:0;padding:var(--dsh-answer-field-padding);font:inherit;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;grid-area:1/1;font-size:14px;line-height:24px}.J23HWq_fieldMirror{box-sizing:content-box;visibility:hidden;max-height:144px;overflow:hidden}.J23HWq_fieldInput{resize:none;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);background:0 0;border:none;outline:none;overflow-y:auto}.J23HWq_fieldInput::placeholder{color:var(--dsw-alias-label-caption)}.J23HWq_customInline{flex:1}.J23HWq_customBlock{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-module-platform);--dsh-answer-field-padding:8px 12px;border-radius:10px;flex-shrink:0;min-height:64px;margin:0 12px}.J23HWq_customBlock:focus-within{border-color:var(--dsw-alias-state-business-primary)}.J23HWq_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.J23HWq_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.J23HWq_card{border-radius:16px}.J23HWq_header{padding:10px 12px 0 18px}.J23HWq_options{padding:4px 8px}.J23HWq_title{font-size:15px;line-height:21px}.J23HWq_option,.J23HWq_customRow{padding:8px 6px}.J23HWq_footer{align-items:flex-end;padding:0 10px}.J23HWq_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.J23HWq_option,.J23HWq_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			...
			"body": "J23HWq_body",
			"card": "J23HWq_card",
			"cardMinimized": "J23HWq_cardMinimized",
			"checkbox": "J23HWq_checkbox",
			"checkboxChecked": "J23HWq_checkboxChecked",
			"customBlock": "J23HWq_customBlock",
			"customInline": "J23HWq_customInline",
			"customRow": "J23HWq_customRow",
			"customRowActive": "J23HWq_customRowActive",
			"description": "J23HWq_description",
			"detail": "J23HWq_detail",
			"eyebrow": "J23HWq_eyebrow",
			"feedback": "J23HWq_feedback",
			"field": "J23HWq_field",
			"fieldInput": "J23HWq_fieldInput",
			"fieldMirror": "J23HWq_fieldMirror",
			"footer": "J23HWq_footer",
			"footerActions": "J23HWq_footerActions",
			"frame": "J23HWq_frame",
			"header": "J23HWq_header",
			"headerActions": "J23HWq_headerActions",
			"headingBlock": "J23HWq_headingBlock",
			"iconButton": "J23HWq_iconButton",
			"number": "J23HWq_number",
			"option": "J23HWq_option",
			"optionCopy": "J23HWq_optionCopy",
			"optionLabel": "J23HWq_optionLabel",
			"optionLine": "J23HWq_optionLine",
			"optionSelected": "J23HWq_optionSelected",
			"options": "J23HWq_options",
			"pager": "J23HWq_pager",
			"progress": "J23HWq_progress",
			"title": "J23HWq_title"
		};
		//#endregion
