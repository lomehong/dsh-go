window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-workflow-run\src\client\WorkflowRunPanel.module.css.mjs
		const css = "._6R06_W_root{width:100%;min-width:0}._6R06_W_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}._6R06_W_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._6R06_W_runLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._6R06_W_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);font-weight:510;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}._6R06_W_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._6R06_W_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}._6R06_W_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}._6R06_W_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}._6R06_W_phaseLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._6R06_W_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:0 auto;overflow:hidden}._6R06_W_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._6R06_W_phaseStatus{width:calc(132px + var(--dsh-content-font-delta-secondary,0px) * 10);color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}._6R06_W_separator{corner-shape:round;background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}._6R06_W_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}._6R06_W_phase{min-width:0}._6R06_W_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}._6R06_W_memberRow,._6R06_W_memberButton{width:100%;min-width:0;min-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}._6R06_W_memberButton{cursor:pointer}._6R06_W_memberButton ._6R06_W_memberLabel{color:var(--dsw-alias-link);font-weight:500;text-decoration:none}._6R06_W_memberButton:hover ._6R06_W_memberLabel,._6R06_W_memberButton:focus-visible ._6R06_W_memberLabel{text-underline-offset:3px;text-decoration:underline dotted}._6R06_W_dotSlot{width:16px;height:calc(24px + var(--dsh-content-font-delta,0px));flex:none;justify-content:center;align-items:center;display:inline-flex;overflow:hidden}._6R06_W_memberButton:focus-visible{outline:none}._6R06_W_memberButton:focus-visible ._6R06_W_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._6R06_W_memberLabelWrap{min-width:0;height:calc(24px + var(--dsh-content-font-delta,0px));border-radius:4px;flex:1;align-items:center;padding:0 2px;display:flex;overflow:hidden}._6R06_W_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._6R06_W_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}._6R06_W_empty{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));padding:0}@media (width<=560px){._6R06_W_phaseList,._6R06_W_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"dotSlot": "_6R06_W_dotSlot",
			"empty": "_6R06_W_empty",
			"memberButton": "_6R06_W_memberButton",
			"memberLabel": "_6R06_W_memberLabel",
			"memberLabelWrap": "_6R06_W_memberLabelWrap",
			"memberRow": "_6R06_W_memberRow",
			"memberStatus": "_6R06_W_memberStatus",
			"members": "_6R06_W_members",
			"phase": "_6R06_W_phase",
			"phaseCount": "_6R06_W_phaseCount",
			"phaseHeader": "_6R06_W_phaseHeader",
			"phaseLeading": "_6R06_W_phaseLeading",
			"phaseList": "_6R06_W_phaseList",
			"phaseStatus": "_6R06_W_phaseStatus",
			"phaseTitle": "_6R06_W_phaseTitle",
			"root": "_6R06_W_root",
			"runHeader": "_6R06_W_runHeader",
			"runLeading": "_6R06_W_runLeading",
			"runSummary": "_6R06_W_runSummary",
			"runTitle": "_6R06_W_runTitle",
			"separator": "_6R06_W_separator",
			"statusTail": "_6R06_W_statusTail"
		};
		//#endregion
		...
		function MemberRow({ member, navigable, openSession, t }) {
			...
			if (!renderButton) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		function PhaseSection({ contentRef, onContentBlur, onToggle, open, pendingCleanCollapse, phase, navigable, openSession, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StatusDisclosure, {
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {}),
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RunHeader, {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: node.data.phases.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PhaseSection, {
								contentRef: (element) => {
