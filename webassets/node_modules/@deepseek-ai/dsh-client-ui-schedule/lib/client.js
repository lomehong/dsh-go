window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-schedule\src\client\ScheduleCatalogAction.module.css.mjs
		const css = ".EWz0Fa_root{position:relative}.EWz0Fa_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:4px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.EWz0Fa_trigger:hover,.EWz0Fa_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.EWz0Fa_trigger svg{flex:none}.EWz0Fa_trigger>svg:last-child{transition:transform .12s}.EWz0Fa_triggerOpen{transform:rotate(180deg)}.EWz0Fa_count{margin-left:2px}.EWz0Fa_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(336px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:2px;margin:0;padding:4px;list-style:none;display:flex;position:fixed;overflow:auto}.EWz0Fa_row{box-sizing:border-box;width:100%;min-height:54px;color:var(--dsw-alias-label-primary);border-radius:8px;flex-direction:column;flex-shrink:0;gap:3px;padding:8px 10px;display:flex}.EWz0Fa_rowOverdue{background:var(--dsw-alias-state-warn-tertiary)}.EWz0Fa_status{color:var(--dsw-alias-label-tertiary);align-items:center;gap:5px;font-size:11px;line-height:16px;display:inline-flex}.EWz0Fa_statusDot{corner-shape:round;background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:8px;height:8px}.EWz0Fa_rowOverdue .EWz0Fa_status{color:var(--dsw-alias-state-warn-label)}.EWz0Fa_rowOverdue .EWz0Fa_statusDot{background:var(--dsw-alias-state-warn-primary)}.EWz0Fa_prompt{overflow-wrap:anywhere;white-space:normal;font-size:13px;line-height:18px}.EWz0Fa_metadata{min-width:0;color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:5px;font-size:11px;line-height:16px;display:flex}.EWz0Fa_relativeOverdue{color:var(--dsw-alias-state-warn-label)}";
		...
		var ScheduleCatalogAction_module_css_default = {
			"count": "EWz0Fa_count",
			"menu": "EWz0Fa_menu",
			"metadata": "EWz0Fa_metadata",
			"prompt": "EWz0Fa_prompt",
			"relativeOverdue": "EWz0Fa_relativeOverdue",
			"root": "EWz0Fa_root",
			"row": "EWz0Fa_row",
			"rowOverdue": "EWz0Fa_rowOverdue",
			"status": "EWz0Fa_status",
			"statusDot": "EWz0Fa_statusDot",
			"trigger": "EWz0Fa_trigger",
			"triggerOpen": "EWz0Fa_triggerOpen"
		};
		//#endregion
		//#region src/client/ScheduleCatalogAction.tsx
		const EMPTY_RECORDS = [];
		const SECOND_MS = 1e3;
		const SECOND_UNIT = {
			unit: "second",
		...
		function ScheduleCatalogAction({ useSession, useProjection, t }) {
			...
			const trigger = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconAlarmClockOutline16, { size: 14 }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: ScheduleCatalogAction_module_css_default.count,
						children: countLabel
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: open ? ScheduleCatalogAction_module_css_default.triggerOpen : void 0 })
				]
			});
			const catalog = open ? (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
				ref: catalogRef,
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									"aria-hidden": "true"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(overdue ? "status.overdue" : "status.scheduled") })]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: formatScheduleFrequency(record, t) }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										"aria-hidden": "true",
										children: "·"
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: formatScheduleLocalTime(record.scheduledAt, document.documentElement.lang) }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										"aria-hidden": "true",
										children: "·"
									}),
