window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = "._q4SSa_card{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);min-width:min(220px,100%);max-width:100%;max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;outline:none;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}._q4SSa_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}._q4SSa_row{cursor:pointer;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;display:flex}._q4SSa_rowActive{background:var(--dsw-alias-interactive-bg-hover)}._q4SSa_label{white-space:nowrap;text-overflow:ellipsis;flex:auto;min-width:0;overflow:hidden}._q4SSa_detail{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;overflow:hidden}._q4SSa_check{color:var(--dsw-alias-label-primary);flex:none;display:inline-flex}._q4SSa_status{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:13px}._q4SSa_search{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);background:0 0;border-radius:8px;outline:none;margin:2px 2px 4px;padding:6px 8px;font-size:13px}._q4SSa_error{color:var(--dsw-alias-state-error-primary);align-items:center;gap:8px;padding:6px 8px;font-size:12px;display:flex}._q4SSa_errorText{text-overflow:ellipsis;flex:1;overflow:hidden}._q4SSa_retry{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:6px;padding:2px 8px;font-size:12px}";
		...
		var PopupSelectView_module_css_default = {
			"card": "_q4SSa_card",
			"check": "_q4SSa_check",
			"detail": "_q4SSa_detail",
			"error": "_q4SSa_error",
			"errorText": "_q4SSa_errorText",
			"label": "_q4SSa_label",
			"retry": "_q4SSa_retry",
			"row": "_q4SSa_row",
			"rowActive": "_q4SSa_rowActive",
			"search": "_q4SSa_search",
			"status": "_q4SSa_status",
			"viewport": "_q4SSa_viewport"
		};
		//#endregion
