window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-commands\src\client\PopupSelectView.module.css.mjs
		const css = ".zMHOWa_card{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-specific-menu);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);min-width:min(220px,100%);max-width:100%;max-height:320px;box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;outline:none;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}.zMHOWa_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.zMHOWa_row{cursor:pointer;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;display:flex}.zMHOWa_rowActive{background:var(--dsw-alias-interactive-bg-hover)}.zMHOWa_label{white-space:nowrap;text-overflow:ellipsis;flex:auto;min-width:0;overflow:hidden}.zMHOWa_detail{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;overflow:hidden}.zMHOWa_check{color:var(--dsw-alias-label-primary);flex:none;display:inline-flex}.zMHOWa_status{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:13px}.zMHOWa_search{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);background:0 0;border-radius:8px;outline:none;margin:2px 2px 4px;padding:6px 8px;font-size:13px}.zMHOWa_error{color:var(--dsw-alias-state-error-primary);align-items:center;gap:8px;padding:6px 8px;font-size:12px;display:flex}.zMHOWa_errorText{text-overflow:ellipsis;flex:1;overflow:hidden}.zMHOWa_retry{border:.5px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:6px;padding:2px 8px;font-size:12px}";
		...
		var PopupSelectView_module_css_default = {
			"card": "zMHOWa_card",
			"check": "zMHOWa_check",
			"detail": "zMHOWa_detail",
			"error": "zMHOWa_error",
			"errorText": "zMHOWa_errorText",
			"label": "zMHOWa_label",
			"retry": "zMHOWa_retry",
			"row": "zMHOWa_row",
			"rowActive": "zMHOWa_rowActive",
			"search": "zMHOWa_search",
			"status": "zMHOWa_status",
			"viewport": "zMHOWa_viewport"
		};
		//#endregion
