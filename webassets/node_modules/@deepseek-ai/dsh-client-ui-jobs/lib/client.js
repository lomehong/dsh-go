window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".pjFsxq_root{position:relative}.pjFsxq_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.pjFsxq_trigger:hover,.pjFsxq_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.pjFsxq_trigger svg{transition:transform .12s}.pjFsxq_triggerOpen{transform:rotate(180deg)}.pjFsxq_triggerDot{flex:none}.pjFsxq_count{margin:0 5px}.pjFsxq_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.pjFsxq_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.pjFsxq_rowSettled{color:var(--dsw-alias-label-tertiary)}.pjFsxq_rowDot{flex:none}.pjFsxq_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.pjFsxq_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.pjFsxq_status,.pjFsxq_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.pjFsxq_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.pjFsxq_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "pjFsxq_count",
			"duration": "pjFsxq_duration",
			"kind": "pjFsxq_kind",
			"label": "pjFsxq_label",
			"menu": "pjFsxq_menu",
			"root": "pjFsxq_root",
			"row": "pjFsxq_row",
			"rowDot": "pjFsxq_rowDot",
			"rowSettled": "pjFsxq_rowSettled",
			"status": "pjFsxq_status",
			"trigger": "pjFsxq_trigger",
			"triggerDot": "pjFsxq_triggerDot",
			"triggerOpen": "pjFsxq_triggerOpen"
		};
		//#endregion
