window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\code\nodejs\deepseek-harness\packages\client\ui-jobs\src\client\JobListAction.module.css.mjs
		const css = ".sJIbdG_root{position:relative}.sJIbdG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.sJIbdG_trigger:hover,.sJIbdG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.sJIbdG_trigger svg{transition:transform .12s}.sJIbdG_triggerOpen{transform:rotate(180deg)}.sJIbdG_triggerDot{flex:none}.sJIbdG_count{margin:0 5px}.sJIbdG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-elevation-prominent);border:0;border-radius:20px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.sJIbdG_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.sJIbdG_rowSettled{color:var(--dsw-alias-label-tertiary)}.sJIbdG_rowDot{flex:none}.sJIbdG_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.sJIbdG_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.sJIbdG_status,.sJIbdG_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.sJIbdG_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.sJIbdG_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "sJIbdG_count",
			"duration": "sJIbdG_duration",
			"kind": "sJIbdG_kind",
			"label": "sJIbdG_label",
			"menu": "sJIbdG_menu",
			"root": "sJIbdG_root",
			"row": "sJIbdG_row",
			"rowDot": "sJIbdG_rowDot",
			"rowSettled": "sJIbdG_rowSettled",
			"status": "sJIbdG_status",
			"trigger": "sJIbdG_trigger",
			"triggerDot": "sJIbdG_triggerDot",
			"triggerOpen": "sJIbdG_triggerOpen"
		};
		//#endregion
