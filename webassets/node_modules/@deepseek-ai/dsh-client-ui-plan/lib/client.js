window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".ene5DG_wrap{align-items:center;gap:6px;display:inline-flex}.ene5DG_chip{corner-shape:round;background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.ene5DG_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.ene5DG_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}.ene5DG_chip:disabled{opacity:.6;cursor:default}.ene5DG_close{color:currentColor;align-items:center;display:inline-flex}.ene5DG_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
