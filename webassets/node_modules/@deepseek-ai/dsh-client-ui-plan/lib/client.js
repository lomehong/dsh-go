window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\Development\Code\nodejs\deepseek-harness\packages\client\ui-plan\src\client\PlanModeControl.module.css.mjs
		const css = ".q39vna_wrap{align-items:center;gap:6px;display:inline-flex}.q39vna_chip{corner-shape:round;background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.q39vna_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.q39vna_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}.q39vna_chip:disabled{opacity:.6;cursor:default}.q39vna_close{color:currentColor;align-items:center;display:inline-flex}.q39vna_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
		...
		function PlanChip({ useProjection, locked, exitPlanMode, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					onClick: off,
					children: [t("chip.label"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
